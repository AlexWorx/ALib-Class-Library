...
\def ALIB_WARNINGS_IGNORE_NOT_ELIDING_COPY_ON_RETURN
...
\def A_CHAR
  ...
  \see For more information, consult chapter \ref alib_characters_prepro_literals
       of the \ref alib_mod_characters "Programmer's Manual" of module \alib_characters_nl.<br>
       With module \alib_system, the further similar macro \ref A_PATH privided.
