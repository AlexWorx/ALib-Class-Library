...
foreach (modName ${ALIB_DISTRIBUTION})
    if(      NOT ( ${modName} STREQUAL "ALL"            )
        ...
        AND  NOT ( ${modName} STREQUAL "CONTAINERS"     )
        ...
        AND  NOT ( ${modName} STREQUAL "THREADMODEL"    )
...
if( NOT idx LESS 0 )
    ...
    list( APPEND  ALIB_DISTRIBUTION  "THREADMODEL"   )
...
if( NOT idx LESS 0 )
    ...
    list( APPEND  ALIB_DISTRIBUTION  "CONTAINERS"    )
