...
./batch_build_with_threads.sh           >> compilation_output.txt  2>> compilation_output.txt
./batch_build_with_threads_release.sh   >> compilation_output.txt  2>> compilation_output.txt
./batch_build_wchar16.sh                >> compilation_output.txt  2>> compilation_output.txt
./batch_build_boostregex_debug.sh       >> compilation_output.txt  2>> compilation_output.txt
./batch_build_boostregex_release.sh     >> compilation_output.txt  2>> compilation_output.txt
