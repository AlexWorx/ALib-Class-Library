...
echo "\n\n############################  RESOURCES    ############################"
rm -r -f *
cmake "-DCMAKE_CXX_FLAGS=-m32"  "-DALIB_DISTRIBUTION=RESOURCES"  ../../cmake/moduletests
make -j
...
echo "\n\n############################  TEXT    ############################"
rm -r -f *
cmake "-DCMAKE_CXX_FLAGS=-m32"  "-DALIB_DISTRIBUTION=TEXT"  ../../cmake/moduletests
make -j

echo "\n\n############################  RESULTS    ############################"
rm -r -f *
cmake "-DCMAKE_CXX_FLAGS=-m32"  "-DALIB_DISTRIBUTION=RESULTS"  ../../cmake/moduletests
make -j

echo "\n\n############################  SYSTEM    ############################"
rm -r -f *
cmake "-DCMAKE_CXX_FLAGS=-m32"  "-DALIB_DISTRIBUTION=SYSTEM"  ../../cmake/moduletests
make -j
...
echo "\n\n############################  RESOURCES;BOXING    ############################"
rm -r -f *
cmake "-DCMAKE_CXX_FLAGS=-m32"  "-DALIB_DISTRIBUTION=RESOURCES;BOXING"  ../../cmake/moduletests
make -j
