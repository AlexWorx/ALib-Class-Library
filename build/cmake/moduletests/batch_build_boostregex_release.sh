...
echo "\n\n############################  CONTAINERS    ############################"
rm -r -f *
cmake "-DALIB_FEAT_BOOST_REGEX=1" "-DCMAKE_BUILD_TYPE=Release"   "-DALIB_DISTRIBUTION=CONTAINERS"  ../../cmake/moduletests
make -j
...
echo "\n\n############################  STRINGS    ############################"
rm -r -f *
cmake "-DALIB_FEAT_BOOST_REGEX=1" "-DCMAKE_BUILD_TYPE=Release"   "-DALIB_DISTRIBUTION=STRINGS"  ../../cmake/moduletests
make -j

echo "\n\n############################  THREADMODEL    ############################"
rm -r -f *
cmake "-DALIB_FEAT_BOOST_REGEX=1" "-DCMAKE_BUILD_TYPE=Release"   "-DALIB_DISTRIBUTION=THREADMODEL"  ../../cmake/moduletests
make -j
...
echo "\n\n############################  MONOMEM;CONTAINERS    ############################"
rm -r -f *
cmake "-DALIB_FEAT_BOOST_REGEX=1" "-DCMAKE_BUILD_TYPE=Release"   "-DALIB_DISTRIBUTION=MONOMEM;CONTAINERS"  ../../cmake/moduletests
make -j
...
echo "\n\n############################  THREADS;THREADMODEL    ############################"
rm -r -f *
cmake "-DALIB_FEAT_BOOST_REGEX=1" "-DCMAKE_BUILD_TYPE=Release"   "-DALIB_DISTRIBUTION=THREADS;THREADMODEL"  ../../cmake/moduletests
make -j
