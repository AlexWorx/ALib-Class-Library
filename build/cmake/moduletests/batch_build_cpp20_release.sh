...
echo "\n\n############################  APP    ############################"
rm -r -f *
cmake "-DCMAKE_BUILD_TYPE=Release" "-DALIB_FEAT_BOOST_REGEX=1"  "-DALIB_BUILD=APP"  ../../cmake/moduletests
make -j
...
echo "\n\n############################  FILETREE    ############################"
rm -r -f *
cmake "-DCMAKE_BUILD_TYPE=Release" "-DALIB_FEAT_BOOST_REGEX=1"  "-DALIB_BUILD=FILETREE"  ../../cmake/moduletests
make -j
...
echo "\n\n############################  BITBUFFER;FILETREE    ############################"
rm -r -f *
cmake "-DCMAKE_BUILD_TYPE=Release" "-DALIB_FEAT_BOOST_REGEX=1"  "-DALIB_BUILD=BITBUFFER;FILETREE"  ../../cmake/moduletests
make -j
...
rm -r -f *
cmake "-DCMAKE_BUILD_TYPE=Release" "-DALIB_FEAT_BOOST_REGEX=1"  "-DALIB_BUILD=FILETREE;THREADMODEL"  ../../cmake/moduletests
make -j
