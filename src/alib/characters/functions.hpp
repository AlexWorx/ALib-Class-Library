...
///
/// @tparam TChar One of the six (overlapping) #"alib_characters_chars;character types".
...
/// zero-terminated string, use the faster method provided with class #"^CString".
///
/// @tparam TChar One of the six (overlapping) #"alib_characters_chars;character types".
/// @param haystack        Pointer to the start of the string.
/// @param haystackLength  The length of the string or the maximum position to search.
///                        If -1 is provided, the length is determined using standard library
///                        function \c strlen (which needs haystack to be zero-terminated).
/// @param needles         Pointer to a set of characters to be searched for.
/// @param needlesLength   The length of the string of needles.
///                        If -1 is provided, the length is determined using standard library
///                        function \c strlen (which needs needles to be zero-terminated).
///
...
/// Furthermore, the buffer, and with it this type, are aligned to \c 8 bytes on 64-bit machines and
...
/// This is provided, as a frequent use-case for this struct is to provide #"^String" objects of
/// variable length.
...
///                          - #"characters::wchar",
///                          - #"characters::xchar",
///                          - #"characters::complementChar", and
///                          - #"characters::strangeChar".
///
