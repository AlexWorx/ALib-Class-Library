...
//==================================================================================================
#ifndef HPP_ALIB_CHARACTERS_TRAITS
#define HPP_ALIB_CHARACTERS_TRAITS 1
#pragma once
#if !defined(DOXYGEN)
...
/// on the same platform), compiler symbols \ref ALIB_CHARACTERS_SIZEOF_WCHAR may be used to
...
/// independent of compiler defaults and optional compiler symbols provided, this type always
...
/// The elements of this enumeration indicate if and how the data of an array-like type
/// (which may be non-zero- or zero-terminated) may be accessed.
...
#endif // HPP_ALIB_CHARACTERS_TRAITS
