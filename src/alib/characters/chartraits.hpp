...
///
/// This is best explained when looking at class #"TString" of higher-level
/// module \alib_strings.
...
/// In the other direction, the type provides cast methods, which let instances of #"%TString"
...
enum class Policy {
    ...
    /// structs #"ArrayTraits" and #"ZTArrayTraits".
    NONE,
    ...
    /// With the field \b Construction of traits-types #"ArrayTraits" and #"ZTArrayTraits", this
    /// enumeration element is not used.
    MutableOnly,
};
...
///
/// \see
///   For detailed information, see chapter #"alib_characters_arrays" of
...
struct ArrayTraits {
    ...
    ///
    /// Note that in the case of access type #"Policy::MutableOnly;*", the
    ...
    /// In specialized versions, this method has to be provided in case that field #".Construction"
    /// is not equal to #"Policy::NONE;*".
    ///
...
//==================================================================================================
/// This type trait is in all aspects equivalent to #"ArrayTraits", only that
/// this struct provides traits on zero-terminated character arrays, while #"%ArrayTraits" is
...
struct ZTArrayTraits {
  ...
  #if DOXYGEN
    /// Same as corresponding method #"ArrayTraits::Buffer" of sibling struct
    /// #"%ArrayTraits".
    ///
    /// @param   src The source object of external type \p{TStringSource}.
    ...
    /// Same as corresponding method #"ArrayTraits::Length" of sibling struct
    /// #"%ArrayTraits".
    ///
    /// @param   src The source object of external type \p{TStringSource}.
    /// @returns Specializations have to return the length of the character array
    ...
    /// Same as corresponding method #"ArrayTraits::Construct" of sibling struct
    /// #"%ArrayTraits".
    ///
...
/// the type trait #"ArrayTraits;ArrayTraits<T, TChar>" exists.
///
/// \see
///  - For details see chapter #"alib_characters_arrays_traits_tool_arraytype" of
///    the Programmer's Manual of module \alib_characters_nl.
///  - Type alias {characters;CharType}.
///  - A sibling concept exists with concept #"IsZTArray".
///
...
/// #"ArrayTraits;ArrayTraits<T, TChar>" exists, this evaluates to \c void.
/// Otherwise, this alias evaluates to one of #"characters::nchar", #"characters::wchar"
/// or #"characters::xchar".
///
/// \see
///  - For details see chapter #"alib_characters_arrays_traits_tool_arraytype" of
///    the Programmer's Manual of module \alib_characters_nl.
///  - Concept #"ch IsArray".
///  - A sibling alias exists with #"ZTType".
///
...
//==================================================================================================
/// Concept which is satisfied for given template type \p{T} in case a specialization of
/// the type trait #"ZTArrayTraits;ZTArrayTraits<T, TChar>" exists.
///
/// \see
///  - For details see chapter #"alib_characters_arrays_traits_tool_arraytype" of
///    the Programmer's Manual of module \alib_characters_nl.
...
/// \p{T} represents.
/// In case no a specialization of the type trait
/// #"ArrayTraits;ZTArrayTraits<T, TChar>" exists, this evaluates to \c void.
/// Otherwise, this alias evaluates to one of #"characters::nchar", #"characters::wchar"
/// or #"characters::xchar".
///
/// \see
...
/// A concept to identify types that can be used to \b implicitly construct string types.
/// @see Traits class #"ArrayTraits" which may be specialized for custom types to
...
/// strings.
/// @see Traits class #"ZTArrayTraits" which may be specialized for custom types to
///      satisfy this concept - with the aim to make type \p{T} compatible (exchangeable) with
...
/// Same as #"IsImplicitZTArrayCast", but uses type-traits class
/// #"ZTArrayTraits" instead of  #"ArrayTraits".
/// @tparam T       The type to be tested (with \c const and \c volatile removed).
...
/// Same as #"IsExplicitZTArrayCast", but uses type-traits class
/// #"ZTArrayTraits" instead of #"ArrayTraits".
...
ALIB_POP_ALLOWANCE // ignore docs due to clang not knowing concepts
...
///
/// Note that for type #"characters::xchar", no complement is defined.
...
/// #"characters::nchar" if \p{TSizeOf} is given as \c 0. Values \c 2 and \c 4 evaluate to
/// #"characters::wchar" or #"characters::xchar" depending on the compiler and platform.
///
...
//==================================================================================================
/// A concept to identify \alib character types  #"characters::nchar", #"characters::wchar"
/// and #"characters::xchar". For these three types the concept is satisfied.
///
...
/// array's element-type satisfies concept #"ch IsCharacter".
