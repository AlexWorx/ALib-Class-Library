...
/// - are #"alib_strings_assembly_ttostring;appendable" to \alib strings.
///
/// \note
...
//==================================================================================================
/// Parameter class used to append to objects of type #"^AString", which invokes the method of the
/// according specialization of template struct
/// <b>AppendableTraits<TIStreamLine,TChar,HeapAllocator></b>.<br>
/// This then reads a line of text from the encapsulated \c std::istream and appends that line to
/// the target #"%AString".
///
/// This class can be created 'inline', similar to, for example,
/// #"alib_strings_assembly_ttostring_builtin;special types appendable to" class #"%AString".
/// But in the common cases, where a series of lines are to be read from a \c std::istream, a local
...
///
/// \see
/// - #"compatibility::std::operator>>(std::istream&, alib::NAString&)" and
///   #"std::operator<<(std::ostream&, const alib::NString&)".
/// - For a sample, refer to the source code of \alib class #"%IniFile", method
///   #"IniFile::Read;*".
///
///
/// @tparam TChar  The character type of the input stream as well as the receiving string.<br>
///                Specializations for character types #"characters::nchar",
///                #"characters::wchar" exist. Those have corresponding alias type definition
///                shortcuts #"IStreamLineN" and #"IStreamLineW" in namespace #"alib".
//==================================================================================================
...
struct TIStreamLine {
    ...
    /// If \c CurrentData::KEEP, the target #"%AString" is not cleared before the read operation.
    ...
    /// @param targetData    If \c CurrentData::Keep, the target #"%AString" is not cleared
    ...
    ///                      parts of the line. Defaults to 4096 characters.
...
/// Specialization of the type trait #"AppendableTraits" for type
/// #"std::TIStreamLine".
/// @tparam TChar The <b>AString</b>'s #"alib_characters_chars;character type".
template<typename TChar>
struct AppendableTraits<compatibility::std::TIStreamLine<TChar>, TChar, lang::HeapAllocator>
{
    /// Reads a line from a text file and appends the contents to \p{target}.
    /// If the end of the input stream was reached, field
    /// #"TIStreamLine;IsEOF" of parameter \p{reader} will be set
    ...
    ///   See functor #"AppendableTraits" for an explanation why it is OK to do so.
    ///
    /// @param  target     The AString object to read into.
    /// @param  reader     The object holding the \c std::istream and some parameters.
...
/// - The type counts the number of printed characters with its overloaded method
///   #".Write(const NString&)".
...
///       \alib with CMake variable #"alib_manual_build_cmake_3;ALIB_CLANG_USE_LIBCPP"),
...
///                    Defaults to #"characters::nchar" (which effectively is C++ \c char).
/// @tparam TAllocator The #"lang::Allocator;allocator type" to use with
...
///                    The default value is #"LineFeeds;Platform", which converts all
///                    line-feeds to the platforms' standard. Values #"LineFeeds;Unix"
///                    and #"LineFeeds;WindowsOS" can be used to force conversion
///                    to a different standard. Finally, #"LineFeeds;Ignore" disables
...
class OStreamWriter : public     lang::AllocatorMember<TAllocator> {
  ...
  protected:
    ...
    /// Implementation of overloaded methods #".Write(const NString&)".
...
/// C++17 Deduction Guide to construct the type #"std::OStreamWriter".
/// @param os        The output-stream to use.
...
/// type \c std::istream to the #"characters::character;default character type".
///
/// \see Class #"std::OStreamWriter".
//==================================================================================================
class IStreamReader {
  protected:
  ...
  public:
    ...
    : readOp( &::std::cin, lang::CurrentData::Clear, bufferSize, maxLineWidth )                   {}
...
//==================================================================================================
/// Copies the contents of the given #"%NString" to into the \c std::ostream given as reference.
///
...
//==================================================================================================
/// Copies the contents of the given #"%NString" to into the \c std::ostream given as pointer.
///
/// \note Unlike this documentation indicates, the operator is defined in the global namespace.
/// @param  stream The ostream object to write the given  String into.
/// @param  string The String to write into the given ostream.
...
//==================================================================================================
/// Copies the contents of the given #"%WString" to into the \c std::ostream given as reference.
///
/// \note Unlike this documentation indicates, the operator is defined in the global namespace.
/// @param  stream The ostream object to write the given  String into.
/// @param  string The String to write into the given ostream.
...
//==================================================================================================
/// Copies the contents of the given #"%WString" to into the \c std::ostream given as pointer.
///
/// \note Unlike this documentation indicates, the operator is defined in the global namespace.
/// @param  stream The ostream object to write the given  String into.
/// @param  string The String to write into the given ostream.
...
//==================================================================================================
/// Copies the contents of the given #"%NString" to into the \c std::wostream given as reference.
///
/// \note
...
//==================================================================================================
/// Copies the contents of the given #"%NString" to into the \c std::wostream given as pointer.
///
/// \note Unlike this documentation indicates, the operator is defined in the global namespace.
/// \see The notes on memory efficiency, documented with operator
///      #"operator<<(std::wostream&,const alib::NString&)"
...
//==================================================================================================
/// Copies the contents of the given #"%WString" to into the \c std::wostream given as reference.
///
/// \note Unlike this documentation indicates, the operator is defined in the global namespace.
/// @param  stream The ostream object to write the given  String into.
/// @param  string The String to write into the given ostream.
...
//==================================================================================================
/// Copies the contents of the given #"%WString" to into the \c std::wostream given as pointer.
///
/// \note Unlike this documentation indicates, the operator is defined in the global namespace.
/// @param  stream The ostream object to write the given  String into.
/// @param  string The String to write into the given ostream.
...
//==================================================================================================
/// Clears the given #"%NAString" and extracts data from the std::istream into it. The extraction
...
//==================================================================================================
/// Clears the given #"%NAString" and extracts data from the std::istream into it. The extractions
/// ends with either the end of the std::istream or when reading a newline character.
///
/// \note Unlike this documentation indicates, the operator is defined in the global namespace.
/// @param  stream The istream object to extract data from.
...
//==================================================================================================
/// Clears the given #"%WAString" and extracts data from the std::istream into it. The extractions
/// ends with either the end of the std::istream or when reading a newline character.
///
/// \note
///   If code selection macro #"ALIB_CHARACTERS_NATIVE_WCHAR" evaluates to false, a local buffer
...
///
/// \see   The notes on memory efficiency, documented with operator
///        #"operator>>(std::basic_istream<wchar_t>&, alib::WAString& )"
///        which this operator uses inline.
/// @param  stream The istream object to extract data from.
/// @param  string The AString to receive data.
/// @returns The ostream to allow concatenated operations.
...
//==================================================================================================
/// Copies the contents of the given #"alib_strings_assembly_ttostring;appendable type"
...
//==================================================================================================
/// Copies the contents of the given #"AppendableTraits;appendable type" the \c std::ostream
/// given as pointer.
///
/// \note Unlike this documentation indicates, this operator is defined in the global namespace.
///
