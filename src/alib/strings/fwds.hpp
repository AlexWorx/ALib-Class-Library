...
namespace alib {  namespace strings {
    ...
    template<typename TChar,                    typename TAllocator>    class  TAString;
    template<typename TChar, integer TCapacity, typename TAllocator>    class  TLocalString;
    ...
    template<typename TChar,                    typename TAllocator>    class  TStringLengthResetter;
