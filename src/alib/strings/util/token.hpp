...
///
/// ## Token Format: ##
/// With the construction, respectively the #"Token::Define;definition" of a token, special formats
/// are detected. These formats are:
/// - <em>"snake_case"</em><br>
/// - <em>"kebab-case"</em><br>
/// - <em>"CamelCase"</em><br>
///
...
/// #"AppendableTraits;appending" an instance to an #"^AString", will have
...
/// functor #"AppendableTraits" for this type.
/// Hence, when appending a #"%Token" to an #"%AString", if omitable, the last character
...
///
/// The source code of overloaded utility namespace function
/// #"LoadResourcedTokens(resources::ResourcePool&)"
...
class Token {
  ...
  public:
    ...
    ///
    /// @return #"DbgDefinitionError::OK", if this token is well
    ...
    ///   a token can simply be #"alib_strings_assembly_ttostring;appended" to an instance of type
    ///   #"^AString".
    ///
    ...
    ///
    /// Otherwise appends the result of #"Token::GetDefinitionName" to
    ...
    ///      #"Token;documentation", for more information about why the
    ...
    /// #"ResourcePool;resources" of \alib {lang;Camp} objects.
    ///
    ...
    ///   #"alib_enums_records;ALib Enum Records" of the type #"lang::Case;2"),
    ...
    ///   when appended to an #"%AString". Output names defined with this function must not start
...
#endif
/// Specialization of functor #"AppendableTraits" for type #"util::Token".
template<typename TAllocator>
struct AppendableTraits<util::Token, character,TAllocator> {
    /// Appends the result of #"Token::GetExportName" to the \p{target}.
    /// @param target The #"%AString" that method #"%Append(const TAppendable&)" was invoked on.
    /// @param src    The #"%Token" to append.
    inline void operator()( TAString<character,TAllocator>& target, const util::Token& src )
