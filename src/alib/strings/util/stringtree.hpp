...
// #################################################################################################
#ifndef HPP_ALIB_STRINGS_UTIL_STRINGTREE
#define HPP_ALIB_STRINGS_UTIL_STRINGTREE 1
 ...
 * \ref aworx::lib::strings::util::StringTree::Node "Node", which consists of
 ...
 * Those are:
 * - \ref aworx::lib::strings::util::StringTree::Cursor       "Cursor",
 * - \ref aworx::lib::strings::util::StringTree::StdIterator  "StdIterator" (C++ version only) and
 * - \ref aworx::lib::strings::util::StringTree::Walker       "Walker".
 *
 ...
 * \ref aworx::lib::strings::util::StringTree::Cursor "Cursor". The only way to create an
 ...
 * - \ref aworx::lib::strings::util::StringTree::Cursor::MoveToChild        "Cursor::MoveToChild",
 * - \ref aworx::lib::strings::util::StringTree::Cursor::MoveToParent       "Cursor::MoveToParent",
 * - \ref aworx::lib::strings::util::StringTree::Cursor::MoveTo             "Cursor::MoveTo" and
 * - \ref aworx::lib::strings::util::StringTree::Cursor::MoveToExistingPart "Cursor::MoveToExistingPart".
 *
 * For the creation of new child nodes or a complete path of such, methods
 * - \ref aworx::lib::strings::util::StringTree::Cursor::MoveToChildCreate              "Cursor::MoveToChildCreate" and
 * - \ref aworx::lib::strings::util::StringTree::Cursor::MoveToAndCreateNonExistingPart "Cursor::MoveToAndCreateNonExistingPart"
 *
 * are provided. Then, two methods for erasing nodes exist:
 * - \ref aworx::lib::strings::util::StringTree::Cursor::DeleteChild    "Cursor::DeleteChild" and
 * - \ref aworx::lib::strings::util::StringTree::Cursor::DeleteChildren "Cursor::DeleteChildren"
 *
 ...
 * - \ref aworx::lib::strings::util::StringTree::Cursor::MoveToParentUnchecked "Cursor::MoveToParentUnchecked" and
 * - \ref aworx::lib::strings::util::StringTree::Cursor::IsValid               "Cursor::IsValid".
 *
 ...
 * \ref aworx::lib::strings::util::StringTree::StdIterator "StdIterator". It implements the concept
 * [C++ InputIterator](http://en.cppreference.com/w/cpp/concept/InputIterator) and due to the
 * implementation of methods
 * - \ref aworx::lib::strings::util::StringTree::begin "StringTree::begin" and
 * - \ref aworx::lib::strings::util::StringTree::end   "StringTree::end",
 *
 ...
 *
 * With methods
 * - \ref aworx::lib::strings::util::StringTree::Cursor::begin "Cursor::begin" and
 * - \ref aworx::lib::strings::util::StringTree::Cursor::end   "Cursor::end",
 *
 ...
 *
 * - \ref aworx::lib::strings::util::StringTree::Cursor::SetIterator   "Cursor::SetIterator" and
 * - \ref aworx::lib::strings::util::StringTree::Walker::SetIterator   "Walker::SetIterator".
 *
 * Please also note the paragraph about recursive iteration below.
 *
 * Class \ref aworx::lib::strings::util::StringTree::StdIterator "StdIterator" is quite lightweight.
 ...
 * Finally, with
 * \ref aworx::lib::strings::util::StringTree::Walker "Walker", a third \b %StdIterator class is exposed.
 * The rationale for having this class is to provide a configurable and controlled way of iterating
 * a tree or a branch. Some features of the class are:
 * - Can be created from (or reset to) the \b %StringTree itself,
 *   \ref aworx::lib::strings::util::StringTree::Cursor   "Cursor"   objects and from
 *   \ref aworx::lib::strings::util::StringTree::StdIterator "StdIterator" objects.
 * - Can work recursively (with depth limitation) or just on the current node's direct children.
 ...
 * same as class
 * \ref aworx::lib::strings::util::StringTree::Cursor "Cursor" does not - but then unlike class
 * \ref aworx::lib::strings::util::StringTree::StdIterator "StdIterator" which does!
 *
 ...
 * \ref aworx::lib::strings::util::StringTree::StdIterator   "StdIterator" and class
 * \ref aworx::lib::strings::util::StringTree::Walker     "Walker", allow recursive iteration. There are
 ...
 * \ref aworx::lib::strings::util::StringTree::Cursor "Cursor",
 * \ref aworx::lib::strings::util::StringTree::StdIterator "StdIterator" and
 * \ref aworx::lib::strings::util::StringTree::Walker "Walker") may become invalid when
 ...
 * \ref aworx::lib::strings::util::StringTreeDefaultAllocator "StringTreeDefaultAllocator", which
 ...
 * \ref aworx::lib::strings::util::StringTreeConstKeyAllocator "StringTreeConstKeyAllocator" may be used,
 ...
 *
 * ## Module Dependencies ##
 * This class is only available if besides module \alibmod_strings, module module \alibmod_memory
 ...
 *                     \alib{strings::util,StringTreeDefaultAllocator}.
...
class StringTree : public TAllocator
{
    ...
    public:
         ...
         * \ref aworx::lib::strings::util::StringTree::Cursor "Cursor", which represents node objects,
         * provides an indirect interface to the values of this class.
         *
         * ## Friends ##
         * class \alib{strings::util,StringTree}
         * class \alib{strings::util,StringTree::Walker}
         * template type \p{TAllocator}
         */
        class Node
        {
            ...
            Node* getChild( const String& childName )
            {
                if(    childName.IsEmpty()
                    || childName.Equals( A_CHAR("." ) )
                    || childName.Equals( A_CHAR("..") )
                    || childName.IndexOf( TSeparator) >=0 )
                {
                    ALIB_WARNING( "Illegal child name: ", childName );
                    return nullptr;
                }
    ...
    public:
         ...
         * \ref aworx::lib::strings::util::StringTree::Walker "StringTree::Walker" provides. Hence it is
         ...
         * \ref aworx::lib::strings::util::StringTree "StringTree".
         *
         * ## Friends ##
         * class \alib{strings::util,StringTree}
         ******************************************************************************************/
        class StdIterator  : public std::iterator<std::input_iterator_tag, T>
        {
            ...
            public:
                 ...
                 * \ref aworx::lib::strings::util::StringTree::Cursor::Depth "Cursor::Depth".
                 *
    ...
    public:
        ...
        class Cursor
        {
            ...
            protected:
                ...
                Node* createPathAndReturnLeaf( TAllocator& allocator, Node* node, Substring& path )
                {
                    ...
                    for(;;)
                    {
                        ...
                        if( childName.Equals( A_CHAR(".") ) || childName.Equals(A_CHAR("..")) )
                        {
                            //ALIB_WARNING( "Illegal child name in creation path: ", childName );
                            return node;
                        }
            ...
            //####  Tree navigation inplace, returning status      #################################
                 ...
                 *    class's method #SearchPath:
                 *    \snippet "alib/strings/util/stringtree.hpp"     DOX_ALIB_STRING_TREE_MOVETOPARENT
                 *    As can be seen, this sample also uses non-checking versions of the
                 *    insertion methods of class \alib{strings,TAString,AString} because
                 ...
                 *
                 * This method does not check the given \p{childName} to be valid (i.e not equal
            ...
            //####  StdIterator creation       ########################################################
                 ...
                 * Unlike with method
                 * \ref aworx::lib::strings::util::StringTree::begin "StringTree::begin", here the
            ...
            public:
                ...
                /**
                 * Returns the name of the node that this cursor represents.
                 * The method searches all children of this node's parent node and returns the
...
#if !ALIB_DOCUMENTATION_PARSER
DOX_MARKER( [DOX_ALIB_STRING_TREE_MOVETOPARENT] )
Cursor iter= *this;
...
DOX_MARKER( [DOX_ALIB_STRING_TREE_MOVETOPARENT] )
       ...
       //##########################################################################################
         ...
         * of \c std::iterator (see class \alib{strings::util::StringTree,StdIterator} for a
         * variant that does).
         * The rationale for this is the fact that the class provides mechanics to sorting the
        ...
        class Walker
        {
            ...
            protected:
                ...
                struct RecursionData
                {
                     ...
                     * written to field #sortedChildren of original object to prevent deletion.
            ...
            public:
                ...
                void SetStart( Cursor cursor )
                {
                    ALIB_ASSERT_ERROR( stringTree == cursor.stringTree,
                                       "Differnt referred StringTree objects" )
                 ...
                 * \alib{strings,TString::Equals,String::Equals}.
                 *
                ...
                {
                    actPath.Reset(  generatePath == Switch::On  ?  EmptyString()
                                                                :  NullString()  );
                }
                 ...
                 *
                 * \note Unlike method
                 *       \ref aworx::lib::strings::util::StringTree::Cursor::SearchName "Cursor::SearchName"
...
/** ************************************************************************************************
 * This struct is the default implementation of a helper type of class \alib{strings::util,StringTree}.
 ...
 *
 * See also
 * \ref aworx::lib::strings::util::StringTreeConstKeyAllocator "StringTreeConstKeyAllocator".
 *
 * @tparam T      The value type of elements stored in the nodes of the tree.
 **************************************************************************************************/
template<typename T> struct StringTreeDefaultAllocator
{
     ...
     *                    \alib{strings::util,StringTreeDefaultAllocator::AllocateNode}.
     */
    template<typename TAllocator>
    inline
    ...
    /**
     * Invoked with method \alib{strings::util,StringTree::Clear} to tell the allocator that the
     * tree was reset.
     * This default allocator, as well as \alib{strings::util,StringTreeConstKeyAllocator} do not
     * perform any action with this method. Class \alib{strings::util,StringTreeBlockAllocator} will
...
/** ************************************************************************************************
 * Implementation of \alib{strings::util,StringTreeDefaultAllocator} which simply does not allocated keys.
 ...
 * \alib{strings::util,StringTree} and especially with the node creation methods
 * of class \alib{strings::util,StringTree::Cursor} are 'safely' allocated already.
...
template<typename T> struct StringTreeConstKeyAllocator
{
     ...
     * See \alib{strings::util,StringTreeDefaultAllocator::FreeKey} for details.
     */
    inline
    ...
    /**
     * Empty implementation.
     * See \alib{strings::util,StringTreeDefaultAllocator::AllocatorClear} for details.
     */
    inline
    void    AllocatorClear()
    {}
...
#if ALIB_MODULE_MEMORY
/** ************************************************************************************************
 * Implementation of \alib{strings::util,StringTreeDefaultAllocator} which uses a
 * \alib{memory,MemoryBlocks} object to allocate the keys.
 *
 * This helper can be used in cases when a string tree only grows over time and now branches are
 * replaced.
 *
 * #### Availability ####
 * This type is available only if module \alibmod_memory is included in the \alibdist.
 *
 * @tparam T            The value type of elements stored in the nodes of the tree.
...
template<typename T, int TBlockSize> struct StringTreeBlockAllocator
{
    ...
    String AllocateKey( const String& childName, T& )
    {
        return memoryBlocks.Clone( childName );
    }
    ...
    /**
     * Resets the memory blocks for re-use (aka calls \alib{MemoryBlocks::Clear} on field
     * #memoryBlocks).
     *
     * See \alib{strings::util,StringTreeDefaultAllocator::AllocatorClear} for details.
     */
...
template<typename T, typename TAllocator= aworx::lib::strings::util::StringTreeDefaultAllocator<T>>
using  StringTree=    aworx::lib::strings::util::StringTree<T, TAllocator>;
...
#endif // HPP_ALIB_STRINGS_UTIL_STRINGTREE
