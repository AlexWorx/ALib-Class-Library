...
//==================================================================================================
#ifndef HPP_ALIB_STRINGS_UTIL_EXTERNALIZER
#define HPP_ALIB_STRINGS_UTIL_EXTERNALIZER 1
...
struct StringEscaper
{
    ...
    ///
    /// \par Availability
    ///   This method is defined only if module \alib_monomem is included in the \alibdist.
...
#endif // HPP_ALIB_STRINGS_UTIL_EXTERNALIZER
