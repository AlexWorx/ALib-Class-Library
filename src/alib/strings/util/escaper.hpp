...
/// #"util::StringEscaperStandard" and possible custom derivates.<br>
...
/// In other words: In situations where a function expects a #"%StringEscaper" where none is necessary
...
//==================================================================================================
/// This struct implements the interface given with #"util::StringEscaper".
