//==================================================================================================
/// \file
/// This header-file is part of sub-namespace #alib::strings::util of module \alib_strings of
/// the \aliblong.
///
...
class CalendarDateTime
{
  public:
        ...
        /// key <c>"Months"</c>. In both cases a user might change this during bootstrap.
        static ALIB_DLL String MONTH_NAMES[12];

        /// A list of day names used with the method \alib{strings::util;CalendarDateTime::Format}.
        ///
        /// If module \alib_camp is not included in the \alibbuild, the values default to:
...
/// \alib{strings::util;CalendarDateTime}, where a value of \c 0 represents year \b 1900.
