...
/// "matching commands". This way, the class is optimized for performance, because after
/// compilation, subsequent invocations of #".Match" do not need to parse the pattern string.
///
/// @tparam TChar    The character type. Implementations for \c nchar and \c wchar are provided
///                  with type definitions #"alib::WildcardMatcherN" and
///                  #"alib::WildcardMatcherW".
//==================================================================================================
...
class TWildcardMatcher {
  ...
  public:
    ...
    ///                      Defaults to #"%NULL_STRING" to allow parameterless construction,
    ///                      with later invocation of #".Compile".
    TWildcardMatcher( const TString<TChar>& pattern= NULL_STRING )           { Compile( pattern ); }
...
extern template ALIB_DLL void TWildcardMatcher<nchar>::Compile( const TString<nchar>& );
extern template ALIB_DLL bool TWildcardMatcher<nchar>::Match  ( const TString<nchar>&, lang::Case );
extern template ALIB_DLL void TWildcardMatcher<wchar>::Compile( const TString<wchar>& );
extern template ALIB_DLL bool TWildcardMatcher<wchar>::Match  ( const TString<wchar>&, lang::Case );
