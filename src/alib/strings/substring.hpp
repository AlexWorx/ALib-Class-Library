...
class TSubstring : public TString<TChar>
{
  ...
  public:
    ...
    TChar       ConsumeChar()
    {
        ...
        {
            ALIB_ASSERT_ERROR( !base::IsEmpty(), "STRINGS",
                          ...
                          integer                      separatorWidth   =0         )
    {
        ...
        else
        {
            ...
            ALIB_ASSERT_ERROR(    regionLength >= 0
                               && regionLength + separatorWidth <= base::length,
                               "STRINGS", "Non checking but regionLength out of bounds"      )
        }
                                 ...
                                 integer             separatorWidth   =0      )
    {
        ...
        target._<NC>( *this, base::length - regionLength, regionLength );
    ...
    {
        ALIB_ASSERT_ERROR( base::IsNotNull() ,
...

    {
        ...
        {
            ALIB_ASSERT_ERROR( position >=0 && position <= base::length,
                               "STRINGS", "Non checking but position out of bounds"        )
            ALIB_ASSERT_ERROR( position + separatorWidth <= base::length,
