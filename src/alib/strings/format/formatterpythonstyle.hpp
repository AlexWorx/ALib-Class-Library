 ...
 *     Finally, if flag
 *     \alib{strings,NumberFormatBase::ForceScientific,ForceScientific}
 ...
 *   respectively \c 'X'.
 *
 *   In the C++ language implementation of \alib, instead of hash-values of objects, the result
 *   of method \alib{boxing,Box::PeekRawValue} is printed. In case of boxed class-types and default
 ...
 *   boxing interface \alib{boxing,IIsTrue}.
 *
 * <p>
 ...
 *
 *   Built-in class \alib{time,DateTime} supports custom formatting with boxing interface
 *   \alib{time,IFormat_DateTime}.
 *
 *
 * <p>
 * - <b>Conversions:</b><br>
 ...
 *     See \alib{strings,FormatBase::Escape,Format::Escape} for details about the conversion
 ...
 *
 *     Which each new invocation of \alib{strings::format,FormatterBase::Format,Formatter::Format},
 ...
 *                  with type definitions \ref aworx::NFormatterPythonStyle} and
 *                  \ref aworx::WFormatterPythonStyle.
 **************************************************************************************************/
template<typename TChar>
class FormatterPythonStyleBase : public FormatterStdImpl<TChar>
{
    // #############################################################################################
    // Protected fields
    // #############################################################################################
    protected:
         ...
         * \c '!'.
         */
        SubstringBase<TChar>        phaExtConversion;
...
extern template ALIB_API                              FormatterPythonStyleBase<char   >::FormatterPythonStyleBase();
extern template ALIB_API  FormatterStdImpl<char   >*  FormatterPythonStyleBase<char   >::Clone();
extern template ALIB_API  void                        FormatterPythonStyleBase<char   >::reset();
extern template ALIB_API  void                        FormatterPythonStyleBase<char   >::resetPHAs();
extern template ALIB_API  void                        FormatterPythonStyleBase<char   >::initializeFormat();
extern template ALIB_API  integer                     FormatterPythonStyleBase<char   >::findPlaceholder();
extern template ALIB_API  bool                        FormatterPythonStyleBase<char   >::parsePlaceholder();
extern template ALIB_API  bool                        FormatterPythonStyleBase<char   >::parseStdFormatSpec();
extern template ALIB_API  void                        FormatterPythonStyleBase<char   >::replaceEscapeSequences(integer);
extern template ALIB_API  bool                        FormatterPythonStyleBase<char   >::preAndPostProcess(integer,NAString*);
extern template ALIB_API  bool                        FormatterPythonStyleBase<char   >::checkStdFieldAgainstArgument();

extern template ALIB_API                              FormatterPythonStyleBase<wchar_t>::FormatterPythonStyleBase();
extern template ALIB_API  FormatterStdImpl<wchar_t>*  FormatterPythonStyleBase<wchar_t>::Clone();
extern template ALIB_API  void                        FormatterPythonStyleBase<wchar_t>::reset();
extern template ALIB_API  void                        FormatterPythonStyleBase<wchar_t>::resetPHAs();
extern template ALIB_API  void                        FormatterPythonStyleBase<wchar_t>::initializeFormat();
extern template ALIB_API  integer                     FormatterPythonStyleBase<wchar_t>::findPlaceholder();
extern template ALIB_API  bool                        FormatterPythonStyleBase<wchar_t>::parsePlaceholder();
extern template ALIB_API  bool                        FormatterPythonStyleBase<wchar_t>::parseStdFormatSpec();
extern template ALIB_API  void                        FormatterPythonStyleBase<wchar_t>::replaceEscapeSequences(integer);
extern template ALIB_API  bool                        FormatterPythonStyleBase<wchar_t>::preAndPostProcess(integer,WAString*);
extern template ALIB_API  bool                        FormatterPythonStyleBase<wchar_t>::checkStdFieldAgainstArgument();
