...
//==================================================================================================
/// This type specializes class #"%AString" by adding a character array member of templated size
...
/// parameter \p{TCapacity}. With that, the allocation and deallocation of heap memory
...
/// strings managed in #"%AString" objects. This means, the use of this class is safe and no
/// restrictions apply.
...
/// #"alib_mod_assert;raises a warning" if an external buffer is replaced by a
/// new (heap) allocation. (Note that from an #"%AString" perspective, this class's internal
/// field #"%.buffer" is an external character array).
/// With use cases that do not allow foreseeing a maximum buffer size, the warning has to be
/// disabled by invoking #"TAString::DbgDisableBufferReplacementWarning".
///
/// For more information on warnings, see #"TAString::SetBuffer(integer)".
///
/// With the provision of an assignment operator, the explicit restriction of parent class to
/// #"alib_ns_strings_astring_copymove;not allow assignments" is lifted with this type.
///
/// \note
///   For commonly used sizes and character types, some convenient typedefs exists in namespace
///   alib, which use #"HeapAllocator".
...
///   definitions #"%LocalString",
///   #"%NLocalString", #"%WLocalString",
///   #"%XLocalString", #"%ComplementLocalString" and
///   #"%StrangeLocalString".
/// @tparam TCapacity  The capacity of the string buffer allocated locally "inside" the class.
/// @tparam TAllocator The allocator type to use. Defaults to #"HeapAllocator".
//==================================================================================================
...
class TLocalString : public TAString<TChar, TAllocator> {
  ...
  protected:
    ...
    /// Passed as an external buffer to parent class #"%AString".
  ...
  //################################################################################################
  public:
    /// Constructs an empty #"%LocalString". Inherited field #"TString::buffer"
    /// will be set as an the external buffer of parent #"%AString".
    ...
    /// Constructs this instance and invokes parent's method #"%Append(const TAppendable&)" to
    /// create a string representation of the given "appendable" object \p{src}.
    ///
    /// \see
    ///   Manual chapter #"alib_strings_assembly_ttostring" for more information
    ...
    : base( localBuffer, TCapacity )                                        { base::Append( src ); }


    /// Assign operator.
    /// Invokes inherited method #"Reset(const TAppendable&)".
    ///
    ...
    /// @return \c *this to allow concatenated calls.
    template <typename TAppendable>
    TLocalString& operator= (const TAppendable& src )          { base::Reset( src ); return *this; }
...
#if ALIB_DEBUG
//==================================================================================================
/// This simple specialization of #"str TLocalString" disables the warning about
