...
namespace alib { namespace strings {
     ...
     *
     * \note
     *   For commonly used sizes and character types, some convenient typedefs exists in namespace alib.
     ...
     *   are provided in namespace #alib with type definitions \b LocalString<TCapacity>,
