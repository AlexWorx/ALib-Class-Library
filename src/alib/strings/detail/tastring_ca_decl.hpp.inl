...
// For this, before inclusion two configuration macros have to be specified:
...
//
// With "tastring_ca_impl.hpp", the corresponding implementations are to be made.
//##################################################################################################
//##################################################################################################

#if !defined(ASTR_TCHAR_SPEC)
#  error "Configuration macro ASTR_TCHAR_SPEC has to be given as ALIB_CHAR_TYPE_ID_XYZ before invoking this .INL"
#endif
