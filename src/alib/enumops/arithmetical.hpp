...
/// - #"arithmetical::operator-(TEnum, TE)"
/// - #"arithmetical::operator++(TEnum&, ty)"
/// - #"operator++(TEnum&, typename)"
/// - #"arithmetical::operator--(TEnum&, ty)"
/// - #"operator--(TEnum&, typename)"
/// - #"arithmetical::operator+=(TEnum, TE)"
/// - #"arithmetical::operator-=(TEnum, TE)"
///
/// \attention
///   Likewise with the operators introduced with the type trait #"BitwiseTraits",
...
///
/// \see
///   - Macro #"ALIB_ENUMS_MAKE_ARITHMETICAL", which specializes this type trait for a given
///     enumeration type.
///   - For details and a source code sample see chapter #"alib_enums_arithmetic_standard"
...
/// Concept that is satisfied if the type trait #"ArithmeticalTraits"
...
/// Operators available to elements of enumerations if #"ArithmeticalTraits" is
/// specialized.
///
/// \note
...
///
/// Selected by the compiler only if #"ArithmeticalTraits" is specialized for
