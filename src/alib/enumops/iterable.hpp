...
/// Specializations have to declare <c>constexpr</c> fields #".Begin" and #".End", as documented
/// with this type.
///
/// \note
...
///
/// \see
///   - Macros #"ALIB_ENUMS_MAKE_ITERABLE" and #"ALIB_ENUMS_MAKE_ITERABLE_BEGIN_END", which
///     specialize this type trait for a given enumeration type.
///   - Type #"EnumIterator" used to perform iterations.
///   - For details and a source code sample see chapter #"alib_enums_iter"
...
/// These are types for which a specialization of type trait #"IterableTraits"
/// is defined.
...
/// Operators available to elements of enumerations if #"IterableTraits" is
/// specialized.
///
/// \note
...
///
/// Selected by the compiler only if #"IterableTraits" is specialized for
/// enum type \p{TEnum}.
///
...
/// The documentation is found with the type trait #"IterableTraits", which needs
...
struct EnumIterator {
    ...
    /// #"EnumIterator::ConstIterator;2" which uses <c>const TEnum*</c> and <c>const TEnum&</c> as
