...
class Box
{
    ...
    public:
        ...
        IsType()                                                                               const
        {
            ...
            //======================================================================================
            /// Tests if this box contains one of types \c char, \c wchar_t, \c char16_t or
            /// \c char32_t.
            ///
        ...
        Unbox()                                                                                const
        {
            ...
            ALIB_ASSERT_ERROR( vtable == getVTable<TUnboxable>(),
                               "Cannot unbox type <" , lang::DbgTypeDemangler(typeid(TUnboxable)).Get(),
        ...
        /// @tparam TUnboxable The type to unbox. If it is not unboxable, a compile-time
        ///                    assertion is given.
        /// @return The unboxed value of type \p{TUnboxable} cast to a non-<c>const</c> object.
        //==========================================================================================
        template<typename TUnboxable>
        inline
        ...
        {
            vtable= reinterpret_cast<detail::VTable*>(typeCode);
            data.SetUInteger(0, uinteger(0));
            data.SetUInteger(1, uinteger(0));
        }
        ...
        TElementType*    UnboxArray()       const
        {
            ALIB_ASSERT_ERROR( vtable, "BOXING",
              "Box not initialized. Unboxing is undefined behavior." )
            ...
            "BOXING: Cannot unbox array type<",lang::DbgTypeDemangler(typeid(TElementType*)).Get(),
        ...
        TElementType&    UnboxElement(integer idx)       const
        {
            ...
            ALIB_ASSERT_ERROR( typeid(TElementType) == vtable->ElementType,
              "BOXING: Cannot unbox array element type <", lang::DbgTypeDemangler(typeid(TElementType)).Get(),
              "> from mapped type <"                     , lang::DbgTypeDemangler(vtable->ElementType ).Get(),
              "[]>." )
