...
///
/// \par Availability
///   This box-function is available only if the module \alib_strings is included in the \alibdist.
///
/// \see
...
struct FAppend
{
    ...
    Appendable( const Box& self, strings::TAString<TChar, TAllocator>& target );
    ...
    /// Implementation template for box-function \alib{boxing;FAppend} for appendable types wrapped in
...
alib::boxing::BootstrapRegister<FAppend<character, alib::lang::HeapAllocator>, alib::boxing::TMappedTo<TAppendable>>    \
...
alib::boxing::BootstrapRegister<FAppend<nchar    , alib::lang::HeapAllocator>, alib::boxing::TMappedTo<TAppendable>>    \
...
alib::boxing::BootstrapRegister<FAppend<wchar    , alib::lang::HeapAllocator>, alib::boxing::TMappedTo<TAppendable>>    \
...
alib::boxing::BootstrapRegister<FAppend<xchar    , alib::lang::HeapAllocator>, alib::boxing::TMappedTo<TAppendable>>    \
