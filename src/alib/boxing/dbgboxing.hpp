...
///
/// \par Availability
///   This struct is only available if compiler symbol \ref ALIB_DEBUG_BOXING is set and
...
/// #RemovableNamespaces before invoking a method.
///
/// \note
...
///
/// \par Availability
///  This struct is only available if compiler symbol \ref ALIB_DEBUG_BOXING is set.
///
/// \par
///   The following methods are available independent of the \alibdist.
///   - #GetKnownVTables
...
#include "alib/lang/callerinfo_functions.hpp"
                       ...
                       const String& indent  = A_CHAR("  "                                   ) )
    {
        ...
        {
            NString512 demangled;
            srcRTTIDmgld.GetShort(demangled);
    ...
    //==============================================================================================
    /// Internally used by methods #DumpVTables and #DumpAll.
    ///
    /// \par Availability
    ///   This method is included only if module \alib_basecamp is included in the \alibdist.
    ///
    ...
    /// \par Availability
    ///   This method is included only if module \alib_basecamp is included in the \alibdist
    ///   and compiler symbol \ref ALIB_DEBUG_CONTAINERS is given.
    ///
    /// @param[out] target              The target string to write to.
