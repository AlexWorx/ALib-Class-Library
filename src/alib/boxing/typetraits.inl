 ...
 * Array types consist of a an element type as well as a length.
 ...
 *
 *    A type becomes \alib{boxing,TT_IsUnboxable,not unboxable} in the moment this function
 ...
 * - C++ array types<br>
 *   Those types are fetched by an overloaded constructor that does not (because it can not)
 *   leverage this struct. Likewise, they can not be unboxed in the usual fashion.
...
struct T_Boxer
{
     ...
     * \snippet "alib/boxing/typetraits.inl"  DOX_ALIB_BOXING_T_BOXER_WRITE
     *
     ...
     */
    DOX_MARKER([DOX_ALIB_BOXING_T_BOXER_WRITE])
     ...
     * that.<br>
     * The default implementation of this struct implements this method as follows:
     * \snippet "alib/boxing/typetraits.inl"  DOX_ALIB_BOXING_T_BOXER_READ
     *
    ...
    {
DOX_MARKER([DOX_ALIB_BOXING_T_BOXER_READ])
 ...
 *   if a type can not be unboxed and methods \alib{boxing,Box::IsType} and \alib{boxing,Box::Unbox}
...
/** ************************************************************************************************
 * This type is of \c std::true_type exactly if a type can not be unboxed and methods
