...
//==================================================================================================
/// A vector of objects of type #"Box".
...
///
/// If another #"%Boxes" object or an array of boxes, or boxed versions of such, are added, this
...
///
/// @tparam TAllocator The allocator to use with the <c>std::vector</c>, as prototyped with class
///                    #"lang::Allocator".
//==================================================================================================
...
class TBoxes : public    std::vector<Box, lang::StdAllocator<Box, TAllocator>> {
  ...
  public:
    ...
    /// Adds an array of boxes. Array elements of types #"%TBoxes" itself and boxed arrays of
    /// class #"%Box" are recursively "flattened".
    ///
    ...
    /// Invokes #"Box::Call" with each box in this list.
    ...
    /// of #"Box::Call" and hence this method is usable with functions that only
    /// accept mutable (aka not constant) boxes.<br>
    /// Technically, the only difference between this method and #"%CallAll" is that the latter
    /// is declared \c const.
    ///
    /// @tparam TFDecl  The function type to call.
    ///                 Needs to be specified with invocations of this method.
    ...
    /// Same as #"CallAll;CallAll<FClone>", but uses method #"Box::Clone",
    /// which internally invokes #"FClone".
    ///
    /// Using this version leads to shorter code, because method #"%Box::Clone" is not inlined.
    /// Cloning is performed 'into' the allocator used by the #"%Boxes" instance.
    ///
    /// \par Availability
...
ALIB_BOXING_VTABLE_DECLARE( alib::boxing::TBoxes<HeapAllocator>*, vt_boxing_tboxes )
