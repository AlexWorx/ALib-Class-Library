...
/// #"debug::RemovableNamespaces" before invoking a function.
///
/// \note
...
///
/// \par Availability
///  This namespace is only available if the configuration macro #"ALIB_DEBUG_BOXING" is set.
///
/// \par
///   The following functions are available independent of the \alibbuild.
///   - #"GetKnownVTables"
///   - #"GetKnownFunctionTypes"
///   - #"GetSpecificFunctionTypes(const Box&)"
///   - #"GetSpecificFunctionTypes(const detail::VTable*)"
///   - #"getFunctionTypes"
/// \par
///   The following functions become available if module \alib_strings is included in the \alibbuild:
///   - #"TypeName(const Box&)",
///   - #"TypeName(const detail::VTable*)", and
///   - #"RemoveNamespaces".
///
/// \par
///   All other functions become available if the module \alib_format is included in the \alibbuild.
///   If in addition configuration macro #"ALIB_DEBUG_CONTAINERS" is given, then a final function becomes
///   available:
///   - #"DumpCustomFunctionHashMapMetrics"

/// \see
///   Chapter #"alib_boxing_more_debug" of the
...
/// @return A vector of pointers to objects of type #"detail::VTable".
ALIB_DLL
...
/// #"Box::DbgGetVTable".
///
/// Note that the result can be conveniently passed to #".DumpFunctions".
/// \see Overloaded version #"GetSpecificFunctionTypes(const Box&)" which accepts a "sample Box".
///
///
...
#if ALIB_STRINGS
/// Implementation of #".TypeName(const detail::VTable*)".
/// \par Availability
...
/// #"debug::RemovableNamespaces" before invoking any function.
///
