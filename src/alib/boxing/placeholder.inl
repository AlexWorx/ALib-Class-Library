...
///
/// By the same token, if a customization of a non-array type writes a different length then
...
union Placeholder
{
    ...
    ///
    /// It has to be ensured that all memory used by a mapped type are cleared.
