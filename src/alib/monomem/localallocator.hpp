...
//==================================================================================================
#ifndef HPP_ALIB_MONOMEM_LOCALALLOCATOR
#define HPP_ALIB_MONOMEM_LOCALALLOCATOR 1
#pragma once
#if !defined(DOXYGEN)
...
///
/// Note that the \ref alib_nsalib_type_aliases "usual type alias" given in namespace #alib,
/// in this case misses the leading <em>"T"</em>, and is given with \alib{LocalAllocator}. Besides that,
...
#endif // HPP_ALIB_MONOMEM_LOCALALLOCATOR
