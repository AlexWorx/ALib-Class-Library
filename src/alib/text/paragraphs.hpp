...
#define HPP_ALIB_TEXT_PARAGRAPHS 1

#if !defined (HPP_ALIB_TEXTTER_PYTHONSTYLE)
...
class Paragraphs
{
    ...
    public:
         ...
         * - \alib{text,Formatter::GetDefault,ALib Default Formatter},
         *   in the case that this object's template character type equals \ref aworx::character, or
    ...
    public:
         ...
         *
         * @throws <b>aworx::lib::text::Exceptions</b><br>
         ...
         *   - \alib{text::Exceptions,UnknownMarker}
         *   - \alib{text::Exceptions,EndmarkerWithoutStart}
...
#endif // HPP_ALIB_TEXT_PARAGRAPHS
