...
#define HPP_ALIB_TEXT_PROPERTY_FORMATTERS
 ...
 * We take the freedom to use the resource pool of module \alib{ALibDistribution}:
 ...
 * Such object is given with template type \alib{text,PropertyFormatterMapAppendable}.
...
class PropertyFormatters
{
    ...
    public:
         ...
         * a clone of the formatter returned by \alib{text,Formatter::GetDefault}.
         * Note, that this is in contrast to the similar parameter of class
         * \alib{text,PropertyFormatter}, which uses the default formatter itself
         ...
         * struct \alib{text,PropertyFormatterMapAppendable}. Now, nested formatting must
         * not be done with the same formatter object.
         *
         *
         * @param callbackTable  The callback table as specified with
         *                       \alib{text,PropertyFormatter::TCallbackTable}.
         ...
         *                       \alib{text,PropertyFormatter}s.<br>
         *                       Defaults to \c nullptr which denotes to create a copy of the
         *                       formatter returned by \alib{text,Formatter::GetDefault}.
         */
        ...
        /**
         * Destructor. Deletes the \alib{text,PropertyFormatter}s which got created.
         */
        ~PropertyFormatters()
        {
        ...
        /**
         * Chooses or - if not yet available - creates the right \alib{text,PropertyFormatter}
         * and invokes its method \alib{text,PropertyFormatter::Format,Format}.
         *
...
/**
 * Helper struct for users of class \alib{text,PropertyFormatters}.
...
{
    /**
     * Invokes the \alib{text,PropertyFormatters::Format} of the formatter map
     * encapsulated in \p{src}.
     * @param target  The target string.
     * @param src     The helper struct object.
     */
    void operator()( TAString<character>& target, const typename text::PropertyFormatterMapAppendable<TFormattable,TOptionEnum>& src )
    {
...
#endif // HPP_ALIB_TEXT_PROPERTY_FORMATTERS
