...
#define HPP_ALIB_TEXT_FORMATTER_JAVASTYLE 1
 ...
 *   - \alib{text::Exceptions,NegativeValuesInBracketsNotSupported}
 *   - \alib{text::Exceptions,MissingPrecisionValueJS}
 *   - \alib{text::Exceptions,HexadecimalFloatFormatNotSupported}
 *   - \alib{text::Exceptions,NoAlternateFormOfConversion}
 *   - \alib{text::Exceptions,NoPrecisionWithConversion}
 *   - \alib{text::Exceptions,UnknownDateTimeConversionSuffix}
 *   - \alib{text::Exceptions,UnknownConversionJS}
 *
 **************************************************************************************************/
...
#endif // HPP_ALIB_TEXT_FORMATTER_JAVASTYLE
