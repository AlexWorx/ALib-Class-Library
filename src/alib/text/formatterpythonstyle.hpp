...
#define HPP_ALIB_TEXT_FORMATTER_PYTHONSTYLE 1
...
/** ************************************************************************************************
 * Implements a \alib{text,Formatter} according to the
 ...
 *   to consult the \ref aworx::lib::text::FormatterStdImpl "parent classes documentation".
 *
 ...
 *     \ref aworx::lib::text::FormatterStdImpl "FormatterStdImpl", features of the parent are
 ...
 *       \ref aworx::lib::text::PropertyFormatter "PropertyFormatter"
 ...
 *     \alib{text,FormatterStdImpl::AlternativeNumberFormat,FormatterStdImpl::AlternativeNumberFormat}
 ...
 *     \alib{text,FormatterStdImpl::DefaultNumberFormat,FormatterStdImpl::DefaultNumberFormat},
 ...
 *     \alib{text,FormatterStdImpl::DefaultNumberFormat,FormatterStdImpl::DefaultNumberFormat} apply.
 ...
 *   \ref alib_text_custom_types_fformat.
 *
 *   For example, \alib class \alib{time,DateTime} supports custom formatting with box-function
 *   \alib{system,FFormat_DateTime} which uses helper class \alib{system,CalendarDateTime} that
 ...
 *     Bracket types <b>'{'</b> and <b>'}'</b> can not be used with this conversion.
 ...
 *
 *     Which each new invocation of \alib{text,Formatter},
 ...
 *     in \aworx{lib,Module::GetResourcePool,library resources}. Modifications of such resources
 ...
 *   - \alib{text::Exceptions,IncompatibleTypeCode}
 *   - \alib{text::Exceptions,MissingClosingBracket}
 *   - \alib{text::Exceptions,MissingPrecisionValuePS}
 *   - \alib{text::Exceptions,DuplicateTypeCode}
 *   - \alib{text::Exceptions,UnknownTypeCode}
 *   - \alib{text::Exceptions,ExclamationMarkExpected}
 *   - \alib{text::Exceptions,UnknownConversionPS}
 *   - \alib{text::Exceptions,PrecisionSpecificationWithInteger}
 **************************************************************************************************/
class FormatterPythonStyle : public FormatterStdImpl
{
    ...
    protected:
         ...
         * addition to parent's \alib{text::FormatterStdImpl,PlaceholderAttributes}.
         */
    ...
    public:
         ...
         * \alib{text,Formatter::Next} is of type \b %FormatterStdImpl, then that
...
#endif // HPP_ALIB_TEXT_FORMATTER_PYTHONSTYLE
