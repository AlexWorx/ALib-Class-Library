...
/// - \alib{enums::arithmetical;operator-}
/// - \alib{enums::arithmetical;operator++}
/// - \alib{enums::arithmetical;operator++(TEnum&;std::underlying_type<TEnum>::type)}
/// - \alib{enums::arithmetical;operator--}
/// - \alib{enums::arithmetical;operator--(TEnum&;std::underlying_type<TEnum>::type)}
/// - \alib{enums::arithmetical;operator+=}
/// - \alib{enums::arithmetical;operator-=}
...
#endif
operator<  (TEnum  lhs, typename std::underlying_type<TEnum>::type rhs) noexcept
{
...
ATMP_T_IF(TEnum, alib::enums::T_EnumIsArithmetical<TEnum>::value)
#endif
operator++  (TEnum&  arg, typename std::underlying_type<TEnum>::type) noexcept
{
    using TValue= typename std::underlying_type<TEnum>::type;
    TEnum tmp= arg;
