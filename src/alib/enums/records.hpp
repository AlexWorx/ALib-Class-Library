...
//==================================================================================================
/// This namespace function initializes enum records, of built-in types i.e., those of the
/// enumerations found in the header file \alibheader{lang/commonenums.hpp}.
///
...
///
/// \note
///   In fact, if the module \alib_basecamp is included, then this function is (almost) empty,
...
//==================================================================================================
/// Frees resources and shuts down module \alib_enums.
/// Multiple invocations of this method are forbidden.
/// The \ref alib_manual_bootstrapping "standard bootstrap" code of \alib, hence the (overloaded)
/// functions \ref alib::Shutdown will call this function.
///
/// \see
///   Sibling function \alib{enums::Bootstrap}.
//==================================================================================================
ALIB_API
void       Shutdown();
...
///   which allows collecting the necessary run-time information to defer the retrieval of
///   enum records.
///
...
///
/// The rationale for the above is twofold: It reduces header file dependcies from the majority
...
#endif // DOXYGEN
{
    ...
    // Method implementations are given in separated header file "recordbootstrap.hpp"
    // #############################################################################################
    ...
    /// \p{definitions}.
    ///
    /// The use of inner struct \alib{enums::EnumRecords;Initializer} allows placing
    ...
    void Bootstrap( const String& input, character innerDelim=',', character outerDelim= ',' );
        ...
        ///
        /// \par Availability
        ///   This method is available only if the module \alib_basecamp is included in the \alibdist.
        ///
...
///   - Specializations
///     \alib{strings::APPENDABLES;T_Append<TEnum,TChar,TAllocator>} and
