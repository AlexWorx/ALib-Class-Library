...
template<typename T> inline constexpr int bitsofval(const T& val)
{
...
#if DOXYGEN
    /// Returns the logarithm base 2 for the size in bits of the template given integral type.<p>
    ...
    BitCount( TIntegral value )
    {
            ...
            return int(__popcnt64 (static_cast<TUnsigned>( value )));
