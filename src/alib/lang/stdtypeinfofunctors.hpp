...
/// functors #"TypeFunctors::Hash", #"TypeFunctors::EqualTo" and #"TypeFunctors::Less".
///
/// If, for example, a <c>std::unordered_map</c> should be instantiated with runtime type
...
struct TypeFunctors {
    ...
    struct Hash {
        ...
        /// @param typeinfo  Pointer to the runtime type information struct.
