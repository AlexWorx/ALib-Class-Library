...
enum class Initialization
{
    Suppress,     ///< Suppress initialization.
                  ///< Writes "Suppress", reads in addition "None".
    Default,      ///< Perform default initialization.
                  ///< Writes "Default", reads in addition "Initialize".
    Nulled,       ///< Perform initialization with a nulled value.
