...
/**
 * This namespace is available only in debug compilations of \alib (see code selection symbol
 * \ref ALIB_DEBUG).
 * It is used to collect debug facilities from other \alib namespaces.
 */
namespace debug {
