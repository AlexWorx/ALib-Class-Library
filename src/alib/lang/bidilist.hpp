...
/// design, see explanations of parent type #"SidiNodeBase".
///
/// By being derived from the aforementioned type, instances of \p{TElement} may also be added
/// to single-linked lists of type #"SidiListHook"). This is, for example,
/// used by types #"List" and #"HashTable" to
...
//==================================================================================================
/// This struct, together with sibling struct #"BidiNodeBase" provide the tools to
