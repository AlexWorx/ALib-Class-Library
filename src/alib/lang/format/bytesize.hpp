...
/// \alib{lang::format;BYTESIZE_NUMBER_FORMAT} is used.
///
...
///                           \alib{lang::format;ByteSizeUnits;IEC} or
///                           \alib{lang::format;ByteSizeUnits;SI}.
...
template<> struct T_Append< lang::format::ByteSizeIEC ,character, lang::HeapAllocator>
{
...
/// \note This specialization is available only if the module \alib_basecamp is included in the
///       \alibdist and a using source file includes header \alibheader{lang/format/bytesize.hpp}.
template<> struct T_Append< lang::format::ByteSizeSI ,character, lang::HeapAllocator>
{
...
ALIB_BOXING_VTABLE_DECLARE( alib::lang::format::ByteSizeIEC      , vt_lang_format_bytesize_iec )
ALIB_BOXING_VTABLE_DECLARE( alib::lang::format::ByteSizeSI       , vt_lang_format_bytesize_si  )
ALIB_BOXING_VTABLE_DECLARE( alib::lang::format::ByteSizeUnits    , vt_lang_format_bytesize_units )
