...
{
    friend class lang::basecamp::BaseCamp;
...
ALIB_ENUMS_ASSIGN_RECORD(  alib::lang::format::FormatterStdImpl::PHTypes, alib::enums::ERSerializable )
ALIB_RESOURCED_IN_MODULE(  alib::lang::format::FormatterStdImpl::PHTypes, alib::BASECAMP, "PHT" )
