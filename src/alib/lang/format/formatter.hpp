...
#endif
{
    ...
    public:
         ...
         * \alib{lang::basecamp,BaseCamp::bootstrap}), an object of type
         * \alib{lang::format,FormatterPythonStyle,FormatterPythonStyle} is created and a second
         *
         * one of type \alib{lang::format,FormatterJavaStyle,FormatterJavaStyle} is appended.
         * Those formatters will be deleted with \alib{lang::basecamp,BaseCamp::shutdown},
