...
namespace alib {  namespace results { class Exception; }
...
class Paragraphs
{
  ...
  public:
    ...
    /// - \alib{lang::format;Formatter::Default;ALib Default Formatter},
  ...
  public:
    ...
    /// For field #Formatter, \alib{lang::format;Formatter::Default} will be used.
    ALIB_API                 Paragraphs();
...
#if !DOXYGEN
template<> ALIB_API  void    Paragraphs::Add      ( boxing::TBoxes<HeapAllocator>&  args );
template<> ALIB_API  void    Paragraphs::Add      ( boxing::TBoxes<MonoAllocator>&  args );
template<> ALIB_API  void    Paragraphs::Add      ( boxing::TBoxes<PoolAllocator>&  args );
template<> ALIB_API  void    Paragraphs::AddMarked( boxing::TBoxes<HeapAllocator>&  args );
template<> ALIB_API  void    Paragraphs::AddMarked( boxing::TBoxes<MonoAllocator>&  args );
template<> ALIB_API  void    Paragraphs::AddMarked( boxing::TBoxes<PoolAllocator>&  args );
#endif // !DOXYGEN
