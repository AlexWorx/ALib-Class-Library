 ...
 **************************************************************************************************/
#ifndef HPP_ALIB_CAMP_DIRECTORY
#define HPP_ALIB_CAMP_DIRECTORY 1
 ...
 * Note: Available with including "alib/lang/system/directory.hpp"
 */
...
ALIB_ENUMS_ASSIGN_RECORD(   alib::lang::system::Directory::SpecialFolder, alib::enums::ERSerializable )
#endif // HPP_ALIB_CAMP_DIRECTORY
