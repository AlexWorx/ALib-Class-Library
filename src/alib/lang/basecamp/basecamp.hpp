...
///
/// \note
///   This constitutes an explicit exception to the general \alib rules: All other
...
// #################################################################################################
    ...
    ///  \ref alib_enums_records "ALib Enum Records" of type \alib{config;Declaration}
...
#if ALIB_CONFIGURATION
DOX_MARKER([DOX_CONFIG_DECLARATION5])
ALIB_ENUMS_ASSIGN_RECORD( alib::lang::basecamp::Variables, alib::config::Declaration )
