...
/// struct #"SidiListHook", provide all basic mechanisms to implement a single linked
/// list.
///
/// Because pointers to nodes and elements are statically castable to each other (which is a no-op),
...
/// As an example, class #"List" of module \alib_containers is built using these
/// helpers internally but publishes a full type safe interface, including iterator classes.
///
/// \see Types #"SidiListHook", #"BidiNodeBase", and #"BidiListHook".
///
...
struct SidiNodeBase {
    ...
    /// \attention
    ///   In case of using type  #"BidiListHook", this may point to an instance of the
    ///   base type  #"BidiNodeBase".
    TElement*   n;
    ...
    ///             <b>[</b>#"SidiNodeBase::n"<b>, </b> \p{last}<b>]</b> which is removed.
    ///
...
//==================================================================================================
/// This class, together with sibling class #"SidiNodeBase" provide the tools to
/// implement a single linked list of \p{TElement} instances.
///
/// \see Types #"SidiNodeBase",<br>
///       #"BidiNodeBase", and<br>
///       #"BidiListHook".
///
