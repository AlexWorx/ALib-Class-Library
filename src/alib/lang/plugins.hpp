...
/// Within \alib itself, for example, classes #"Configuration" and
/// #"Compiler" inherit from this class.
///
...
class PluginContainer {
  ...
  public:
    ...
    /// #"Responsibility::Transfer;*" will be deleted.
    ~PluginContainer() {
  ...
  public:
    ...
    /// <c>0..[#".CountPlugins"]</c>. No internal checks for valid plug-in numbers are made.
    ///
    ...
    /// Same as #".GetPlugin(integer)", but converts the plug-in found to the template type, which
    /// has to be explicitly provided with the invocation of this method.
    ///
