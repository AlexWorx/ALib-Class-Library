...
///
/// See also #"alib::uinteger;alib::uinteger".
///
...
/// Unsigned version of #"alib::integer;alib::integer".
...
/// #"alib::uintGap_t;alib::uintGap_t" is used to fill a gap that occurs
...
///
/// \see
///   Along with these definitions, configuration macro #"ALIB_SIZEOF_INTGAP" is defined.
using  intGap_t=                    platform_specific;

 /// Used to complete overwriting methods and template specializations.<br>
 /// See signed sibling type #"alib::intGap_t;alib::intGap_t" for more information.
...
#else
    #error "Configuration macro 'ALIB_SIZEOF_INTEGER' supports only values 4 and 8."
#endif
