...
/// class #"SharedVal" and is an almost full-featured alternative for
...
///   The shared objects are always created with construction of this class or with the method
///   #".InsertDerived(TArgs&& ...)" .
/// - Special method #".InsertDerived(TAllocator&, TArgs&& ...)" is to be used, in case types
///   derived from \p{T} are to be placed inside.
...
///
/// \see
///   - Sibling class #"SharedVal", with is a restricted but slightly more efficient
///     version of this class.
///   - Class #"TSharedMonoVal" of module \alib_monomem, which incorporates
///     an own embedded instance of class #"TMonoAllocator".
...
class SharedPtr {
  protected:
    ...
    /// Note, that in the case that #"HeapAllocator" is used parent class
    /// #"%AllocatorMember" will be empty.
    template<typename U>
    struct FieldMembers : lang::AllocatorMember<TAllocator> {
        ...
        /// Constructor.
        /// @param  pAllocator The allocator, stored in parent #"%AllocatorMember".
  ...
  public:
    ...
    lang::AllocatorInterface<TAllocator> AIF()           const noexcept { return GetAllocator()(); }
