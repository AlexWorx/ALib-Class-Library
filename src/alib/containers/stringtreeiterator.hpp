...
/// This class is to be used with instances of class #"StringTree" and allows
...
/// For example, when processing files with class #"FTree", an application might
...
///   #"alib_ns_containers_stringtree_iterator"
///   of the description of class #"%StringTree".
///
/// @tparam TStringTree  The #"StringTree" that this class is working with.
...
class StringTreeIterator {
  ...
  public:
    ...
    /// Evaluates to the constant or mutable types #"StringTree::Cursor;*" or
    /// or #"StringTree::ConstCursor;*".
  ...
  public:
    ...
    struct NameSorter : Sorter {
        ...
        /// the string method #"TString;CompareTo".
        /// @param lhs  The left-hand side cursor to the node to compare.
        /// @param rhs  The right-hand side cursor to the node to compare.
...
//###################################### Constructor/Destructor ####################################
  ...
  //########################################### Interface ##########################################
    ...
    /// Resets this iterator to the first child of the node that the given cursor object
    /// represents, or, in case parameter \p{includeStartNode} indicates so, to the given
    /// \p{startNode} itself.<br>
    ...
    /// Determines if this instance is valid. #"%StringTreeIterator" instances may become invalid
    ...
    ///
    /// \note
    ///   It is \b not allowed to use the method #"TCursor::Delete" on the node returned by
    ///   this method.
    ///   As a replacement, use the method #".DeleteNode" provided with this class.<br>
    ///   However, the methods #"TCursor::DeleteChild(TCur)" and #"TCursor::DeleteChildren"
    ///   are allowed to be invoked and therefore have no replacement in this class.
    ///
  ...
  //######################################### node deletion ########################################
    ...
    ///   The methods #"TCursor::DeleteChild(TCursor&)" and "TCursor::DeleteChildren"
