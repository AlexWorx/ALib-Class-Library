...
//==================================================================================================
#ifndef HPP_ALIB_MONOMEM_CONTAINERS_LRUCACHETABLE
#define HPP_ALIB_MONOMEM_CONTAINERS_LRUCACHETABLE 1
#pragma once
  ...
  //================================================================================================
    ...
    class TForwardIterator
    {
        ...
        public:
            ...
            #else
                ATMP_SELECT_IF_1TP( typename TMutable, ATMP_EQ( TMutable, TForwardIterator<StoredType> ) )
                TForwardIterator( const TMutable& mutableIt )
...
#endif // HPP_ALIB_MONOMEM_CONTAINERS_LRUCACHETABLE
