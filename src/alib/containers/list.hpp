...
/// Extents #"%BidiNodeBase" by an value of type \p{T}.
template<typename T>
...
/// #"alib_mods_contmono;Programmer's Manual" of this module.
namespace containers {


//==================================================================================================
/// Implements a doubly linked list, likewise \c std::list does. Memory for inserted elements is
/// allocated using the #"lang::Allocator" provided with construction.
///
...
#endif
{
  ...
  public:
    ...
    ///   #"Recycling::Shared" and if argument \p{TAllocator}
    ///   does not equal type #"HeapAllocator".
    List()
    #if ALIB_DEBUG_CRITICAL_SECTIONS
    ...
    /// Copy constructor.
    /// Invokes the implementation-dependent copy constructor of recycler, copies the pointer to the
    ...
    /// Move constructor.
    /// Invokes the implementation-dependent move constructor of recycler, moves the pointer to the
    /// allocator and then copies each element.
    ...
    /// #"Recycling::Shared". In this case, the elements are still
    /// recycled.
    ///
