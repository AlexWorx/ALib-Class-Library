...
/// application.
///
/// Instead, class #"Trigger" will be the only responsible entity to
/// trigger such actions within its own execution thread.
///
/// @see Chapter #"alib_thrmod_trigger" of this module's Programmer's Manual
...
//==================================================================================================
/// The #"%Trigger" class provides a mechanism to periodically "trigger" actions on objects
...
/// #"%Triggered:trigger" methods are called periodically based on the time interval given with
/// their respective method #"Triggered::triggerPeriod".
///
/// Internally, #"%Trigger" operates its own thread to handle the timing and execution of
...
///
/// \par Usage:
/// - Users register their implementations of the #"%Triggered" interface with the #"Add()" method
///   to begin periodic triggers.
/// - Objects can be unregistered using the #".Remove" method.
/// - Method #".Stop" method terminates the execution of the internal thread.
///
                  ...
                  protected   TCondition<Trigger>
{
  ...
  protected:
    ...
    /// The condition requested by parent class #"TCondition" via a call to
    /// #".isConditionMet".
  ...
  public:
    ...
    /// Destructor.
    ALIB_DLL  virtual      ~Trigger()                                                      override;

    using Thread::Start;
    
    /// Implementation of the parent interface (virtual abstract).
    ALIB_DLL  virtual void  Run()                                                          override;
