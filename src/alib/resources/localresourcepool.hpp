...
/// #"ResourcePool", which does \b not externalize resources.
///
/// A shared instance of this class is attached to each \alibmod, if the
/// #"alib_mod_bs;bootstrapping of ALib" is not customized.
///
/// With the use of type #"HashTable" for its internal data management, this
/// class uses #"alib_mods_contmono;monotonically growing memory" taken from the global
/// allocator.
///
...
///
/// \see
///   Please consult the #"alib_mod_resources;Programmer's Manual" of module \alib_resources_nl
///   for details on the concept of resources.
///   Some details on this specific type are given in chapter
///   #"alib_resources_interface_default".
//==================================================================================================
class LocalResourcePool  : public ResourcePool {
  protected:
    ...
    ///
    /// \see Manual section #"alib_resources_details_debug".
  ...
  public:
    ...
    ///    #"HashTable::Reserve",
    ///    #"HashTable::BaseLoadFactor()",
    ///    #"HashTable::BaseLoadFactor(float)",
    ///    #"HashTable::MaxLoadFactor()"), or
    ///    #"HashTable::MaxLoadFactor(float)").
    ///
  ...
  //################################################################################################
    ...
    /// \note
    ///   If the configuration macro #"ALIB_DEBUG_RESOURCES" is set on compilation and static field
    ///   #"LocalResourcePool::DbgResourceLoadObserver;*" is set before bootstrapping,
    ...
    const String&   Get( const NString& category, const NString& name
        ...
        ///   #"LocalResourcePool" is used.
        ///   Otherwise, an \alib_warning is raised and an empty vector is returned.
        ///
        /// \see
        ///   Namespace function #"resources::DbgDump", method #".DbgGetCategories" and field
