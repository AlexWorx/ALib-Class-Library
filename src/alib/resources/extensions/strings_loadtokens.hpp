...
///   the resource pool. To ensure this, with debug-builds, the parameter \p{dbgSizeVerifier}
///   has to be provided (preferably by using the macro #"ALIB_DBG").
///
/// \par Availability
///   This function is an extension, which is injected by the higher-level module \alib_resources
///   and is accessed through the header file #"F;ALib.Resources.H".
