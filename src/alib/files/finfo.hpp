...
class FInfo
{
  ...
  public:
    ...
    struct  DirectorySums
    {
        ...
        uint32_t Count(Types type)                                                    const noexcept
        {
            ALIB_ASSERT_ERROR( type < Types::MARKER_TYPES_END,
               "FILES", "Cant get count for file type {!Q}", type )
    ...
    {
        lang::system::CPathString   Target;      ///< The target path.
                                                 ///<  This is a zero-terminated \b CString.
        lang::system::CPathString   RealTarget;  ///< The resolved real target path.
    };
...
public:
    ...
    void                    SetLinkTarget(FTree& tree, const lang::system::PathString& target,
    ...
    [[nodiscard]] lang::system::CPathString&  GetLinkTarget()  const noexcept
    {
        ALIB_ASSERT_ERROR(    Type() == FInfo::Types::SYMBOLIC_LINK
                           || Type() == FInfo::Types::SYMBOLIC_LINK_DIR, "FILES",
    ...
    [[nodiscard]] lang::system::CPathString&  GetRealLinkTarget()  const noexcept
    {
        ALIB_ASSERT_ERROR(    Type() == FInfo::Types::SYMBOLIC_LINK
                           || Type() == FInfo::Types::SYMBOLIC_LINK_DIR, "FILES",
                      "Given node is not a symbolic link.")
