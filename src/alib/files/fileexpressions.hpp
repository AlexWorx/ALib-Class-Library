 ...
 *
 * Each types are auto-casted to \b Integer to allow all common operators, especially bitwise
 * boolean operators.
 *
 * ## Constants:  ##
 * <br>
...
* DateTime                            | \b Time          | time              | ./.        | Returns the result of \alib{files::FInfo,MTime}.
* DateTime                            | \b MTime         | mt                | ./.        | Returns the result of \alib{files::FInfo,MTime}.
* DateTime                            | \b CTime         | ct                | ./.        | Returns the result of \alib{files::FInfo,CTime}.
* DateTime                            | \b ATime         | at                | ./.        | Returns the result of \alib{files::FInfo,ATime}.
...
class FileExpressions
{
  ...
  public:
    ...
    struct Scope : public ExpressionScope
    {
        FTree::ConstCursor  Node;          ///< A node of a \alib{files,FTree}.
        String              ParentPath;    ///< The absolute path to the parent directory.

        using expressions::Scope::Scope;
    };
    ...
    class Filter  : public FFilter
    {
      protected:
        ...
        Scope             scope;       ///< The scope used with this filter.
        SPExpression      expression;  ///< The compiled expression.
