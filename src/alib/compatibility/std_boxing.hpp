...
///   the \alibdist,  mutex \alib{monomem;GLOBAL_ALLOCATOR_LOCK} has to be locked before an
///   invocation.
///   Bootstrapping may look as follows:
///     \snippet "gtest_main.cpp"     DOX_COMPATIBILITY_BOOTSTRAP
///
/// \note
///   (Note, that the curly brackets create a compound that release the automatic owner instance
///   after the call.) <br>
...
inline void BootstrapStdStringBoxing()
{
        ...
        alib::boxing::BootstrapRegister<FAppend<nchar, lang::HeapAllocator>, boxing::TMappedTo<::std::reference_wrapper<::std::string   >>>( boxing::FAppend<nchar, lang::HeapAllocator>::WrappedAppendable<::std::string   > );
        alib::boxing::BootstrapRegister<FAppend<wchar, lang::HeapAllocator>, boxing::TMappedTo<::std::reference_wrapper<::std::string   >>>( boxing::FAppend<wchar, lang::HeapAllocator>::WrappedAppendable<::std::string   > );
        alib::boxing::BootstrapRegister<FAppend<nchar, lang::HeapAllocator>, boxing::TMappedTo<::std::reference_wrapper<::std::wstring  >>>( boxing::FAppend<nchar, lang::HeapAllocator>::WrappedAppendable<::std::wstring  >);
        alib::boxing::BootstrapRegister<FAppend<wchar, lang::HeapAllocator>, boxing::TMappedTo<::std::reference_wrapper<::std::wstring  >>>( boxing::FAppend<wchar, lang::HeapAllocator>::WrappedAppendable<::std::wstring  >);
        #if ALIB_SIZEOF_WCHAR_T == 4
        alib::boxing::BootstrapRegister<FAppend<nchar, lang::HeapAllocator>, boxing::TMappedTo<::std::reference_wrapper<::std::u16string>>>( boxing::FAppend<nchar, lang::HeapAllocator>::WrappedAppendable<::std::u16string>);
        alib::boxing::BootstrapRegister<FAppend<wchar, lang::HeapAllocator>, boxing::TMappedTo<::std::reference_wrapper<::std::u16string>>>( boxing::FAppend<wchar, lang::HeapAllocator>::WrappedAppendable<::std::u16string>);
        #else
        alib::boxing::BootstrapRegister<FAppend<nchar, lang::HeapAllocator>, boxing::TMappedTo<::std::reference_wrapper<::std::u32string>>>( boxing::FAppend<nchar, lang::HeapAllocator>::WrappedAppendable<::std::u32string>);
        alib::boxing::BootstrapRegister<FAppend<wchar, lang::HeapAllocator>, boxing::TMappedTo<::std::reference_wrapper<::std::u32string>>>( boxing::FAppend<wchar, lang::HeapAllocator>::WrappedAppendable<::std::u32string>);
        #endif
