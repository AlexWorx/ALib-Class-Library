...
// #################################################################################################
#ifndef HPP_ALIB_STRINGFORMAT_FORMATTER_JAVASTYLE
#define HPP_ALIB_STRINGFORMAT_FORMATTER_JAVASTYLE 1
 ...
 *   - \alib{stringformat::Exceptions,ArgumentIndexIs0}
 *   - \alib{stringformat::Exceptions,ArgumentIndexOutOfBounds}
 *   - \alib{stringformat::Exceptions,IncompatibleTypeCode}
 *   - \alib{stringformat::Exceptions,NegativeValuesInBracketsNotSupported}
 *   - \alib{stringformat::Exceptions,MissingPrecisionValueJS}
 *   - \alib{stringformat::Exceptions,HexadecimalFloatFormatNotSupported}
 *   - \alib{stringformat::Exceptions,NoAlternateFormOfConversion}
 *   - \alib{stringformat::Exceptions,NoPrecisionWithConversion}
 *   - \alib{stringformat::Exceptions,UnknownDateTimeConversionSuffix}
 *   - \alib{stringformat::Exceptions,UnknownConversionJS}
 *
 **************************************************************************************************/
...
#endif // HPP_ALIB_STRINGFORMAT_FORMATTER_JAVASTYLE
