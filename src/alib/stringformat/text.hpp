...
// #################################################################################################
#ifndef HPP_ALIB_STRINGFORMAT_TEXT
#define HPP_ALIB_STRINGFORMAT_TEXT 1

#if !defined (HPP_ALIB_STRINGFORMATTER_PYTHONSTYLE)
 ...
 *
 * One central \b static method is #FormatParagraph, which  format a "paragraph" that starts at a
 ...
 * formatted using static method #FormatParagraph.<br>
...
class Text
{
    ...
    // #############################################################################################
    protected:
        /** Internal buffer, used for field #Text, if no external string object was given.*/
        AString     text;
    ...
    public:
         ...
         *  - \alib{stringformat,Stringformat::GetDefaultFormatter} in the case that this object's template
         ...
         */
        std::shared_ptr<lib::stringformat::Formatter>
                                        Formatter;
    ...
    public:
         ...
         */
        ALIB_API                 Text( AString& externalBuffer );
    ...
    public:
        ...
        ALIB_API
        static
        void    FormatParagraph( AString&      text,
                                 integer                           startIdx,
                                 integer                           lineWidth,
        ...
        Text&  Add( const BoxedObjects&... args )
        {
            boxes.clear();
            boxes.Add( args... );
            Add( boxes );
         ...
         *   - \alib{stringformat::Exceptions,UnknownMarker}
         *   - \alib{stringformat::Exceptions,EndmarkerWithoutStart}
         *
         * @param args       The list of arguments to add.
         ******************************************************************************************/
        ALIB_API
         ...
         ******************************************************************************************/
        template <typename... BoxedObjects>
        Text&  AddMarked( const BoxedObjects&... args )
        {
            boxes.clear();
            boxes.Add( args... );
            AddMarked( boxes );
         ...
         ******************************************************************************************/
        ALIB_API
        Text&     PushIndent( uinteger qty, character fillChar = ' ' );
         ...
         ******************************************************************************************/
        ALIB_API
        Text&     PushIndent( const String& indentFirstLine,
                               const String& indentOtherLines=nullptr);
...
#endif // HPP_ALIB_STRINGFORMAT_TEXT
