...
// #################################################################################################
#ifndef HPP_ALIB_STRINGFORMAT_FORMATTER_PYTHONSTYLE
#define HPP_ALIB_STRINGFORMAT_FORMATTER_PYTHONSTYLE 1
...
/** ************************************************************************************************
 * Implements a \alib{stringformat,Formatter} according to the
 ...
 *   to consult the \ref aworx::lib::stringformat::FormatterStdImpl "parent classes documentation".
 *
 ...
 *     \ref aworx::lib::stringformat::FormatterStdImpl "FormatterStdImpl", features of the parent are
 ...
 *       \ref aworx::lib::stringformat::PropertyFormatter "PropertyFormatter"
 ...
 *     \alib{stringformat,FormatterStdImpl::AlternativeNumberFormat,FormatterStdImpl::AlternativeNumberFormat}
 ...
 *     \alib{stringformat,FormatterStdImpl::DefaultNumberFormat,FormatterStdImpl::DefaultNumberFormat},
 ...
 *     \alib{stringformat,FormatterStdImpl::DefaultNumberFormat,FormatterStdImpl::DefaultNumberFormat} apply.
 ...
 *     Finally, if flag
 *     \alib{strings,TNumberFormat::ForceScientific,ForceScientific}
 ...
 *   is found in the documentation of \alibmod_boxing , chapter
 *   \ref alib_boxing_strings_fappend.
 *
 ...
 *   \alib{stringformat,FFormat} is available. This interface is invoked and string
 ...
 *   \ref alib_stringformat_custom_types_fformat.
 *
 *   For example, \alib class \alib{time,DateTime} supports custom formatting with box-function
 *   \alib{stringformat,FFormat_DateTime} which uses helper class \alib{system,CalendarDateTime} that
 *   provides a very common specific mini language for
 *   \alib{system::CalendarDateTime,Format,formatting date and time values}.
 *
 * <p>
 * - <b>Conversions:</b><br>
 ...
 *
 *     Which each new invocation of \alib{stringformat,Formatter},
 ...
 *     in \aworx{lib,Module::Resources,library resources}. Modifications of such resources might use this
 ...
 * @throws aworx::lib::stringformat::Exceptions
 *   - \alib{stringformat::Exceptions,ArgumentIndexOutOfBounds}
 *   - \alib{stringformat::Exceptions,IncompatibleTypeCode}
 *   - \alib{stringformat::Exceptions,MissingClosingBracket}
 *   - \alib{stringformat::Exceptions,MissingPrecisionValuePS}
 *   - \alib{stringformat::Exceptions,DuplicateTypeCode}
 *   - \alib{stringformat::Exceptions,UnknownTypeCode}
 *   - \alib{stringformat::Exceptions,ExclamationMarkExpected}
 *   - \alib{stringformat::Exceptions,UnknownConversionPS}
 *   - \alib{stringformat::Exceptions,PrecisionSpecificationWithInteger}
 **************************************************************************************************/
class FormatterPythonStyle : public FormatterStdImpl
{
    ...
    protected:
         ...
         * addition to parent's \alib{stringformat::FormatterStdImpl,PlaceholderAttributes}.
         */
    ...
    public:
         ...
         * \alib{stringformat,Formatter::Next} is of type \b %FormatterStdImpl, then that
    ...
    protected:
         ...
         * \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,FormatSpec}.
         *
...
#endif // HPP_ALIB_STRINGFORMAT_FORMATTER_PYTHONSTYLE
