...
#ifndef HPP_ALIB_STRINGFORMAT_PROPERTY_FORMATTER
#define HPP_ALIB_STRINGFORMAT_PROPERTY_FORMATTER
 ...
 *
 * For this, the format string definition of \alib \alib{stringformat,Formatter}
 ...
 * \ref alib_stringformat_intro "standard ALib format strings" is passed.
 ...
 *
 * A vector of tuples need to be defined and passed to the constructor of this class.
 ...
 *
 * In case of
 * \alib{stringformat,FormatterPythonStyle,FormatterPythonStyle} format strings,
 ...
 *
 * In case of
 * \alib{stringformat,FormatterJavaStyle,FormatterJavaStyle}, which uses \b '\%'
 ...
 *
 * Furthermore, with the second element of tuple \ref TCallbackTableEntry, it is possible
 ...
 * If \alibmod_expressions is compiled with the library, a utility class similar to this one
...
class PropertyFormatter
{
    public:
         ...
         * - - - - - - - -| - - - - - - - - - - - - - - -| - - - - - - - - - - - - - - - - - - - -
         * 0  | \alib{strings,TString,String}| The identifier string
...
using PropertyFormatter  =    aworx::lib::stringformat::PropertyFormatter;

} // namespace [aworx]


#endif // HPP_ALIB_STRINGFORMAT_PROPERTY_FORMATTER
