...
#define HPP_ALIB_STRINGFORMAT_FORMATTER_STD 1
 ...
 * \alib{stringformat,Formatter::format} and introduces a set of
 ...
 * may set field \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,FormatSpec} to reflect
 * a format-specific portion the placeholder string.
 * If it does, it will be checked if the argument supports box-function \alib{stringformat,FFormat},
 ...
 *   \alib{stringformat,FormatterPythonStyle,FormatterPythonStyle} as the
 *   "Python format mini language" supports such custom format specifications. Class
 *   \alib{stringformat,FormatterJavaStyle,FormatterJavaStyle} does \b not support
 *   this mechanism.
 *
 ...
 *       set fields
 *       \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,Arg} and
 *       \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,ArgIdx}
 ...
 *     \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,FormatSpec}
 *     and if yes, if box-function \alib{stringformat,FFormat} is defined for
 *     \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,Arg}.
...
class FormatterStdImpl : public Formatter
{
    ...
    protected:
        ...
        enum class PHTypes
        {
            ...
            // special
            Fill            , ///< Writes \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,FillChar}
        ...
        struct PlaceholderAttributes
        {
             ...
             *  This is set to
             *  \ref aworx::lib::stringformat::FormatterStdImpl::PHTypes::NotGiven "PHTypes::NotGiven"
             ...
             *  \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,Arg,argument}.
             *  This is set by #parsePlaceholder if explicit indexing is used. Otherwise by #format
             *  which invokes #setArgument if #parsePlaceholder did not set it yet.
             ...
             *  This is set to \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,ArgIdx}
             *  in default implementation of #resetPlaceholder. */
            int                 PreviousArgIdx;
    ...
    protected:
         ...
         * Field \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,FormatSpec}
         ...
         * \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,FormatSpec} is set and object
         * \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,Arg}
         * supports an own format specifier by providing box-function
         * \alib{stringformat,FFormat}.
         ...
         *
         * @return \c true if \alib{stringformat::FormatterStdImpl::PlaceholderAttributes,Arg}
         ...
         *   \alib{stringformat::Exceptions,IncompatibleTypeCode} is thrown.
         *
...
#endif // HPP_ALIB_STRINGFORMAT_FORMATTER_STD
