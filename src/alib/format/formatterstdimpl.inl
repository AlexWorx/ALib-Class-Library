...
/// \alib{format;Formatter::format} and introduces a set of
...
/// may set field \alib{format::FormatterStdImpl::PlaceholderAttributes;FormatSpec} to reflect
/// a format-specific portion the placeholder string.
/// It will be checked if the argument supports box-function \alib{format;FFormat},
...
///   \alib{format;FormatterPythonStyle;FormatterPythonStyle} as the
///   "Python format mini language" supports such custom format specifications. Class
///   \alib{format;FormatterJavaStyle;FormatterJavaStyle} does \b not support
///   this mechanism.
///
...
///     invoked for the rest of the string before exiting the function.
///
...
///     substring in field
///     \alib{format::FormatterStdImpl::PlaceholderAttributes;FormatSpec}.
///
...
///       set fields
///       \alib{format::FormatterStdImpl::PlaceholderAttributes;Arg} and
///       \alib{format::FormatterStdImpl::PlaceholderAttributes;ArgIdx}
...
///     The default implementation checks whether  box-function \alib{format;FFormat} is defined for
///     \alib{format::FormatterStdImpl::PlaceholderAttributes;Arg}.
...
///     \ref alib_mod_assert "raises an error" if the argument does not fit to the placeholder
...
class FormatterStdImpl : public Formatter
{
    ...
    public: // needs to be public because it is resourced in Basecamp
        ...
        enum class PHTypes
        {
            ...
            Fill     , ///< Writes \alib{format::FormatterStdImpl::PlaceholderAttributes;FillChar}
    ...
    protected:
        ...
        struct PlaceholderAttributes
        {
            ...
            /// Set to \c nullptr in the default implementation of #resetPlaceholder.
            const Box*          Arg;
            ...
            /// This field is \e nulled in the default implementation of #resetPlaceholder.
            ...
            /// This is set to
            /// \ref alib::format::FormatterStdImpl::PHTypes::NotGiven "PHTypes::NotGiven"
            /// in the default implementation of #resetPlaceholder.
            PHTypes             Type;
            ...
            /// \alib{format::FormatterStdImpl::PlaceholderAttributes;Arg;argument}.
            /// This is set by #parsePlaceholder if explicit indexing is used. Otherwise by #format
            /// which invokes #setArgument if #parsePlaceholder did not set it yet.
            /// Set to \c -1 in the default implementation of #resetPlaceholder.
            int                 ArgIdx;
            ...
            /// This is set to \alib{format::FormatterStdImpl::PlaceholderAttributes;ArgIdx}
            /// in the default implementation of #resetPlaceholder.
            int                 PreviousArgIdx;

            /// The (minimum) width of the output.
            /// This is set to \c 0 in the default implementation of #resetPlaceholder.
            int                 Width;
            ...
            /// This is set to \c -1 in the default implementation of #resetPlaceholder.
            int                 CutContent;
            ...
            /// This is set to \c false in the default implementation of #resetPlaceholder.
            ...
            /// Set to \c false in the default implementation of #resetPlaceholder.
            ...
            /// Is \e nulled in the default implementation of #resetPlaceholder.
            character           TypeCode;
        };
    ...
    protected:
        ...
        /// Field \alib{format::FormatterStdImpl::PlaceholderAttributes;FormatSpec}
        ...
        /// \alib{format::FormatterStdImpl::PlaceholderAttributes;Arg} supports an own format specifier
        /// by disposing about box-function \alib{format;FFormat}.
        /// If so, the function is invoked with passing
        /// \alib{format::FormatterStdImpl::PlaceholderAttributes;FormatSpec}, the result of the
        ...
        ///
        /// @return \c true if \alib{format::FormatterStdImpl::PlaceholderAttributes;Arg}
        ...
        ///   \alib{format::FMTExceptions;IncompatibleTypeCode} is thrown.
        ///
