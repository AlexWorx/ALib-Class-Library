...
ALIB_EXPORT namespace alib::format {
    ...
    ///     \ref alib::format::FormatterStdImpl "FormatterStdImpl", features of the parent are
    ...
    ///       \ref alib::format::PropertyFormatter "PropertyFormatter"
    ...
    ///   the placeholder disposes of a custom implementation of box function \alib{format;FFormat}.
    ...
    ///   \ref alib_format_custom_types_fformat.
    ///
    ///   For example, \alib class \alib{time;DateTime} supports custom formatting with box-function
    ///   \alib{format;FFormat_DateTime} which uses helper-class
    ///   \alib{strings::util;CalendarDateTime} that provides a very common specific mini language
    ///   for \alib{strings::util::CalendarDateTime;Format;formatting date and time values}.
    ///
    /// <p>
    /// - <b>Conversions:</b><br>
    ...
    ///     See \alib{strings;TEscape;Escape} for details about the conversion
    ...
    ///
    ///     Which each new invocation of \alib{format;Formatter},
    ...
    ///     in \alib{camp::Camp;GetResourcePool;library resources}. Modifications of such resources
    ...
    class FormatterPythonStyle : public FormatterStdImpl
    {
        ...
        /// \alib{format;FormatterStdImpl::writeStringPortion}.<br>
