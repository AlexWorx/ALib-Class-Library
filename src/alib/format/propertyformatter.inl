...
/// \ref alib_format_intro "standard ALib format strings" is passed.
...
///
/// In case of
/// \alib{format;FormatterPythonStyle;FormatterPythonStyle} format strings,
...
///
/// In case of
/// \alib{format;FormatterJavaStyle;FormatterJavaStyle}, which uses \b '\%'
