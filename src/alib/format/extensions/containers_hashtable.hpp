...
/// Invokes method #"DbgGetHashTableDistribution" and creates human-readable
...
//    Furthermore the configuration macro #"ALIB_DEBUG_CONTAINERS" has to be set.
///
/// \see
///   Sibling namespace functions #"DbgGetHashTableDistribution" and
...
///
/// Before invoking this method, specializations of #"AppendableTraits" have to be made
/// and furthermore, boxed values of the type have to be <em>"made appendable"</em> to
/// instances of type #"%AString". The latter is rather simple, if done using
/// #"ALIB_BOXING_BOOTSTRAP_REGISTER_FAPPEND_FOR_APPENDABLE_TYPE;this macro" during bootstrap.
///
/// \note
...
///   inline function and adopt the #"Formatter::Format;*" statement to
...
/// \see
///   Sibling namespace functions #"DbgGetHashTableDistribution" and
///   #"DbgDumpDistribution" provided for debugging and optimization.
///
/// @tparam THashtable          A specification  of templated type #"HashTable".
///                             Deduced by the compiler by given parameter \p{hashtable}.
/// @param  hashtable           The hashtable to investigate on.
