...
/// allocated using an internal field of type #"MonoAllocator".
...
///   Furthermore, the configuration macro #"ALIB_DEBUG_BOXING" has to be set.
//==================================================================================================
...
/// See function #".TypeInfo(const String&, const String&)", which invokes this function using
/// template parameter \p{TBoxable}
/// \par Availability
///   This function is an extension, which is injected by the higher-level module \alib_format and
///   is accessed through the header file #"F;ALib.Format.H".
///   Furthermore, the configuration macro #"ALIB_DEBUG_BOXING" has to be set.
...
///                                      struct #"ArrayTraits" allows implicit access
...
///                                      struct #"ArrayTraits" be implicitly
...
/// #".typeInfo".<br>
/// See function #".TypeInfo(const String&, const String&)".
///
/// \par Availability
///   This function is an extension, which is injected by the higher-level module \alib_format and
///   is accessed through the header file #"F;ALib.Format.H".
...
/// Hence, for types that are not default-constructible, the function #"%.TypeInfo(const Box&);()"
/// has to be used with a accordingly boxed "sample" of type \p{TBoxable}
///
/// \note
...
/// #"%AString" with a sorted list of type names, including their counter information.
///
/// \par Availability
///   This function is an extension, which is injected by the higher-level module \alib_format and
///   is accessed through the header file #"F;ALib.Format.H".
...
void     dumpVTables( AString&                                 target,
    ...
    /// Invokes #"DbgDumpDistribution" on the internal hash table used to register
    ...
    ///   and is accessed through the header file #"F;ALib.Format.H".
    ///   Furthermore, the configuration macros #"ALIB_DEBUG_BOXING" and #"ALIB_DEBUG_CONTAINERS"
    ///   are set.
    /// @param[out] target              The target string to write to.
