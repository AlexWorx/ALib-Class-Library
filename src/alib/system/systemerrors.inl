...
/// In case module \alib_camp is included in the \alibbuild, the enum record
/// \alib{exceptions;ERException} is assigned and each error is resourced in the
/// \alib{camp;Basecamp}.
/// With that, these enums can be used as information entries in class \alib{exceptions;Exception}.
//==================================================================================================
...
ALIB_BOXING_VTABLE_DECLARE(   alib::system::SystemErrors , vt_system_systemerrors     )
#if ALIB_ENUMRECORDS && ALIB_EXCEPTIONS
  ALIB_ENUMS_ASSIGN_RECORD(   alib::system::SystemErrors , alib::exceptions::ERException  )
#endif
