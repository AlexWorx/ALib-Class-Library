...
class ProcessInfo {
  ...
  protected:
        ...
        /// of #"Current".
        ALIB_DLL static ProcessInfo    current;
  ...
  public:
    ...
    ///
    /// @return \c true on success, \c false otherwise.
    ALIB_DLL bool          Get( uinteger processID  )                   { return get( processID ); }
    #endif

    /// Static method that receives information on the current process.
    ///
    /// @return A constant reference to a #"%ProcessInfo" object representing the current process.
    ALIB_DLL static
