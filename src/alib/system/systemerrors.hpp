 ...
 **************************************************************************************************/
#ifndef HPP_ALIB_SYSTEM_ERRORS
#define HPP_ALIB_SYSTEM_ERRORS 1
 ...
 * do not have a corresponding enum record. \alib{system,SystemErrors::UNKNOWN} is thrown
