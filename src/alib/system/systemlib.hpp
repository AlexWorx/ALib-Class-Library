...
/** ************************************************************************************************
 * This namespace of \alib holds classes and functions that are interfacing with the operating
 * system.
 **************************************************************************************************/
namespace system {
...
class System  : public lang::Library
{
    ...
    public:
        inline  System()
                : lang::Library( ALIB_VERSION, ALIB_REVISION, ASTR("ALIB_SYSTEM") )
        {}
...
ALIB_LANG_EXCEPTIONS( aworx::lib::system::Exceptions  , SYSTEM, ASTR("Exceptions")   )
ALIB_LANG_EXCEPTIONS( aworx::lib::system::SystemErrors, SYSTEM, ASTR("SystemErrors") )
