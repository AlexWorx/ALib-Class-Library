...
class ScopeStore
{
    ...
    public:
         ...
         */
        using LanguageStore= strings::util::StringTree<StoreT, strings::util::StringTreeBlockAllocator<StoreT,512>>;
        ...
        /** The outer thread map of values. */
        std::map<ThreadID, std::vector<StoreT>>     threadOuterStore;

        /** The inner thread map of values. */
        std::map<ThreadID, std::vector<StoreT>>     threadInnerStore;
    ...
    public:
         ...
         ******************************************************************************************/
        ALIB_API
        void InitAccess    ( Scope scope, int pathLevel, ThreadID threadID );
...
extern template   void                         ScopeStore<NAString*>                   ::InitAccess (Scope,int,ThreadID);
...
extern template   void                         ScopeStore<Box*>                        ::InitAccess (Scope,int,ThreadID);
extern template   void                         ScopeStore<Box*>                        ::initCursor (bool);
extern template   Box*                         ScopeStore<Box*>                        ::access     (int,Box*);
extern template                                ScopeStore<std::map<NAString, int>*>    ::ScopeStore (ScopeInfo&, bool);
extern template                                ScopeStore<std::map<NAString, int>*>    ::~ScopeStore();
extern template   void                         ScopeStore<std::map<NAString, int>*>    ::Clear      ();
extern template   void                         ScopeStore<std::map<NAString, int>*>    ::InitWalk   (Scope,std::map<NAString, int>*);
extern template   std::map<NAString, int>*     ScopeStore<std::map<NAString, int>*>    ::Walk       ();
extern template   void                         ScopeStore<std::map<NAString, int>*>    ::InitAccess (Scope,int,ThreadID);
extern template   void                         ScopeStore<std::map<NAString, int>*>    ::initCursor (bool);
extern template   std::map<NAString, int>*     ScopeStore<std::map<NAString, int>*>    ::access     (int,std::map<NAString, int>*);
extern template                                ScopeStore<std::map<NAString, Box>*>    ::ScopeStore (ScopeInfo&, bool);
extern template                                ScopeStore<std::map<NAString, Box>*>    ::~ScopeStore();
extern template   void                         ScopeStore<std::map<NAString, Box>*>    ::Clear      ();
extern template   void                         ScopeStore<std::map<NAString, Box>*>    ::InitWalk   (Scope,std::map<NAString, Box>*);
extern template   std::map<NAString, Box>*     ScopeStore<std::map<NAString, Box>*>    ::Walk       ();
extern template   void                         ScopeStore<std::map<NAString, Box>*>    ::InitAccess (Scope,int,ThreadID);
extern template   void                         ScopeStore<std::map<NAString, Box>*>    ::initCursor (bool);
extern template   std::map<NAString, Box>*     ScopeStore<std::map<NAString, Box>*>    ::access     (int,std::map<NAString, Box>*);
#endif
...
template<> inline bool                         ScopeStoreType<Box*>                    ::AreEqual   ( Box* first, Box* second )                                         { return first->Call<FEquals>(*second); }
...
template<> inline bool                         ScopeStoreType<std::map<NAString, int>*>::AreEqual   ( std::map<NAString, int>* first, std::map<NAString, int>* second ) { return first == second;  }
template<> inline bool                         ScopeStoreType<std::map<NAString, int>*>::IsNull     ( std::map<NAString, int>* value )                                  { return value == nullptr; }
template<> inline std::map<NAString, int>*     ScopeStoreType<std::map<NAString, int>*>::NullValue  ()                                                                  { return nullptr;          }
template<> inline bool                         ScopeStoreType<std::map<NAString, Box>*>::AreEqual   ( std::map<NAString, Box>* first, std::map<NAString, Box>* second ) { return first == second;  }
template<> inline bool                         ScopeStoreType<std::map<NAString, Box>*>::IsNull     ( std::map<NAString, Box>* value )                                  { return value == nullptr; }
template<> inline std::map<NAString, Box>*     ScopeStoreType<std::map<NAString, Box>*>::NullValue  ()                                                                  { return nullptr;          }
//! @endcond
