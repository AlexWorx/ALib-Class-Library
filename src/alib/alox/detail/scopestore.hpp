...
/// #"ScopeStore::Walk" and #"ScopeStore::access" for each boolean value of template argument
...
struct ScopeStoreHelper {
    ...
    /// @param self The #"%ScopeStore" that invoked us.
    /// @return The result as specified in #"ScopeStore::Walk".
    ...
    /// @return The result as specified in #"ScopeStore::access".
...
class ScopeStore {
  ...
  public:
    ...
    /// This does not lead to memory leaks, because during the life-time of a #"%Lox" objects
  ...
  public:
    ...
    ///                        #"StringTree" needed by member #"languageStore".
    ALIB_DLL
    ...
    /// @param pathLevel  Used only if parameter \p{scope} equals #"lox Scope::Path;*"
    ...
    ///                   If #"threads::UNDEFINED" is given, the ID provided in
    ///                   \p{scopeInfo} is used.
    ALIB_DLL
