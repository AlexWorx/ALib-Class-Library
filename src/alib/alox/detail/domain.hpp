...
//==================================================================================================
/// Used to store log prefixes. Those that are provided as #"alib::boxing::Box;boxes" of
...
/// survives the lifespan on the setting function.
//==================================================================================================
class PrefixLogable : public Box {
  ...
  public:
    ...
    /// @param pa  The pool allocator of the #"%Lox".
...
class Domain {
  public:
    ...
    struct LoggerData {
        ...
        LoggerData( detail::Logger* logger )                               { this->Logger= logger; }
    };
  ...
  public:
    ...
    int  CountLoggers()                                               { return int( Data.size() ); }
    ...
    Verbosity GetVerbosity( int loggerNo )        { return Data[size_t(loggerNo)].LoggerVerbosity; }

    /// Returns the priority of the \e Verbosity setting for the given logger number.
    /// @param loggerNo  The number of the \e Logger whose \e Verbosity is requested.
    /// @return The priority.
    Priority GetPriority( int loggerNo )                 { return Data[size_t(loggerNo)].Priority; }
    ...
    int       GetCount( int loggerNo )          { return Data[size_t(loggerNo)].LogCallsPerDomain; }
    ...
    ///                  \p{statement}.
    /// @param verbosity The \e Verbosity to check.
    /// @return \c true if the domain is active.
