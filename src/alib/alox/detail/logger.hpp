...
//==================================================================================================
#ifndef HPP_ALIB_LOX_DETAIL_LOGGER
#define HPP_ALIB_LOX_DETAIL_LOGGER 1
#pragma once
#if !defined(DOXYGEN)
...
namespace APPENDABLES {
    ...
    ///               (Templated inline implementation for all the
    ///               \ref alib_characters_chars "six possible character types".)
    //==============================================================================================
    template<typename TChar> struct T_Append<lox::detail::Logger,TChar, lang::HeapAllocator>
    {
        //==========================================================================================
...
#endif // HPP_ALIB_LOX_DETAIL_LOGGER
