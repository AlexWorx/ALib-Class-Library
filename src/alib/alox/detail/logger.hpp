...
#endif
{
  ...
  protected:
    ...
    /// #"%Lox" have to differ in their names.
  ...
  public:
    ...
    /// #"alib_mod_alox_prefix_logables_intro;Prefix Logables".
    ///
  ...
  //################################################################################################
  protected:
    /// This method is invoked by class #"Lox" when a logger is added or removed from it.
    /// Note, that a logger might be added to multiple #"%Lox" objects in parallel.
    ///
...
//==================================================================================================
/// Specialization of functor #"AppendableTraits" for type #"%detail::Logger".
///
