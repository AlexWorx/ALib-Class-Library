...
/// class #"Lox". Almost all functions expect a pointer to the hidden implementation type
/// <b>LoxImpl</b> as the first parameter.
//==================================================================================================
struct LI {
    /// Implementation of the constructor #"Lox::Lox;the constructor" of class #"%Lox".
    /// @param name The name of the Lox. Will be copied and converted to upper case.
    /// @return The implementation for the calling #"%Lox".
    ALIB_DLL static
    LoxImpl*        Construct( const NString& name );

    /// Destructs a lox.
    /// @param lox The #"%Lox" that is to be destructed.
    ALIB_DLL static
    ...
    /// Implementation of the method #"Lox::GetName;*".
    ///
    /// @param impl  The implementation struct of the #"%Lox".
    /// @returns The name of this Lox.
    ALIB_DLL static
    const NString&  GetName(LoxImpl* impl);

    /// Implementation of the method #"Lox::GetLogCounter;*".
    ///
    /// @param impl  The implementation struct of the #"%Lox".
    /// @returns The name of this Lox.
    ALIB_DLL static
    ...
    /// Implementation of the method #"Lox::Acquire;*".
    ///
    /// @param impl  The implementation struct of the #"%Lox".
    /// @param ci    The source location that the call is placed at.
    ///              Usually macro #"ALIB_CALLER" is passed here.
    ALIB_DLL static
    void            Acquire(LoxImpl* impl, const lang::CallerInfo& ci );

    /// Implementation of the method #"Lox::Release;*".
    /// @param impl  The implementation struct of the #"%Lox".
    ALIB_DLL static
    void            Release(LoxImpl* impl);

    /// Implementation of the method #"Lox::Reset;*".
    /// @param impl         The implementation struct of the #"%Lox".
    ALIB_DLL static
    void            Reset(LoxImpl* impl);

    /// Implementation of the method #"Lox::SetFileNameCacheCapacity;*".
    /// @param impl           The implementation struct of the #"%Lox".
    ...
    /// Implementation of the method #"Lox::SetSourcePathTrimRule;*".
    /// @param impl            The implementation struct of the #"%Lox".
    ...
    /// Implementation of the method #"Lox::GetLogger;*".
    /// @param impl          The implementation struct of the #"%Lox".
    ...
    /// Implementation of the method #"Lox::RemoveLogger(detail::Logger*)".
    /// @param impl      The implementation struct of the #"%Lox".
    ...
    /// Implementation of the method #"Lox::RemoveLogger(const NString&)".
    /// @param impl          The implementation struct of the #"%Lox".
    ...
    /// Implementation of the method #"Lox::SetVerbosity(detail::Logger*)".
    /// @param impl       The implementation struct of the #"%Lox".
    /// @param logger     The logger to be affected (case-insensitive).
    ...
    /// @param priority   The priority of the setting. Defaults to #"Priority::DefaultValues".
    ALIB_DLL static
    ...
    /// Implementation of the method #"Lox::SetVerbosity(const NString&, Verbosity)".
    /// @param impl       The implementation struct of the #"%Lox".
    /// @param loggerName The logger to be affected, identified by its name (case-insensitive).
    /// @param verbosity  The 'level of verboseness' to be set.
    /// @param domain     The parent (start) domain to be set. The use of absolute paths
    ///                   starting with <c> '/'</c> are recommended.
    ///                   Defaults to root domain \"/\".
    ...
    /// Implementation of the method #"Lox::SetVerbosityExport(detail::Logger*)".
    /// @param impl       The implementation struct of the #"%Lox".
    /// @param logger     The logger to be affected.
    /// @param value      The value to set.
    /// @param priority   The priority of the setting. Defaults to #"var Priority::Standard".
    ALIB_DLL static
    void            SetVerbosityExport( LoxImpl*         impl,
                                        detail::Logger*  logger,
                                        bool             value,
                                        Priority         priority=Priority::Standard);

    /// Implementation of the method #"Lox::SetVerbosityExport(const NString&)".
    /// @param impl       The implementation struct of the #"%Lox".
    /// @param loggerName The logger to be affected, identified by its name (case-insensitive).
    /// @param value      The value to set.
    /// @param priority   The priority of the setting. Defaults to #"var Priority::Standard".
    ...
    /// Implementation of the method #"Lox::SetDomain(const NString&, Scope, threads::Thread*)".
    /// @param impl        The implementation struct of the #"%Lox".
    ...
    /// Implementation of the method #"Lox::SetDomainSubstitutionRule;*".
    /// @param impl        The implementation struct of the #"%Lox".
    ...
    /// Implementation of the method #"Lox::RemoveThreadDomain;*".
    /// @param impl        The implementation struct of the #"%Lox".
    /// @param scopeDomain The domain path to register.
    /// @param scope       Either \e Scope::ThreadOuter or \e Scope::ThreadInner. With other
    ///                    values, an internal error is logged.
    ...
    /// Implementation of the method #"Lox::SetPrefix(const Box&,const NString&,lang::Inclusion);*".
    /// @param impl        The implementation struct of the #"%Lox".
    ...
    /// Implementation of the method #"Lox::SetStartTime(Ticks, const NString&)".
    /// @param impl       The implementation struct of the #"%Lox".
    ...
    void        SetStartTime( LoxImpl* impl, time_t startTime, const NString& loggerName );
        ...
        /// #"Lox::SetStartTime(const FILETIME&, const NString&)".
        /// @param impl       The implementation struct of the #"%Lox".
        /// @param startTime  The new start time in system-specific time unit.
        /// @param loggerName The name of the \e Logger whose start time is to be set (case
        ///                   insensitive).
    ...
    /// Implementation of the method #"Lox::MapThreadName;*".
    /// @param impl        The implementation struct of the #"%Lox".
    ...
    /// Implementation of the method #"Lox::State;*".
    /// @param impl          The implementation struct of the #"%Lox".
    ...
    /// Implementation of the method #"Lox::GetState;*".
    /// @param impl       The implementation struct of the #"%Lox".
    ...
    /// Implementation of the method #"Lox::GetLogableContainer;*".
    /// @param impl        The implementation struct of the #"%Lox".
    /// @return An empty list of boxes.
    ALIB_DLL static
    BoxesMA&        GetLogableContainer( LoxImpl* impl );

    /// Implementation of the method #"Lox::Entry;*".
    /// @param impl        The implementation struct of the #"%Lox".
    ...
    /// Implementation of the method #"Lox::IsActive;*".
    ///
    /// @param impl         The implementation struct of the #"%Lox".
    ...
    /// @param resultDomain An optional pointer to an #"%AString". If given, the resulting
    ...
    /// Implementation of the method #"Lox::GetVerbosity;*".
    ///
    /// @param impl         The implementation struct of the #"%Lox".
    /// @param domain       The log domain. All rules for resolving the effective log domain
    ///                     apply as with normal log statements.
    ...
    ALIB_DLL static
    Verbosity GetVerbosity( LoxImpl* impl, const NString&  domain,  NAString* resultDomain );
...
//##################################################################################################
    ...
    //==============================================================================================
    /// Implementation of the method #"Lox::DbgGetMonoAllocator;*".
    /// @param impl   The implementation struct of the #"%Lox".
...
//##################################################################################################
    ...
    /// #"alib::lox::detail::Domain::Separator;Domain::Separator",
    ...
    /// @return The resulting #"alib::lox::detail::Domain;Domain".
    ALIB_DLL static
    detail::Domain* evaluateResultDomain( LoxImpl* impl, const NString& domainPath );

    /// Invokes #"Domain::Find" on the given domain and logs internal message when the domain was
    /// not known before.
    ///
    /// @param impl          The implementation struct of the #"%Lox".
    ...
    /// #"alib::lox::Lox::InternalDomains;Lox::InternalDomains".
    ///
    /// @param impl      The implementation struct of the #"%Lox".
    /// @param verbosity The verbosity.
    ...
    /// Each invocation has to be followed by an invocation to #".logInternal(BoxesMA&)"
    ...
    /// Implementation of the method #"Lox::EntryDetectDomain;*".
    ///
    /// @param impl      The implementation struct of the #"%Lox".
    /// @param verbosity The verbosity.
    ALIB_DLL static
    ...
    /// Internal method serving public interface #"Lox::Once(const NString&, Verbosity, const Box&, const String&, Scope, int);Lox::Once".
    ///
    /// @param impl      The implementation struct of the #"%Lox".
    /// @param domain    Optional <em>Log Domain</em> which is combined with
    ///                  <em>Scope Domains</em> set for the \e Scope of invocation.
    ...
    /// Internal method serving public interface #"Lox::Store(const Box&, Scope);Lox::Store".
    ///
    /// @param impl      The implementation struct of the #"%Lox".
    ...
    /// Internal method serving public interface #"Lox::Retrieve(const NString&);Lox::Retrieve".
    ///
    /// @param impl      The implementation struct of the #"%Lox".
    /// @param pKey       The key to the data.
    /// @param scope     The \e Scope that the data is bound to.
    ...
    /// in/out parameter \p{scope} is changed to #"%Scope::Path", in case a level was added.
    ///
    /// @param impl           The implementation struct of the #"%Lox".
    ...
    /// @param impl  The implementation struct of the #"%Lox".
    /// @returns The internal #"%RecursiveLock" of this #"%Lox".
    ALIB_DLL static
