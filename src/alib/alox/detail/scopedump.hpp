...
/// It was extracted from class #"%Lox" to keep that class clean from this somehow 'cluttered' code.
///
/// The current purpose of this class is to write information into an AString buffer. This is used
/// by method #"alib::lox::Lox::State;Lox::State". In the future, other export formats,
