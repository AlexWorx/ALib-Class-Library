...
//==================================================================================================
#ifndef HPP_ALIB_ALOX_PP
#define HPP_ALIB_ALOX_PP
#pragma once
#ifndef HPP_ALIB
...
//##################################################################################################
// Macro  introduced by module ALib.ALox
//##################################################################################################
...
#define Log_SetVerbosityExport(...)       { Log_Prune( LOG_ACQUIRE _log.SetVerbosityExport       (__VA_ARGS__); LOG_RELEASE ) }
...
#define Log_GetVerbosity(result, ...)       Log_Prune( LOG_ACQUIRE result=     _log.GetVerbosity (__VA_ARGS__); LOG_RELEASE )
...
#define Lox_SetVerbosityExport(...)       { Lox_Prune( LOX_ACQUIRE _lox.SetVerbosityExport       (__VA_ARGS__); LOX_RELEASE )  }
...
#define Lox_GetVerbosity(result, ...)     { Lox_Prune( LOX_ACQUIRE result= _lox.GetVerbosity     (__VA_ARGS__); LOX_RELEASE )  }
#define Lox_Exception(...)                { Lox_Prune( alib::lox::LogTools::Exception( LOX_LOX,   __VA_ARGS__);)               }

//##################################################################################################
// If ALox not included in the build, set all macros to empty
//##################################################################################################
#else // ALIB_ALOX
#   define Log_Prune( ... )
...
#   define Lox_IsActive(...)
#   define Lox_GetVerbosity(...)
#   define Lox_Exception(...)

#endif //ALIB_ALOX
#endif // HPP_ALIB_ALOX_PP
