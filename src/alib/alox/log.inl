...
//==================================================================================================
#ifndef HPP_ALIB_LOX_LOG
#define HPP_ALIB_LOX_LOG 1
#pragma once
...
#if ALOX_DBG_LOG && !DOXYGEN
    extern ALIB_API Lox*     theDebugLox;  // will be created in ALoxCamp::Bootstrap
#endif
...
class Log
{
    ...
    public:
        ...
        ALIB_API static textlogger::TextLogger*   DebugLogger;

        /// An (additional) IDE specific logger, that might be created by AddDebugLogger.
        ALIB_API static textlogger::TextLogger*   IDELogger;
