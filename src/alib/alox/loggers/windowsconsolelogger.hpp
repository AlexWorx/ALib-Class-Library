...
/// #"alib::lox::ESC;ESC". Especially, ESC style attributes are ignored.
///
...
/// field #".CFP" and also configuration variable #"alxcvALOX_CONSOLE_LIGHT_COLORS".
///
...
class WindowsConsoleLogger : public alib::lox::textlogger::TextLogger
{
  ...
  //################################################################################################
    public:
        ...
        ///
        /// The configuration variable #"alxcvALOX_CODEPAGE" is evaluated within the constructor of
        /// this class, to allow to modifying the codepage at runtime.
        UINT            CodePage                                                            =65001;
