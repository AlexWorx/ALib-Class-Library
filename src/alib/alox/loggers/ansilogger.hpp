...
///
/// ALox text logger escape sequences (see class #"alib::lox::ESC;ESC")
...
/// #".CFP" and also configuration variable #"alxcvALOX_CONSOLE_LIGHT_COLORS".
///
...
/// Of course, it is no problem to log other ANSI codes directly into an #"%AnsiLogger".
...
/// recommended to use #"alib::lox::ESC;ESC" sequences instead of
...
class AnsiLogger : public alib::lox::textlogger::TextLogger {
  ...
  public:
    ...
    /// #"ColorfulLoggerParameters;LightColorUsage". With this logger,
    ...
    /// #"alib::lox::ESC;escape codes" for colors are translated to normal ANSI colors or
    /// lighter ones:
    /// - If this field evaluates to
    ///   #"LightColorUsage::Never", light colors
    ///   are never used.
    /// - If this field is
    ///   #"LightColorUsage::Foreground",
    ///   colors will be light colors and background colors dark ones. This is the default.
    /// - With
    ///   #"LightColorUsage::Background",
    ///   background colors will be light colors and foreground colors dark ones.
    ///
    /// The configuration variable #"alxcvALOX_CONSOLE_LIGHT_COLORS" allows externally
  ...
  public:
    ...
    /// @param pOStream       The output stream to write into. Defaults to \c std::cout.
    ...
    ALIB_DLL explicit
    AnsiLogger( std::ostream&  pOStream = std::cout,
  ...
  protected:
    ...
    /// #"alxcvALOX_CONSOLE_LIGHT_COLORS". Finally it is checked if variable
    /// #"alxcvALOX_LOGGERNAME_FORMAT" has priority of default values, and if yes, such
...
//==================================================================================================
/// A #"AnsiLogger" that logs all messages to <em>std::cout</em>.
...
class AnsiConsoleLogger : public AnsiLogger {
  public:
    ...
    /// @param name  The name of the \e Logger. Optional and defaults to the logger type name.
    ///              "ANSI_CONSOLE".
    explicit            AnsiConsoleLogger( const NString& name= nullptr  )
    : AnsiLogger( std::cout, name, "ANSI_CONSOLE" )                                               {}
