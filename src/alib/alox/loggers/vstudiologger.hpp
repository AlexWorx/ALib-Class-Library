...
ALIB_EXPORT namespace alib {  namespace lox::loggers {
//==================================================================================================
...
///  #"alib::lox::Log;Log" implements a method
///  #"alib::lox::Log::AddDebugLogger;Log::AddDebugLogger"
...
class VStudioLogger : public alib::lox::textlogger::PlainTextLogger
{
  ...
  //################################################################################################
    protected:
        ...
        ///
        /// If #"ALIB_CHARACTERS_WIDE" is set, this string also acts as a converter to wide
        /// characters.
  ...
  //################################################################################################
    protected:
        /// Invokes parent method. Then performs some VStudio-related adaptations.
        ///
