...
//==================================================================================================
#ifndef HPP_ALIB_LOX_DETAIL_TEXTLOGGER_TEXTLOGGER
#define HPP_ALIB_LOX_DETAIL_TEXTLOGGER_TEXTLOGGER 1
#pragma once
...
class StandardConverter : public ObjectConverter
{
    ...
    public:
        ...
        /// \alib{lang::format;FormatterPythonStyle}. If so, its \b AutoSizes member is set to
...
class TextLogger : public Logger
{
  ...
  protected:
    ...
    /// \alib{config;Configuration} of camp \alib_alox.
...
#endif // HPP_ALIB_LOX_DETAIL_TEXTLOGGER_TEXTLOGGER
