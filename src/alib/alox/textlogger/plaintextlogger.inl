...
class PlainTextLogger : public TextLogger
{
  ...
  protected:
    ...
    ///         \ref notifyPlainTextLogOp "notifyPlainTextLogOp(Phase::End)".
    ...
    /// \ref notifyPlainTextLogOp "notifyPlainTextLogOp(Phase::End)" will be performed.
    ///
  ...
  protected:
    ...
    /// - \ref notifyPlainTextLogOp "notifyPlainTextLogOp(true)"
    /// -   #logPlainTextPart()
    /// -   ...
    /// - \ref notifyPlainTextLogOp "notifyPlainTextLogOp(Phase::End)"
    ///
