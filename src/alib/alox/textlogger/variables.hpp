...
//==================================================================================================
#ifndef HPP_ALIB_LOX_METAINFO
#define HPP_ALIB_LOX_METAINFO 1
#pragma once
...
/// and its derivates.
/// This struct is used to define an external \ref alib_mod_config "configuration variable"
...
struct FormatMetaInfo
{
    ...
    /// @param pool The pool object of the \alib{config;Configuration}.
...
/// as well as the log message part, collected during the run of a software.
/// This struct is used to define an external \ref alib_mod_config "configuration variable"
...
/// \alib{lang::format;FormatterPythonStyle::Sizes} and thus is used to organize tab-stops and
...
struct FormatAutoSizes
{
    ...
    ///       \alib{lang::format;FormatterPythonStyle} used.
...
DOX_MARKER([DOX_CONFIG_DEFINETYPE1])
ALIB_CONFIG_VARIABLE_DEFINE_TYPE_WITH_POOL_CONSTRUCTOR( alib::lox::textlogger::, FormatMetaInfo           ,A_CHAR("ALOXFMI") )
DOX_MARKER([DOX_CONFIG_DEFINETYPE1])
ALIB_CONFIG_VARIABLE_DEFINE_TYPE_WITH_POOL_CONSTRUCTOR( alib::lox::textlogger::, FormatDateTime           ,A_CHAR("ALOXFDT") )
ALIB_CONFIG_VARIABLE_DEFINE_TYPE_WITH_POOL_CONSTRUCTOR( alib::lox::textlogger::, FormatTimeDiff           ,A_CHAR("ALOXFTD") )
ALIB_CONFIG_VARIABLE_DEFINE_TYPE_WITH_POOL_CONSTRUCTOR( alib::lox::textlogger::, FormatMultiLine          ,A_CHAR("ALOXFML") )
ALIB_CONFIG_VARIABLE_DEFINE_TYPE_WITH_POOL_CONSTRUCTOR( alib::lox::textlogger::, FormatOther              ,A_CHAR("ALOXFO" ) )
ALIB_CONFIG_VARIABLE_DEFINE_TYPE                      ( alib::lox::textlogger::, FormatAutoSizes          ,A_CHAR("ALOXAS" ) )
ALIB_CONFIG_VARIABLE_DEFINE_TYPE_WITH_POOL_CONSTRUCTOR( alib::lox::textlogger::, Replacements             ,A_CHAR("ALOXSR" ) )
ALIB_CONFIG_VARIABLE_DEFINE_TYPE                      ( alib::lox::textlogger::, ColorfulLoggerParameters ,A_CHAR("ALOXCLP") )


ALIB_ENUMS_ASSIGN_RECORD( alib::lox::textlogger::ColorfulLoggerParameters::LightColorUsage, alib::enums::ERSerializable )


#endif // HPP_ALIB_LOX_METAINFO
