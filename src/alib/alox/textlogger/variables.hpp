...
//==================================================================================================
/// Definition of the main log-line format string for class #"textlogger::TextLogger;*"
/// and its derivates.
/// This struct is used to define an external #"alib_mod_variables;configuration variable"
/// named #"alxcvALOX_LOGGERNAME_FORMAT".
/// This variable can be accessed programatically
/// with #"TextLogger::GetFormatMetaInfo" or by accessing the variable's value
/// through the configuration object found in camp singleton #"alib::ALOX;2".
//==================================================================================================
struct FormatMetaInfo {
    ...
    /// (see #"ALOX_DBG_LOG_CI" and #"ALOX_REL_LOG_CI"), then it defaults to:
    /// <c>"[%TC +%TL][%tN]%V[%D]%A1(%#): "</c>
    ///
    /// \note
    ...
    /// @param pool The pool object of the #"Configuration".
...
//==================================================================================================
/// Definition of date and time formats for class #"textlogger::TextLogger;*"
/// and its derivates.
/// This struct is used to define an external #"alib_mod_variables;configuration variable"
/// named #"alxcvALOX_LOGGERNAME_FORMAT_DATE_TIME".
/// This variable can be accessed programatically
/// with #"TextLogger::GetFormatDate" or by accessing the variable's value
/// through the configuration object found in camp singleton #"alib::ALOX;2".
//==================================================================================================
...
/// #"textlogger::TextLogger;*" and its derivates.
/// This struct is used to define an external #"alib_mod_variables;configuration variable"
/// named #"alxcvALOX_LOGGERNAME_FORMAT_TIME_DIFF".
/// This variable can be accessed programatically
/// with #"TextLogger::GetFormatTimeDiff" or by accessing the variable's value
/// through the configuration object found in camp singleton #"alib::ALOX;2".
//==================================================================================================
...
//==================================================================================================
/// Definition of the multi-line message mode for class #"textlogger::TextLogger;*"
/// and its derivates.
/// This struct is used to define an external #"alib_mod_variables;configuration variable"
/// named #"alxcvALOX_LOGGERNAME_FORMAT_MULTILINE".
/// This variable can be accessed programatically
/// with #"TextLogger::GetFormatMultiLine" or by accessing the variable's value
/// through the configuration object found in camp singleton #"alib::ALOX;2".
//==================================================================================================
struct FormatMultiLine {
    ...
    /// #"%TextLogger", even the replacements of the delimiter character.
    AStringPA        Delimiter;
...
//==================================================================================================
/// Definition of further format options for class #"textlogger::TextLogger;*"
/// and its derivates.
/// This struct is used to define an external #"alib_mod_variables;configuration variable"
/// named #"alxcvALOX_LOGGERNAME_FORMAT_OTHER".
/// This variable can be accessed programatically
/// with #"TextLogger::GetFormatOther" or by accessing the variable's value
/// through the configuration object found in camp singleton #"alib::ALOX;2".
//==================================================================================================
struct FormatOther {
...
/// This struct is used to define an external #"alib_mod_variables;configuration variable"
/// named #"alxcvALOX_LOGGERNAME_AUTO_SIZES".
///
/// This variable can be accessed programatically either with method
/// #"TextLogger::GetAutoSizes" or by accessing the variable's value
/// through the configuration object found in camp singleton #"alib::ALOX;2".
///
...
/// to invoke #"AutoSizes::Reset" on that field.
///
/// Field #".LogMessage" with built-in text loggers, is passed to field
/// #"FormatterPythonStyle::Sizes;*" and thus is used to organize tab-stops and
...
///
/// Also, it might be reasonable to invoke #"AutoSizes;Consolidate" one both
/// objects from time to time, or in certain situations.
///
/// @see Variable #"alxcvALOX_LOGGERNAME_AUTO_SIZES".
//==================================================================================================
struct FormatAutoSizes {
    ...
    ///       #"FormatterPythonStyle" used.
    AutoSizes   LogMessage;

    /// Determines whether changes should be written back to configuration sources, if possible.<br>
    /// Defaults to \c true.
    /// @see Methods #"Variable::IsWriteBack;*" and the virtual method used to
    ///      implement this feature: #"VMeta::isWriteBack;*".
    bool        WriteBack                                                                     =true;
}; // struct FormatAutoSizes
...
/// #"TextLogger::GetReplacements" or by accessing the variable's value
/// through the configuration object found in camp singleton #"alib::ALOX;2".
//==================================================================================================
struct Replacements {
...
// FormatAutoSizes (has writeback, no macro for that)
#if !DOXYGEN
ALIB_EXPORT namespace alib::variables::detail {
struct VMeta_FormatAutoSizes : public VMeta {
         ALIB_DLL String                typeName ()      const override { return A_CHAR("ALOXAS"); }
ALIB_DBG(ALIB_DLL const std::type_info& dbgTypeID()                                                            override { return typeid(lox::textlogger::FormatAutoSizes); }  )
         ALIB_DLL void                  construct(VDATA* obj, PoolAllocator&)                                  override { new (obj) lox::textlogger::FormatAutoSizes(); }
         ALIB_DLL void                  destruct (VDATA* obj, PoolAllocator&)                                  override { reinterpret_cast<lox::textlogger::FormatAutoSizes*>(obj)->~FormatAutoSizes(); }
         ALIB_DLL size_t                size     ()                                                            override { static_assert(alignof(lox::textlogger::FormatAutoSizes) <= PoolAllocator::MAX_ALIGNMENT); return (std::max)( sizeof(lox::textlogger::FormatAutoSizes), sizeof(void*) ); }
         ...
         ALIB_DLL bool                isWriteBack(VDATA* obj)                                            const override { return reinterpret_cast<lox::textlogger::FormatAutoSizes*>(obj)->WriteBack; }
};}
#endif // !DOXYGEN
