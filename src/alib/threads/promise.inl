...
class Promise
{
  ...
  public:
    ...
    /// With debug-compilations, a \ref alib_mod_assert "warning is raised" on destruction, in
    ...
    #if   DOXYGEN
    /// Sets the state to \alib{threads::Promise;State;State::Unfulfilled}.
    ...
    /// @param ci    Caller information. Only available with debug-builds.
    ///              Use macro \ref ALIB_CALLER_PRUNED to pass this parameter
