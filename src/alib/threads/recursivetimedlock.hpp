...
/// #"OwnerRecursive" to acquire and release objects of this class.
/// Such a use is greatly simplified with macros #"ALIB_LOCK_RECURSIVE" and
...
/// #"threads::Lock". Not only for this reason, non-nested locking is the preferred technique.
...
///   #"DbgLockAsserter::RecursionLimit;*".
