...
/// objects of this class. Such a use is greatly simplified with macros #"ALIB_LOCK" and
/// #"ALIB_LOCK_WITH".
///
...
/// - Field #"DbgLockAsserter;WaitTimeLimit" enables the raise of \alib warnings
