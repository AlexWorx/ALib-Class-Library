...
//==================================================================================================
#ifndef HPP_ALIB_THREADS_SHAREDTIMEDLOCK
#define HPP_ALIB_THREADS_SHAREDTIMEDLOCK 1
#pragma once
#if !defined(DOXYGEN)
...
/// - Releasing non-acquired instances, as well as destructing acquired one, raises an assertion.
...
#endif
{
  ...
  // ===============================================================================================
    ...
    ALIB_API [[nodiscard]]  bool TryAcquireSharedTimed( const Ticks::Duration&            waitDuration );
    ...
    /// is counted, and an assertion is raised if more releases than acquisitions are performed.
    /// \par Debug Parameter:
    ///   Pass macro \ref ALIB_CALLER_PRUNED with invocations.
    ALIB_API
...
#endif // HPP_ALIB_THREADS_SHAREDTIMEDLOCK
