...
/// it is recommended to use a stack instantiation of class #"lang::Owner" to acquire and release
...
/// Here, class #"OwnerShared" is to be used, best using macros #"ALIB_LOCK_SHARED" and
...
///   #"alib_mod_assert;raises an ALib error".
/// - Field #"DbgLockAsserter;WaitTimeLimit" the raise of \alib warnings in case a
...
#endif
{
  ...
  //================================================================================================
    ...
    /// Same as overloaded sibling, but expects a point in time rather than a #"^Ticks::Duration".
    ///
  ...
  //================================================================================================
    ...
    /// Same as overloaded sibling, but expects a C++ standard library point in time type
    /// rather than a #"^Ticks::Duration" value.
    ///
    /// @param pointInTime  The point in time, when this method stops waiting.
    /// @param ci           Caller information.
    ///                     Use the macro #"ALIB_COMMA_CALLER_PRUNED" with invocations.
