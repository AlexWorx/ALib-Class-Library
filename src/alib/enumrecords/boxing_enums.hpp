...
/// Returns the #"alib_enums_records;ALib Enum Record" associated with the given instance of
/// class #"boxing::Enum", which is defined in module \alib_boxing.
///
...
///
/// \see
/// - Namespace function #"enum GetRecord" of the module \alib_enumrecords, which
...
/// @param  e        The enumeration element, boxed in class #"%Enum".
...
const TRecord&  GetRecord(Enum e) {
    ...
    return *static_cast<const TRecord*>( result );
}

/// Returns a pointer to the #"alib_enums_records;ALib Enum Record" associated with this
/// enumeration element represented by this instance.
/// If no enum record was is defined, \c nullptr is returned.
///
/// \see
/// - Namespace function #"enum TryRecord" of module \alib_enumrecords, which provides the
...
const TRecord*  TryRecord(Enum e){
    return static_cast<const TRecord*>( enumrecords::detail::getEnumRecord( e.TypeID(),
                                                                            e.Integral() ) );
}
