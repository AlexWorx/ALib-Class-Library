...
///   an application, and - if strings are #"alib_mod_resources;resourced" -
///   far more flexible.
///
/// \see Chapter #"alib_enums_records_firststep_init" for a sample of how this method
///      can be invoked.
///
/// @tparam TArgs   Types of the variadic arguments \p{args}.
/// @tparam TEnum   The enum type to define records for.
...
/// \p{definitions}.
///
/// The use of struct #"bootstrap::Initializer;*" allows placing
...
/// Reads a list of enum data records from the given string \p{input}.
///
...
///
/// This is due to the static nature of #"alib_enums_records;ALib Enum Records" and their
...
///
/// \see Chapter #"alib_enums_records_resourced_parsing" for a sample of how this method
///      can be invoked.
///
