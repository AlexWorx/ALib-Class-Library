...
//==================================================================================================
ALIB_EXPORT namespace alib {  namespace enumrecords { namespace detail {
...
//==================================================================================================
/// This detail function returns \e the central hash table that stores enum records of all types.
...
///
/// Consequently, there are no mechanisms to protect parallel access, because after bootstrap
/// only read operations are allowed.
///
/// Before bootstrapping, the returned map may be <c>const_cast</c>'ed to a mutable reference
...
///
/// \note
///   Runtime access to single records is provided with function
///   #"detail::getEnumRecord(const std::type_info& rtti; integer)" and encapsulated
///   in type #"boxing::Enum" of the module \alib_boxing.
///
/// \attention
///   In the absence of the module \alib_monomem in an \alibbuild, the returned type changes to
