...
/// already define an #"Variable;ALib Variable".
...
///
/// With a #"%var Declaration" instance in place, constructors
/// #"Variable(Configuration& cfg, const Declaration* )", as well as methods
/// #"Declare(const Declaration*)", and
/// #"Try(const Declaration*)" can be used.
///
...
/// constructors of class #"%Variable", some of its overloaded methods #"Declare(TEnum);Declare"
...
/// comments are dependent on runtime information. For example, the text logging types of
...
/// allocated. For this, the convenience method #"Configuration::StoreDeclaration;*" is
/// available. The method not only copies the data into the internal #"MonoAllocator",
...
///       allocated, disposed, and recycled by class #"%Configuration".
///
///
/// \par Enum Records
/// This type inherits class #"ERSerializable" and is enabled to be read from
...
///
/// (For more information, see #"alib_enums_records;ALib Enum Records".)
///
/// \par Resourced Enums
/// Besides defining the enum record type, a custom enum has to have a specialization of the
/// type traits #"ResourcedTraits".
...
/// - Static method #"Declaration::Get(TEnum);*"
/// - #"Variable::Variable(Configuration&, TEnum)"
/// - #"Variable::Variable(Configuration&, TEnum, const Box)"
/// - #"Variable::Declare(TEnum);*"
/// - #"Variable::Declare(TEnum, const Box&)"
/// - #"variables::CampVariable(camp::Camp&, TEnum)"
/// - #"variables::CampVariable(camp::Camp&, TEnum, const Box)"
///
...
/// #"alib_ns_strings_propertyformatter_map_sample;documentation of class PropertyFormatter".
///
...
class Declaration : public enumrecords::ERSerializable {
  ...
  protected:
    ...
    /// #"ALIB_VARIABLES_DEFINE_TYPE" and ALIB_VARIABLES_REGISTER_TYPE.<br>
    /// Built-in types are listed with chapter #"alib_variables_types_builtin" of the Programmer's
    /// Manual.
    String      typeName;
    ...
    /// #"Priority::DefaultValues" when declared passing this instance.
  ...
  public:
    ...
    ///
    /// @param pName         Value for the inherited field #"ERSerializable::EnumElementName;*".
    ...
    /// #"alib_enums_records;ALib Enum Records" of this type, that contains the declaration data.
    ///
    /// In the case that a specialization of type trait #"ResourcedTraits"
