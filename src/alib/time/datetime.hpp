...
/// class #"Ticks", the underlying system timer is not guaranteed to be steady.
...
/// the methods and operators inherited from base #"TimePointBase".
///
/// To construct an object of this type using calendrical date and time values, helper-class
/// #"util::CalendarDateTime" with its constructor
/// #"CalendarDateTime;CalendarDateTime(int,int,int,int,int,int,int)" is
...
class DateTime : public TimePointBase<std::chrono::system_clock, DateTime> {
  ...
  //################################################################################################
    ...
    /// Static method that creates a #"%time::DateTime" object representing the given system
    ...
    { return DateTime( std::chrono::system_clock::from_time_t( epochSeconds ) ); }
            ...
            //======================================================================================
            /// Static method that creates a #"%time::DateTime" object representing the given
            /// "file time".
            ...
            /// @return The time point as \c SYSTEMTIME.
            //======================================================================================
            ALIB_DLL  SYSTEMTIME ToSystemTime(lang::Timezone timezone= lang::Timezone::Local) const;

            //======================================================================================
            /// Static method that creates a #"%time::DateTime" object representing the given as
            /// windows system time.
            ///
            /// \note
            ///    Microsoft Windows specific.
            ///
            /// @param systemTime Pointer to a \c  SYSTEMTIME struct that holds the system time to
            ///                   use.
            /// @param timezone   Denote if the time is interpreted as local or UTC.
            ///                   Defaults to #"Timezone::Local;2".
            /// @return Seconds in the epoch.
            //======================================================================================
