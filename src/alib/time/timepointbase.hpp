...
/// - Inner class #"TimePointBase::Duration" that represents the difference type of this
///   class.
...
///                   - \c std::chrono::system_clock with descendant class #"time::DateTime" and
///                   - \c std::chrono::steady_clock with descendant class #"Ticks".
/// @tparam TDerived  The derived type itself, hence either #"time::DateTime" or
///                   #"Ticks". This template parameter is needed to define the result
...
class TimePointBase {
  public:
    ...
    /// This inner class of #"%TimePointBase" represents durations, hence difference values of two
    /// values of the parent class.
    ///
    /// Often, objects of this class are generated by the subtraction of #"%TimePointBase" values or
    /// by using methods #"TimePointBase::Age;*" and #"TimePointBase::Since;*".
    /// Furthermore, the class #"util::CalendarDuration" (found in the module
  ...
  public:
    ...
    /// (i.e., before it is read), parameter \p{init} can be passed to either #"%Suppress"
    /// or #"%Nulled". Both values set this instance to a \e nulled state, as complete
