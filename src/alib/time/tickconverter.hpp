...
//==================================================================================================
/// As explained in detail in the documentation of the module \alib_time, a steady time model is
/// supported with class #"Ticks" and a non-steady one representing the system clock with
/// class #"time::DateTime".
/// Only values of the latter type can be converted to human-readable (calendar) date and time values.
///
/// In some situations however,software that requires steady, monotonic time points, may also be
/// required to present these time points in human-readable format. It is possible to do some sort
/// of conversion. For that, simply both clocks need to be probed at the same point
...
/// data. software can use one ore more instances of this class and update (synchronize) these
...
class TickConverter {
  ...
  public:
    ...
    /// to avoid differences in conversion across converter instances used in software.
    ///
    ...
    /// Converts a #"%Ticks" object to a #"%time::DateTime" object.
    ...
    /// Converts a #"%time::DateTime" object to a #"%Ticks" object.
