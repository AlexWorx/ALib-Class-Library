...
class CommandLine
{
  ...
  public:
    ...
    ///    #OptionArgsIgnored may/should be passed to the plug-in \b %CLIVariablesPlugin of
    ///    (all) \alib{variables;Configuration} object(s) used with the application. For this,
    ...
    virtual
    integer         ArgCount()                                { return integer(ArgStrings.size()); }
