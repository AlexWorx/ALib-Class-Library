//==================================================================================================
/// \file
/// This header-file is part of module \alib_bootstrap of the \aliblong.
///
...
/// State of initialization of the \alibmods that do not dispose over a #"Camp"
/// instance.
...
struct TCompilationFlags {
    unsigned char bits[5]; ///< The Flags.
};
...
///
/// This function called in all variants of function #"Bootstrap(BootstrapPhases);2".
/// If a using application wants to act different on such a mismatch, an own check of
/// global variables #"VERSION;2", #"REVISION;2" and #"COMPILATION_FLAGS;2" against
/// configuration macros #"ALIB_VERSION", #"ALIB_REVISION" and
/// #"ALIB_COMPILATION_FLAGS"
/// has to be performed \e before calling #"%Bootstrap".
///
...
///                         Defaults to #"ALIB_VERSION" and <b>must not</b> be passed when invoking
///                         this function.
/// @param alibRevision     The \alib sub-version required.
///                         Defaults to #"ALIB_REVISION" and <b>must not</b> be passed when invoking
///                         this function.
/// @param compilationFlags The flags as defined in invoking compilation unit.
///                         Defaults to \c ALIB_COMPILATION_FLAGS and must not be given.
ALIB_DLL
...
/// in the #"alib_mod_bs;Programmer's Manual" of module \alib_bootstrap_nl.
///
...
///       default values, which are read from corresponding configuration macros.<br>
///       For more information on this topic, see chapter
///       #"alib_mod_bs_assertcomp"  of the #"alib_manual".
///
/// \par Availability
...
///                         Defaults to #"ALIB_VERSION" and <b>must not</b> be passed.
/// @param alibRevision     The \alib sub-version used by the caller.
///                         Defaults to #"ALIB_REVISION" and <b>must not</b> be passed.
/// @param compilationFlags The flags as defined in invoking compilation unit.
///                         Defaults to #"ALIB_COMPILATION_FLAGS" and <b>must not</b> be passed.
...
/// - #"Bootstrap(BootstrapPhases, camp::Camp*, int, int, TCompilationFlags);2", and
...
/// the \#"alib_mod_bs;Programmer's Manual" of module \alib_bootstrap_nl.
///
...
ALIB_DLL
extern ListMA<camp::Camp*>  CAMPS;

/// Fills list #"CAMPS;2", taking the permutation of modules contained in the \alibbuild into
/// account.<br>
...
/// @param targetCamp       The "highest" \alibcamp in the list #"CAMPS;2" to bootstrap.
...
///                         this function.
/// @param compilationFlags The flags as defined in invoking compilation unit.
///                         Defaults to #"ALIB_COMPILATION_FLAGS" and <b>must not</b> be passed when
...
/// version #"alib::Shutdown(").
///
/// For details on when and how to invoke this method explicitly, see the detailed explanations in
/// the #"alib_mod_bs;Programmer's Manual" of module \alib_bootstrap_nl.
///
/// @param targetPhase The termination level to perform.
/// @param targetCamp  The "lowest" \alibcamp in list #"CAMPS;2" to shut down.
