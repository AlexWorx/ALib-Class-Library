 ...
 **************************************************************************************************/
#ifndef HPP_ALIB_FS_LISTS_SIDILIST
#define HPP_ALIB_FS_LISTS_SIDILIST 1
...
/** ************************************************************************************************
 * This namespace implements internals of \alib which are not part of an \alibmod.
 ************************************************************************************************ */
namespace detail {
 ...
 * struct \alib{detail::SidiListHelper}, provide all basic mechanisms to implement a single linked
 * list.
 *
 ...
 *
 * \see Types \alib{detail::SidiListHelper},<br>
 *      \alib{detail::BidiNodeBase} and<br>
...
struct SidiNodeBase
{
     ...
     *  \attention
     *    In case of using type \alib{detail::BidiListHelper}, this may point to an instance of the
     *    base type \alib{detail::BidiNodeBase}. */
    TElement*   pnext;
...
/** ************************************************************************************************
 * This class, together with sibling class \alib{detail::SidiNodeBase} provide the tools to
...
#endif // HPP_ALIB_FS_LISTS_SIDILIST
