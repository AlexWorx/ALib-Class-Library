...
// #################################################################################################
#if     defined( ALIB_FILESET_INTEGERS     ) \
     || defined( ALIB_FILESET_DEBUG        ) \
     || defined( ALIB_FILESET_OWNER        ) \
...
#define ALIB_FILESET_INTEGERS         (    ALIB_CHARACTERS       \
                                         | ALIB_SINGLETONS       \
                                         | ALIB_MONOMEM          \
                                         | ALIB_TIME             )

#define ALIB_FILESET_DEBUG            (    ALIB_CHARACTERS       \
                                         | ALIB_ENUMS            \
                                         | ALIB_MONOMEM          \
                                         | ALIB_SINGLETONS       )
...
#define ALIB_SINGLETONS               1
#define ALIB_MONOMEM                  1
#define ALIB_FILESET_INTEGERS         1
#define ALIB_FILESET_DEBUG            1
