...
/// A custom parser might be set to protected field #"Compiler::parser;*"by a derived
...
class ParserImpl  : public Parser {
  protected:
    ...
    /// #"Compiler::UnaryOperators;*" and used for testing of existence.
    ...
    ///
    /// This table is filled in the constructor of the class with the values stored in
    /// #"Compiler::BinaryOperators;*" and used for testing of existence.
    HashSet< MonoAllocator,
             String,
             alib::hash_string_ignore_case    <character>,
    ...
    ///   inserted #"%AST" elements, exclusively allocate from the same temporary allocator.
  ...
  //################################################################################################
    ...
    /// @return Either the given node or a node of type #"detail::ASTBinaryOp"
