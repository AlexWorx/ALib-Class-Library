...
/// This is the detail namespace of #"alib::expressions;2" implementing the abstract syntax tree,
...
//==================================================================================================
/// This class represents a program "run on" the #"detail::VirtualMachine;*" to evaluate an
/// expression.
///
/// ## Friends ##
...
class Program : public ProgramBase {
  ...
  //################################################################################################
    ...
    /// Returns the number of #"VirtualMachine::Command" that the
    /// program encompasses.
  ...
  protected:
    ...
    /// values in field #"Scope::Stack;*"
    /// stack of field #"ExpressionVal::ctScope;*".
