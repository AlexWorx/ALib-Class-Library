 ...
 * #"Types::Boolean", #"Types::Integer" and
 * #"Types::Float".
 *
 ...
 *
 * - Dependent on configuration flags of the given #"%Compiler", the following alias operators
 *   are defined:
 *   - With flag #"Compilation::AliasEqualsOperatorWithAssignOperator":<br>
 *     Operator <c>'=='</c> is aliased with <c>'='</c>.
 *   - With flag #"Compilation::AllowBitwiseBooleanOperators":<br>
 ...
 * |-------------|-----------|-----------------|--------- |------------
 * | Boolean     |\b Boolean |bool             | \<any\>  | Converts any type of boxed value by invoking box-function #"FIsTrue".
...
/// exposed through the header of struct #"plugins::Arithmetics;*".
/// The rationale for this is that the function is also used for auto-casting custom types to
/// boolean values, which is performed with compiler plug-in #"plugins::AutoCast;*".
///
/// The function is compile-time invokable and uses box-function #"FIsTrue" to
