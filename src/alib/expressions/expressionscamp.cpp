...
/// #"alib_mod_expressions;ALib Module Expressions - Programmer's Manual".
//==================================================================================================
...
void bulkloadResources(ResourcePool& resourcePool, const NCString& resourceCategory) {
    ...
    "ED55"          , A_CHAR("Nested expression {!Q} returned wrong result type.\n")
                      A_CHAR("Type expected: {}\n")
                      A_CHAR("Type returned: {}"),
    ...
    "CPA8"          , A_CHAR("Float I 5"),
    "CPALen"        , A_CHAR("Length I 3"),
    "CPM0"          , A_CHAR("PI I 2"),
    "CPM1"          , A_CHAR("E I 1"),
    "CPM2"          , A_CHAR("abs I 3"),
    ...
    "CPD57"         , A_CHAR("GetUtcMilliSecond I 1 1 1 1"),
...
void ExpressionsCamp::Bootstrap() {
    if( GetBootstrapState() == BootstrapPhases::PrepareResources ) {
        ...
        if(!rc.Do( "expressionscamp.alibrc", __FILE__, *this, ResourceCategory, true,
                                            __FILE__ )
                               //       nullptr )
            )
...
#if ALIB_DEBUG
        // with debug-builds a few resources are added (not using the resource compiler)
        resourcePool->BootstrapBulk( ResourceCategory,

    "VM_CMD_OPCODES",      A_CHAR( "0,Constant"     ",1,"
                                   "1,Function"     ",1,"
                                   "2,Subroutine"   ",1,"
                                   "4,JumpIfFalse"  ",5,"
                                   "5,Jump"         ",1"    ) ,
