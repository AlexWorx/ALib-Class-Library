...
class  Compiler;
struct Scope;
namespace detail{ class Program; struct VirtualMachine; }
...
class ExpressionVal
{
    ...
    public:
        ...
        //==========================================================================================
        ALIB_API            ExpressionVal( MonoAllocator&  allocator,
        ...
        /// \doxlinkproblem{classalib_1_1expressions_1_1detail_1_1Program.html;ad280346af2e021d0a6759401a683e16e;Program::CountOptimizations}
...
namespace APPENDABLES {
    ...
    //==============================================================================================
    template<> struct T_Append<expressions::ExpressionVal,alib::character, lang::HeapAllocator>
    {
    ...
    //==============================================================================================
    template<> struct T_Append<expressions::Expression,alib::character, lang::HeapAllocator>
    {
        /// Appends the result of \alib{expressions;ExpressionVal::GetNormalizedString} to the
        /// \p{target}.
        ///
