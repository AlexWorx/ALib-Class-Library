...
/// \alib{expressions;Compiler::Repository} to enable an \e automated definition and retrieval
...
///
/// ## Friends ##
/// class \alib{expressions;ExpressionVal}
//==================================================================================================
class Compiler  : public lang::PluginContainer<CompilerPlugin, CompilePriorities>
{
  ...
  public:
    ...
    int GetBinaryOperatorPrecedence( const String& symbol ) {
        ...
        /// \alib{enumops;BitwiseTraits;Bitwise enum class} that lists the plug-ins built-into
...
IF_ALIB_CAMP(
    ...
    /// \doxlinkproblem{structalib_1_1expressions_1_1Scope.html;aebf2cd4ff8a2611de06368fccfd3ef5b;Scope::Formatter;expressions::Scope::Formatter}.
    ...
    ///
    /// In the constructor of this class, a \alib{format;Formatter::Clone;clone} of the
  ...
  public:
    ...
    /// be accessed with \alib{expressions;ExpressionVal::GetOriginalString}, the normalized
    /// version can be retrieved after the compilation with method
    /// \alib{expressions;ExpressionVal::GetNormalizedString}. During compilation, the
    ...
    /// Provides access to the internal \alib{MonoAllocator}.
  ...
  protected:
    ...
    /// Implements \alib{expressions;ExpressionVal::GetOptimizedString}.
    ///
...
namespace detail {
/// Base class exported by the main module \implude{Expressions} for technical reasons.
class  ProgramBase {
  protected:
