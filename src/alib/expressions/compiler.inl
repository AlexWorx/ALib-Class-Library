...
IF_ALIB_CAMP(
    ...
    public:
        ...
        /// be accessed with \alib{expressions;ExpressionVal::GetOriginalString}, the normalized version
        /// can be retrieved after the compilation with method
        /// \alib{expressions;ExpressionVal::GetNormalizedString}. During compilation, the normalization
        ...
        {
            return AddNamed( name, NULL_STRING );
        }
