...
//==================================================================================================
/// This is a default implementation of abstract interface #"ExpressionRepository"
/// which retrieves definitions of named expressions using core mechanics of \alib, namely:
/// 1. #"alib_mod_resources;Static resource data", and
/// 2. #"alib_mod_variables;Configuration data".
//==================================================================================================
class StandardRepository : public  ExpressionRepository {
  ...
  public:
    ...
    /// added to enable to search an expression in the root of the #"%StringTree" of #".config".
