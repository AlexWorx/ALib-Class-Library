...
#if ALIB_MONOMEM
#   include "alib/monomem/aliases/localstringma.hpp"
#   include "alib/monomem/aliases/localstringpa.hpp"
#endif
...
UT_METHOD( Tab )
{
    ...
    // test some bad input
        ms._(Format::Tab(  0, 0, -1,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Format::Tab(  0, 0,  0,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Format::Tab( -1, 0,  0,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Format::Tab( -1, 0,  0,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Format::Tab( -1, 0,  -1,       '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Format::Tab( -5, 0,  0,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Format::Tab( -5, 0,  -100,     '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Format::Tab(  2, 0,  -101,     '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Format::Tab(  0, 0,  0,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Format::Tab(  1, 0,  0,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
