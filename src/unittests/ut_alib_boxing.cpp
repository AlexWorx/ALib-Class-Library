...
ALIB_BOXING_CUSTOMIZE(SmallNotCopyConstrCustom, SmallNotCopyConstrCustom,
    static void Write( Placeholder& target, SmallNotCopyConstrCustom const& value )
    {
        target.Write( value.cp, value.i );
    }
    static SmallNotCopyConstrCustom result;
...
ALIB_BOXING_CUSTOMIZE(ClassWithValueAndPointerCustom , ClassWithValueAndPointerCustom,
    static void Write( Placeholder& target, ClassWithValueAndPointerCustom const& value )
    {
        target.Write( value.cp, value.i );
    }
...
UT_METHOD(Boxing_Boxes)
{
...

    {
        ...
        boxes.clear(); boxes.Add( 5, String64(A_CHAR("xyz")) );      UT_EQ( 2,  boxes.Size() )  UT_EQ( A_CHAR("xyz")  , boxes[1].Unbox<String >())
