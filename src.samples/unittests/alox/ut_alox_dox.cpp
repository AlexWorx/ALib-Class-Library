...
void docSampleInstallAssertionPlugin();
void docSampleInstallAssertionPlugin()
{
...
DOX_MARKER([DOX_ALOX_SET_ASSERTION_PLUGIN])
Log_Prune( Log::SetALibAssertionPlugin( &LOX_LOX ); )
Log_Prune( Lox_SetVerbosity( myReleaseLogger, Verbosity::Info, lox::ALOX_ASSERTION_PLUGIN_DOMAIN_PREFIX ); )
DOX_MARKER([DOX_ALOX_SET_ASSERTION_PLUGIN])

DOX_MARKER([DOX_ALOX_SET_ASSERTION_PLUGIN_2])
...
DOX_MARKER([MAN_EXT_VERBOSITY_VARIABLES_1])
...
Log_SetVerbosity( "DEBUG_LOGGER", Verbosity::Info, "/MYDOM", variables::Priority::Standard +1 )
Log_Info( "MYDOM", "This line will be logged" )
...
// switching on with higher priority
Log_SetVerbosity( &memLog, Verbosity::Info, "/MYDOM", variables::Priority::Standard +1 )
Log_Info( "MYDOM", "This line will be logged" )
...
//! [MAN_EXT_VERBOSITY_VARIABLES_3]
Log_SetVerbosity( "DEBUG_LOGGER", Verbosity::Verbose, "/UI/MOUSE"        , variables::Priority::DefaultValues + 1 )
Log_SetVerbosity( "DEBUG_LOGGER", Verbosity::Verbose, "/UI/DIALOGS/MOUSE", variables::Priority::DefaultValues + 1 )
//! [MAN_EXT_VERBOSITY_VARIABLES_3]
