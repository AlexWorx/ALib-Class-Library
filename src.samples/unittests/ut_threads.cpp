...
class Test_ThreadLock_TestThread : public Thread
{
    ...
    Test_ThreadLock_TestThread( AWorxUnitTesting* pUT, const character* tname, RecursiveLock* lock, int holdTime, int repeats, bool verbose, Test_ThreadLock_SharedInt* shared )
    :Thread( tname )
    {
        this->UT=        pUT;
        this->Mutex=     lock;
...
#endif // #if !defined(ALIB_UT_ROUGH_EXECUTION_SPEED_TEST)
