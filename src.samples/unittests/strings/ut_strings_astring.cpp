...
#define TESTCLASSNAME       UT_Strings_AString
...
UT_METHOD( CharAt )
{
    ...
    UT_EQ(  ms.CharAtStart<NC>()    ,    'A'  )
    UT_EQ(  ms.CharAtEnd         ()    ,    'A'  )
    UT_EQ(  ms.CharAtEnd<NC>  ()    ,    'A'  )
    UT_EQ(  ms.CharAt            ( -1 ),    '\0' )
    UT_EQ(  ms.CharAt            (  0 ),    'A'  )
    UT_EQ(  ms.CharAt            (  1 ),    '\0' )
    UT_EQ(  ms.CharAt<NC>     (  0 ),    'A'  )
    ...
    UT_EQ(  ms.CharAt<NC>     (  0 ),    'A'  )
    UT_EQ(  ms.CharAt<NC>     (  1 ),    'B'  )
    UT_EQ(  ms.CharAt<NC>     (  2 ),    'C'  )
...
UT_METHOD( DeleteInsertFillReplace )
{
    ...
    // delete
    {
        ...
        ms.Reset(A_CHAR("0123456789"));   ms.Delete<NC>          (  5,    5     );      UT_EQ( A_CHAR("01234"),        ms )
        ms.Reset(A_CHAR("0123456789"));   ms.Delete<NC>          (  0,    5     );      UT_EQ( A_CHAR("56789"),        ms )
        ms.Reset(A_CHAR("0123456789"));   ms.Delete<NC>          (  0,    1     );      UT_EQ( A_CHAR("123456789"),    ms )
        ms.Reset(A_CHAR("0123456789"));   ms.Delete<NC>          (  9,    1     );      UT_EQ( A_CHAR("012345678"),    ms )
        ...
        ms.Reset(A_CHAR("0123456789"));   ms.DeleteStart<NC>     (   0          );      UT_EQ( A_CHAR("0123456789"),   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.DeleteStart<NC>     (   1          );      UT_EQ(  A_CHAR("123456789"),   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.DeleteStart<NC>     (   2          );      UT_EQ(   A_CHAR("23456789"),   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.DeleteStart<NC>     (   9          );      UT_EQ(          A_CHAR("9"),   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.DeleteStart<NC>     (  10          );      UT_EQ(           A_CHAR(""),   ms )
        ...
        ms.Reset(A_CHAR("0123456789"));   ms.DeleteEnd<NC>          (   0          );      UT_EQ( A_CHAR("0123456789"),   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.DeleteEnd<NC>          (   1          );      UT_EQ( A_CHAR("012345678") ,   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.DeleteEnd<NC>          (   2          );      UT_EQ( A_CHAR("01234567")  ,   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.DeleteEnd<NC>          (   9          );      UT_EQ( A_CHAR("0")         ,   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.DeleteEnd<NC>          (  10          );      UT_EQ( A_CHAR("")          ,   ms )
    }
    ...
    // InsertAt
    {
        ...
        ms.Reset(A_CHAR("0123456789"));   ms.InsertAt<NC>        ( A_CHAR("TST"),   0 );        UT_EQ( A_CHAR("TST0123456789"), ms )
        ms.Reset(A_CHAR("0123456789"));   ms.InsertAt<NC>        ( A_CHAR("TST"),   1 );        UT_EQ( A_CHAR("0TST123456789"), ms )
        ms.Reset(A_CHAR("0123456789"));   ms.InsertAt<NC>        ( A_CHAR("TST"),   8 );        UT_EQ( A_CHAR("01234567TST89"), ms )
        ms.Reset(A_CHAR("0123456789"));   ms.InsertAt<NC>        ( A_CHAR("TST"),   9 );        UT_EQ( A_CHAR("012345678TST9"), ms )
        ms.Reset(A_CHAR("0123456789"));   ms.InsertAt<NC>        ( A_CHAR("TST"),  10 );        UT_EQ( A_CHAR("0123456789TST"), ms )
    ...
    // ReplaceSubstring
    {
        ...
        ms.Reset(A_CHAR("0123456789"));   ms.ReplaceSubstring<NC>( r,   0,  1 )  ;      UT_EQ( A_CHAR("ABC123456789"), ms )
        ms.Reset(A_CHAR("0123456789"));   ms.ReplaceSubstring<NC>( r,   0,  2 )  ;      UT_EQ( A_CHAR("ABC23456789"),  ms )
        ms.Reset(A_CHAR("0123456789"));   ms.ReplaceSubstring<NC>( r,   1,  1 )  ;      UT_EQ( A_CHAR("0ABC23456789"), ms )
        ms.Reset(A_CHAR("0123456789"));   ms.ReplaceSubstring<NC>( r,   1,  2 )  ;      UT_EQ( A_CHAR("0ABC3456789"),  ms )
        ms.Reset(A_CHAR("0123456789"));   ms.ReplaceSubstring<NC>( r,   8,  1 )  ;      UT_EQ( A_CHAR("01234567ABC9"), ms )
        ms.Reset(A_CHAR("0123456789"));   ms.ReplaceSubstring<NC>( r,   8,  2 )  ;      UT_EQ( A_CHAR("01234567ABC"),  ms )
    }
...
_Pragma("GCC diagnostic pop")
        ...
        ms.Reset(A_CHAR("0123456789"));   ms.ReplaceRegion<NC>   ( '@',   0,  1 )  ;    UT_EQ( A_CHAR("@123456789"),   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.ReplaceRegion<NC>   ( '@',   0,  2 )  ;    UT_EQ( A_CHAR("@@23456789"),   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.ReplaceRegion<NC>   ( '@',   1,  1 )  ;    UT_EQ( A_CHAR("0@23456789"),   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.ReplaceRegion<NC>   ( '@',   1,  2 )  ;    UT_EQ( A_CHAR("0@@3456789"),   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.ReplaceRegion<NC>   ( '@',   8,  1 )  ;    UT_EQ( A_CHAR("01234567@9"),   ms )
        ms.Reset(A_CHAR("0123456789"));   ms.ReplaceRegion<NC>   ( '@',   8,  2 )  ;    UT_EQ( A_CHAR("01234567@@"),   ms )
    }
...
UT_METHOD( Append )
{
    ...
    // const character*
    {
        ...
        ms._(A_CHAR("1234567"));     UT_EQ  (15, ms.Capacity()   )   UT_EQ( A_CHAR("1234567"),   ms )
        ...
        // _<NC>
        ms.SetNull();            UT_EQ  ( 0, ms.Length()      )  UT_TRUE( ms.IsNull()   )
        ms._<NC>( csEmpty );       UT_EQ  ( 0, ms.Length()      )  UT_TRUE( ms.IsNull()   )
    ...
    // fundamental types
    {
        ...
        {  int8_t   i=  4;  ms._()._<NC>(i);       UT_EQ ( A_CHAR("4")  , ms) }
        {  int8_t   i= -4;  ms._()._<NC>(i);       UT_EQ ( A_CHAR("-4") , ms) }
        {  uint8_t  i=  4;  ms._()._<NC>(i);       UT_EQ ( A_CHAR("4")  , ms) }


        {  int16_t  i=  5;  ms._()._<NC>(i);       UT_EQ ( A_CHAR("5")  , ms) }
        {  int16_t  i= -5;  ms._()._<NC>(i);       UT_EQ ( A_CHAR("-5") , ms) }
        {  uint16_t i=  5;  ms._()._<NC>(i);       UT_EQ ( A_CHAR("5")  , ms) }

        {  int32_t  i=  6;  ms._()._<NC>(i);       UT_EQ ( A_CHAR("6")  , ms) }
        {  int32_t  i= -6;  ms._()._<NC>(i);       UT_EQ ( A_CHAR("-6") , ms) }
        {  uint32_t i=  6;  ms._()._<NC>(i);       UT_EQ ( A_CHAR("6")  , ms) }

        {  int64_t  i=  7;  ms._()._<NC>(i);       UT_EQ ( A_CHAR("7")  , ms) }
        {  int64_t  i= -7;  ms._()._<NC>(i);       UT_EQ ( A_CHAR("-7") , ms) }
        {  uint64_t i=  7;  ms._()._<NC>(i);       UT_EQ ( A_CHAR("7")  , ms) }
    }
    ...
    // Substring
    {
        ...
        ms.SetNull();              UT_EQ  ( 0, ms.Length()        )  UT_TRUE( ms.IsNull()    )
        ms._( t );                 UT_EQ  (15, ms.Capacity()      )    UT_EQ( A_CHAR("01234"), ms )
        ...
        // _<NC>
        ms.SetNull();             UT_EQ  ( 0, ms.Length()        )  UT_TRUE( ms.IsNull() )
        ms._<NC>( ssEmpty );        UT_EQ  ( 0, ms.Length()        )  UT_TRUE( ms.IsNull() )
        ms.Reset()._<NC>( t);       UT_EQ( A_CHAR("23"),  ms )
    }
    ...
    // std::string
    {
        ...
        ms._( ssEmpty);            UT_EQ  ( 0, ms.Length()      )  UT_TRUE( ms.IsNotNull() )
        ms.SetNull();              UT_EQ  ( 0, ms.Length()      )  UT_TRUE( ms.IsNull()    )
        ms._( t );                 UT_EQ  (15, ms.Capacity()    )  UT_EQ( A_CHAR("012")   , ms )
        ...
        ms.SetNull();                   UT_EQ( 0, ms.Length())   UT_TRUE( ms.IsNull() )
        ms._<NC>( ssEmpty );         UT_EQ( 0, ms.Length())   UT_TRUE( ms.IsNull() )
        ms.Reset()._<NC>( t);        UT_EQ( A_CHAR("0123456789"), ms  )
        ms.Reset()._<NC>( t ,2,3);   UT_EQ( A_CHAR("234")       , ms  )
    }
...
UT_METHOD( Fields )
{
    ...
    // empty fields
    ms._( Field( nullptr, 3, lang::Alignment::Left,     '#' ) );            UT_EQ( A_CHAR("###")          , ms )

    ms.Reset();
    ms._( Field( A_CHAR("") ,     3, lang::Alignment::Left,     '#' ) );    UT_EQ( A_CHAR("###")          , ms )
    ms._( Field( A_CHAR("") ,     4, lang::Alignment::Center,   '*' ) );    UT_EQ( A_CHAR("###****")      , ms )
    ms._( Field( A_CHAR("") ,     5, lang::Alignment::Right,    '+' ) );    UT_EQ( A_CHAR("###****+++++") , ms )

    // field, alignment left
    ms.Reset();
    ms._( Field( A_CHAR("A")       , 5, lang::Alignment::Left ) );
    ms._( Field( A_CHAR("AB")      , 5, lang::Alignment::Left ) );
    ms._( Field( A_CHAR("ABC")     , 5, lang::Alignment::Left ) );
    ms._( Field( A_CHAR("ABCD")    , 5, lang::Alignment::Left ) );
    ms._( Field( A_CHAR("ABCDE")   , 5, lang::Alignment::Left ) );
    ms._( Field( A_CHAR("ABCDEF")  , 5, lang::Alignment::Left ) );
    ms._( Field( A_CHAR("ABCDEFG") , 5, lang::Alignment::Left ) );
    UT_EQ( A_CHAR("A    AB   ABC  ABCD ABCDEABCDEFABCDEFG"), ms )

    // field, alignment right
    ms.Reset();
    ms._( Field( A_CHAR("A")       , 5, lang::Alignment::Right ) );
    ms._( Field( A_CHAR("AB")      , 5, lang::Alignment::Right ) );
    ms._( Field( A_CHAR("ABC")     , 5                         ) ); // btw: right is default
    ms._( Field( A_CHAR("ABCD")    , 5                         ) );
    ms._( Field( A_CHAR("ABCDE")   , 5                         ) );
    ms._( Field( A_CHAR("ABCDEF")  , 5, lang::Alignment::Right ) );
    ms._( Field( A_CHAR("ABCDEFG") , 5, lang::Alignment::Right ) );
    UT_EQ( A_CHAR("    A   AB  ABC ABCDABCDEABCDEFABCDEFG"), ms )

    // field, alignment center
    ms.Reset();
    ms._( Field( A_CHAR("A")       , 5, lang::Alignment::Center) );
    ms._( Field( A_CHAR("AB")      , 5, lang::Alignment::Center) );
    ms._( Field( A_CHAR("ABC")     , 5, lang::Alignment::Center) );
    ms._( Field( A_CHAR("ABCD")    , 5, lang::Alignment::Center) );
    ms._( Field( A_CHAR("ABCDE")   , 5, lang::Alignment::Center) );
    ms._( Field( A_CHAR("ABCDEF")  , 5, lang::Alignment::Center) );
    ms._( Field( A_CHAR("ABCDEFG") , 5, lang::Alignment::Center) );
    UT_EQ( A_CHAR("  A   AB   ABC ABCD ABCDEABCDEFABCDEFG"), ms )

    // a nested field
    ms.Reset();
    ms._(A_CHAR("***"));
        String32 inner  (A_CHAR("OS:"));    inner._(Field( A_CHAR("Linux"), 10, lang::Alignment::Right, '-' ) );
                 inner._(A_CHAR(" Lang:")); inner._(Field( A_CHAR("en_US"),  8, lang::Alignment::Right, '-' ) );
        ms._(Field( inner, 35, lang::Alignment::Center, '#' ) );
    ms._(A_CHAR("***"));
...
UT_METHOD( CapacityLength )
{
    ...
    ALIB_DBG(assert::GetHaltFlagAndCounters().HaltOnErrors=false;)
            ...
            ms.ShortenTo(20);
                ...
                UT_EQ( 20, ms.Length() )    UT_EQ  ( ms.Capacity(), as )
            #endif
            ...
            ms.ShortenTo(11);
            #if !ALIB_DEBUG_STRINGS
                UT_EQ( 11, ms.Length() )    UT_EQ  ( ms.Capacity(), as )    UT_EQ(A_CHAR("12345678901")   ,  ms  )
            #endif
    ...
    #if !ALIB_DEBUG_STRINGS && !ALIB_DEBUG_ALLOCATIONS
    {
        AString* ms;
        ms= new AString();
        // we use std::malloc, as this is used inside AString. Otherwise valgrind would warn of a mismatch new[]/delete
        ms->SetBuffer( static_cast<character*>(std::malloc(size_t(5) * sizeof(character))), 5, 0, lang::Responsibility::Transfer );
    ...
    // LocalStrings
    // (Just checking if construction works and types work with MONOMEM. The rest is check all
    // over the place!)
    #if ALIB_MONOMEM
    {
        MonoAllocator ma(ALIB_DBG("UTStrLs",) 1);
        LocalStringMA<5> lsMA(ma);UT_EQ ( EMPTY_STRING, lsMA  )
        auto* origBuf= lsMA.Buffer();
        lsMA << A_CHAR("ABC");    UT_EQ ( A_CHAR("ABC")   , lsMA  )    UT_TRUE ( origBuf == lsMA.Buffer()  )
        UT_PRINT( "A warning should follow" )
        lsMA << A_CHAR("EFG");    UT_EQ ( A_CHAR("ABCEFG"), lsMA  )    UT_TRUE ( origBuf != lsMA.Buffer()  )

        StringMA8 lsMA8(ma);      UT_EQ ( EMPTY_STRING, lsMA8  )
        origBuf= lsMA8.Buffer();
        lsMA8 << A_CHAR("ABC");   UT_EQ ( A_CHAR("ABC"   )   , lsMA8 )    UT_TRUE ( origBuf == lsMA8.Buffer()  )
        lsMA8 << A_CHAR("EFG");   UT_EQ ( A_CHAR("ABCEFG")   , lsMA8 )    UT_TRUE ( origBuf == lsMA8.Buffer()  )
        UT_PRINT( "A warning should follow" )
        lsMA8 << A_CHAR("HIJ");   UT_EQ ( A_CHAR("ABCEFGHIJ"), lsMA8 )    UT_TRUE ( origBuf != lsMA8.Buffer()  )

        PoolAllocator pa(ma);
        LocalStringPA<5> lsPA(pa);UT_EQ ( EMPTY_STRING, lsPA  )
        origBuf= lsPA.Buffer();
        lsPA << A_CHAR("ABC");    UT_EQ ( A_CHAR("ABC"   ), lsPA  )    UT_TRUE ( origBuf == lsPA.Buffer()  )
        UT_PRINT( "A warning should follow" )
        lsPA << A_CHAR("EFG");    UT_EQ ( A_CHAR("ABCEFG"), lsPA  )    UT_TRUE ( origBuf != lsPA.Buffer()  )

        StringPA8 lsPA8(pa);      UT_EQ ( EMPTY_STRING, lsPA8  )
        origBuf= lsPA8.Buffer();
        lsPA8 << A_CHAR("ABC");   UT_EQ ( A_CHAR("ABC"      ), lsPA8 )    UT_TRUE ( origBuf == lsPA8.Buffer()  )
        lsPA8 << A_CHAR("EFG");   UT_EQ ( A_CHAR("ABCEFG"   ), lsPA8 )    UT_TRUE ( origBuf == lsPA8.Buffer()  )
        UT_PRINT( "A warning should follow" )
        lsPA8 << A_CHAR("HIJ");   UT_EQ ( A_CHAR("ABCEFGHIJ"), lsPA8 )    UT_TRUE ( origBuf != lsPA8.Buffer()  )
    }
    #endif
}
...
UT_METHOD( TTab )
{
    ...
    // test some bad input
        ms._(Tab(  0, 0, -1,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Tab(  0, 0,  0,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Tab( -1, 0,  0,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Tab( -1, 0,  0,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Tab( -1, 0,  -1,       '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Tab( -5, 0,  0,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Tab( -5, 0,  -100,     '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Tab(  2, 0,  -101,     '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Tab(  0, 0,  0,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Tab(  1, 0,  0,        '@' ));        UT_EQ( EMPTY_STRING,  ms )
    ms.Reset(Tab(  1, 0,  1,        '@' ));        UT_EQ( A_CHAR("@"), ms )
    ms.Reset(Tab(  0, 0,  1,        '@' ));        UT_EQ( A_CHAR("@"), ms )


    // minpad 0 (not common, default is 1, tab wont move if on tab position)
    ms.Reset();                    ms._(Tab( 2, 0, 0,    '@' ) )._( '-' );       UT_EQ( A_CHAR("-"),   ms )
    ms.Reset();    ms._( 'x' );    ms._(Tab( 2, 0, 0,    '@' ) )._( '-' );       UT_EQ( A_CHAR("x@-"), ms )

    // more standard tabs
    ms.Reset();
    ms._( A_CHAR("12") )._(Tab( 2 ))
      ._(  '1' )._(Tab( 2 ))
                ._(Tab( 2 ))
      ._(  '@' );
    ...
    ms.Reset();
    ms._( A_CHAR("12345") )._(Tab( 5 ))
      ._( A_CHAR("1234") ) ._(Tab( 5 ))
      ._( A_CHAR("123") )  ._(Tab( 5 ))
      ._( A_CHAR("12") )   ._(Tab( 5 ))
      ._(  '1' )   ._(Tab( 5 ))
                   ._(Tab( 5 ))
      ._(  '@' );
    ...
    ms.Reset();
    ms._( A_CHAR("12345") )._(Tab( 5, 0, 0 ))
      ._( A_CHAR("1234") ) ._(Tab( 5, 0, 0 ))
      ._( A_CHAR("123") )  ._(Tab( 5, 0, 0 ))
      ._( A_CHAR("12") )   ._(Tab( 5, 0, 0 ))
      ._(  '1' )   ._(Tab( 5, 0, 0 ))
                   ._(Tab( 5, 0, 0 ))
      ._(  '@' );
    UT_EQ( A_CHAR("123451234 123  12   1    @"), ms )

    ms.Reset();                   ms._(Tab( 0 ))  ._( '-' );        UT_EQ( A_CHAR(" -")    , ms )
    ms.Reset();                   ms._(Tab( 1 ))  ._( '-' );        UT_EQ( A_CHAR(" -")    , ms )
    ms.Reset();                   ms._(Tab( 2 ))  ._( '-' );        UT_EQ( A_CHAR("  -")   , ms )
    ms.Reset();                   ms._(Tab( 3 ))  ._( '-' );        UT_EQ( A_CHAR("   -")  , ms )
    ms.Reset();    ms._( 'x' );   ms._(Tab( 1 ))  ._( '-' );        UT_EQ( A_CHAR("x -")   , ms )
    ...
    ms._( A_CHAR("12345") )._(Tab( 5 , -1))
      ...
      ._( A_CHAR("123") )  ._(Tab( 5 , -1))
      ._( A_CHAR("12") )   ._(Tab( 5 , -1))
      ._(  '1' )   ._(Tab( 5 , -1))
                   ._(Tab( 5 , -1))
      ._(  '@' );
    ...
    ms.Reset(A_CHAR("ABC")).NewLine();
    ms._( A_CHAR("12345") )._(Tab( 5, -1, 0 ))
      ._( A_CHAR("1234") ) ._(Tab( 5, -1, 0 ))
      ._( A_CHAR("123") )  ._(Tab( 5, -1, 0 ))
      ._( A_CHAR("12") )   ._(Tab( 5, -1, 0 ))
      ._(  '1' )   ._(Tab( 5, -1, 0 ))
                   ._(Tab( 5, -1, 0 ))
      ._(  '@' );
...
UT_METHOD( SearchAndReplace )
{
    ...
    // search characters
    {
        ...
        result= ms.IndexOf<NC>( '@', 5   );   UT_EQ(    -1,  result )

        result= ms.IndexOf<NC>( 'a', 0   );   UT_EQ(    0,   result )
        result= ms.IndexOf<NC>( 'b', 0   );   UT_EQ(    1,   result )
        result= ms.IndexOf<NC>( 'c', 0   );   UT_EQ(    2,   result )

        result= ms.IndexOf<NC>( 'a', 1   );   UT_EQ(    5,   result )
        result= ms.IndexOf<NC>( 'b', 1   );   UT_EQ(    1,   result )
        result= ms.IndexOf<NC>( 'c', 1   );   UT_EQ(    2,   result )

        result= ms.IndexOf<NC>( 'a', 2   );   UT_EQ(    5,   result )
        result= ms.IndexOf<NC>( 'b', 2   );   UT_EQ(    6,   result )
        result= ms.IndexOf<NC>( 'c', 2   );   UT_EQ(    2,   result )

        result= ms.IndexOf<NC>( 'a', 3   );   UT_EQ(    5,   result )
        result= ms.IndexOf<NC>( 'b', 3   );   UT_EQ(    6,   result )
        result= ms.IndexOf<NC>( 'c', 3   );   UT_EQ(    7,   result )

        result= ms.IndexOf<NC>( 'd', 7   );   UT_EQ(    8,   result )
        result= ms.IndexOf<NC>( 'd', 8   );   UT_EQ(    8,   result )
    }

    {
        ...
        result= ms.IndexOf<NC>( '1',     0,   1 );   UT_EQ( -1,  result )
        result= ms.IndexOf<NC>( '1',     0,   2 );   UT_EQ(  1,  result )
        result= ms.IndexOf<NC>( '2',     0,   2 );   UT_EQ( -1,  result )
        result= ms.IndexOf<NC>( '2',     1,   2 );   UT_EQ(  2,  result )
        result= ms.IndexOf<NC>( '2',     1,   3 );   UT_EQ(  2,  result )
        result= ms.IndexOf<NC>( '2',     2,   3 );   UT_EQ(  2,  result )
        result= ms.IndexOf<NC>( '2',     2,   1 );   UT_EQ(  2,  result )
        result= ms.IndexOf<NC>( '2',     3,   1 );   UT_EQ( -1,  result )
    }
    ...
    // ------------------ search char backwards ------------------
    {
        ...
        result= ms.LastIndexOf<NC>( '@', 5   );   UT_EQ(    -1,  result )

        result= ms.LastIndexOf<NC>( 'a', 0   );   UT_EQ(    0,   result )
        result= ms.LastIndexOf<NC>( 'b', 0   );   UT_EQ(   -1,   result )
        result= ms.LastIndexOf<NC>( 'c', 0   );   UT_EQ(   -1,   result )

        result= ms.LastIndexOf<NC>( 'a', 1   );   UT_EQ(    0,   result )
        result= ms.LastIndexOf<NC>( 'b', 1   );   UT_EQ(    1,   result )
        result= ms.LastIndexOf<NC>( 'c', 1   );   UT_EQ(   -1,   result )

        result= ms.LastIndexOf<NC>( 'a', 2   );   UT_EQ(    0,   result )
        result= ms.LastIndexOf<NC>( 'b', 2   );   UT_EQ(    1,   result )
        result= ms.LastIndexOf<NC>( 'c', 2   );   UT_EQ(    2,   result )

        result= ms.LastIndexOf<NC>( 'a', 3   );   UT_EQ(    0,   result )
        result= ms.LastIndexOf<NC>( 'b', 3   );   UT_EQ(    1,   result )
        result= ms.LastIndexOf<NC>( 'c', 3   );   UT_EQ(    2,   result )

        result= ms.LastIndexOf<NC>( 'd', 7   );   UT_EQ(    3,   result )
        result= ms.LastIndexOf<NC>( 'd', 8   );   UT_EQ(    8,   result )
    }
    ...
    // non static version
    {
        ...
        result= ms.IndexOfAny    <lang::Inclusion::Include, NC>( A_CHAR("x")          );    UT_EQ(  -1, result )
        result= ms.IndexOfAny    <lang::Inclusion::Include, NC>( A_CHAR("xy")         );    UT_EQ(  -1, result )
        result= ms.IndexOfAny    <lang::Inclusion::Include, NC>( A_CHAR("xyz")        );    UT_EQ(  -1, result )
        result= ms.IndexOfAny    <lang::Inclusion::Include, NC>( A_CHAR("xyd")        );    UT_EQ(   3, result )
        result= ms.IndexOfAny    <lang::Inclusion::Include, NC>( A_CHAR("d")          );    UT_EQ(   3, result )
        result= ms.IndexOfAny    <lang::Inclusion::Include, NC>( A_CHAR("xyd")  ,  4  );    UT_EQ(   8, result )
        result= ms.LastIndexOfAny<lang::Inclusion::Include, NC>( A_CHAR("xyd")  ,  2  );    UT_EQ(  -1, result )
        result= ms.LastIndexOfAny<lang::Inclusion::Include, NC>( A_CHAR("xyd")  ,  4  );    UT_EQ(   3, result )
        result= ms.LastIndexOfAny<lang::Inclusion::Include, NC>( A_CHAR("a")    ,  4  );    UT_EQ(   0, result )
        result= ms.LastIndexOfAny<lang::Inclusion::Include, NC>( A_CHAR("b")    ,  4  );    UT_EQ(   1, result )
        result= ms.LastIndexOfAny<lang::Inclusion::Include, NC>( A_CHAR("ba")   ,  4  );    UT_EQ(   1, result )
        result= ms.LastIndexOfAny<lang::Inclusion::Include, NC>( A_CHAR("xa")   ,  4  );    UT_EQ(   0, result )
        ...
        result= ms.IndexOfAny    <lang::Inclusion::Exclude ,NC>( A_CHAR("x")          );    UT_EQ(   0, result )
        result= ms.IndexOfAny    <lang::Inclusion::Exclude ,NC>( A_CHAR("xy")         );    UT_EQ(   0, result )
        result= ms.IndexOfAny    <lang::Inclusion::Exclude ,NC>( A_CHAR("xyz")        );    UT_EQ(   0, result )
        result= ms.IndexOfAny    <lang::Inclusion::Exclude ,NC>( A_CHAR("a")          );    UT_EQ(   1, result )
        result= ms.IndexOfAny    <lang::Inclusion::Exclude ,NC>( A_CHAR("ba")         );    UT_EQ(   2, result )
        result= ms.IndexOfAny    <lang::Inclusion::Exclude ,NC>( A_CHAR("abc")        );    UT_EQ(   3, result )
        result= ms.IndexOfAny    <lang::Inclusion::Exclude ,NC>( A_CHAR("acb")        );    UT_EQ(   3, result )
        result= ms.IndexOfAny    <lang::Inclusion::Exclude ,NC>( A_CHAR("cba")        );    UT_EQ(   3, result )
        result= ms.IndexOfAny    <lang::Inclusion::Exclude ,NC>( A_CHAR("xcba")       );    UT_EQ(   3, result )
        result= ms.LastIndexOfAny<lang::Inclusion::Exclude ,NC>( A_CHAR("ecd")  ,  4  );    UT_EQ(   4, result )
        result= ms.LastIndexOfAny<lang::Inclusion::Exclude ,NC>( A_CHAR("acd")  ,  3  );    UT_EQ(   1, result )
        result= ms.LastIndexOfAny<lang::Inclusion::Exclude ,NC>( A_CHAR("abc")  ,  2  );    UT_EQ(  -1, result )
        result= ms.LastIndexOfAny<lang::Inclusion::Exclude ,NC>( A_CHAR("xay")  ,  3  );    UT_EQ(   3, result )
        result= ms.LastIndexOfAny<lang::Inclusion::Exclude ,NC>( A_CHAR("d")    ,  3  );    UT_EQ(   2, result )
        result= ms.LastIndexOfAny<lang::Inclusion::Exclude ,NC>( A_CHAR("a")    ,  0  );    UT_EQ(  -1, result )
    }
    ...
    // search
    {
        ...
        result= ms.IndexOf<NC, lang::Case::Sensitive>( A_CHAR("abcd")       );  UT_EQ( result,   0 )
        result= ms.IndexOf<NC, lang::Case::Sensitive>( A_CHAR("b")          );  UT_EQ( result,   1 )
        result= ms.IndexOf<NC, lang::Case::Sensitive>( A_CHAR(" abcd")      );  UT_EQ( result,   4 )
        result= ms.IndexOf<NC, lang::Case::Sensitive>( A_CHAR("abcd"),     1);  UT_EQ( result,   5 )
    }

    // ignore case
    {
        AString ms( A_CHAR("Hello A-Worx LibraryXXX") );
        ms.DeleteEnd(3);
        result= ms.IndexOf<CHK, lang::Case::Ignore>( A_CHAR("a-worx"),    0 ); UT_EQ( result,  6 )
        result= ms.IndexOf<CHK, lang::Case::Ignore>( A_CHAR("a-worx"),    1 ); UT_EQ( result,  6 )
        result= ms.IndexOf<CHK, lang::Case::Ignore>( A_CHAR("a-worx"),  -10 ); UT_EQ( result,  6 )
        result= ms.IndexOf<CHK, lang::Case::Ignore>( A_CHAR("a-worx"),    6 ); UT_EQ( result,  6 )
        result= ms.IndexOf<CHK, lang::Case::Ignore>( A_CHAR("a-worx"),    7 ); UT_EQ( result, -1 )
        result= ms.IndexOf<CHK, lang::Case::Ignore>( A_CHAR("a-worx"),  100 ); UT_EQ( result, -1 )
        result= ms.IndexOf<CHK, lang::Case::Ignore>( A_CHAR("hel"),       0 ); UT_EQ( result,  0 )
        result= ms.IndexOf<CHK, lang::Case::Ignore>( A_CHAR("hel"),       1 ); UT_EQ( result, -1 )
        result= ms.IndexOf<CHK, lang::Case::Ignore>( A_CHAR("library"),   1 ); UT_EQ( result, 13 )
        result= ms.IndexOf<CHK, lang::Case::Ignore>( A_CHAR("Library"),   5 ); UT_EQ( result, 13 )
        result= ms.IndexOf<CHK, lang::Case::Ignore>( A_CHAR("LIBRARY"),  13 ); UT_EQ( result, 13 )
        result= ms.IndexOf<CHK, lang::Case::Ignore>( A_CHAR("LIBRARY"),  14 ); UT_EQ( result, -1 )
        result= ms.IndexOf<NC , lang::Case::Ignore>( A_CHAR("a-worx"),    0 ); UT_EQ( result,  6 )
        result= ms.IndexOf<NC , lang::Case::Ignore>( A_CHAR("a-worx"),    1 ); UT_EQ( result,  6 )
        result= ms.IndexOf<NC , lang::Case::Ignore>( A_CHAR("a-worx"),    6 ); UT_EQ( result,  6 )
        result= ms.IndexOf<NC , lang::Case::Ignore>( A_CHAR("a-worx"),    7 ); UT_EQ( result, -1 )
        result= ms.IndexOf<NC , lang::Case::Ignore>( A_CHAR("hel"),       0 ); UT_EQ( result,  0 )
        result= ms.IndexOf<NC , lang::Case::Ignore>( A_CHAR("hel"),       1 ); UT_EQ( result, -1 )
        result= ms.IndexOf<NC , lang::Case::Ignore>( A_CHAR("library"),   1 ); UT_EQ( result, 13 )
        result= ms.IndexOf<NC , lang::Case::Ignore>( A_CHAR("LIBRARY"),   5 ); UT_EQ( result, 13 )
        result= ms.IndexOf<NC , lang::Case::Ignore>( A_CHAR("LIBRARY"),  13 ); UT_EQ( result, 13 )
    }
    ...
    // ------------ search and replace characters ------------
    {
        ...
        ms.SearchAndReplace( A_CHAR('x'), 'X'          );     UT_EQ( A_CHAR("Hello")   , ms )
        ms.SearchAndReplace( A_CHAR('H'), 'X'          );     UT_EQ( A_CHAR("Xello")   , ms )
        ms.SearchAndReplace( A_CHAR('o'), 'X'          );     UT_EQ( A_CHAR("XellX")   , ms )
        ms.SearchAndReplace( A_CHAR('X'), 'Y'          );     UT_EQ( A_CHAR("YellY")   , ms )
        ms.SearchAndReplace( A_CHAR('l'), 'Y'          );     UT_EQ( A_CHAR("YeYYY")   , ms )
        ms.SearchAndReplace( A_CHAR('e'), 'Y'          );     UT_EQ( A_CHAR("YYYYY")   , ms )
        ms.SearchAndReplace( A_CHAR('Y'), 'Z'          );     UT_EQ( A_CHAR("ZZZZZ")   , ms )
        ms.SearchAndReplace( A_CHAR('Z'), 'A', 1000    );     UT_EQ( A_CHAR("ZZZZZ")   , ms )
        ms.SearchAndReplace( A_CHAR('Z'), 'A', 5       );     UT_EQ( A_CHAR("ZZZZZ")   , ms )
        ms.SearchAndReplace( A_CHAR('Z'), 'A', 4       );     UT_EQ( A_CHAR("ZZZZA")   , ms )
        ms.SearchAndReplace( A_CHAR('Z'), 'A'          );     UT_EQ( A_CHAR("AAAAA")   , ms )
        ms.SearchAndReplace( A_CHAR('A'), 'B', 0,0     );     UT_EQ( A_CHAR("AAAAA")   , ms )
        ms.SearchAndReplace( A_CHAR('A'), 'B', 0,1     );     UT_EQ( A_CHAR("BAAAA")   , ms )
        ms.SearchAndReplace( A_CHAR('A'), 'B', 0,4     );     UT_EQ( A_CHAR("BBBBA")   , ms )
        ms.SearchAndReplace( A_CHAR('A'), 'B', 0,5     );     UT_EQ( A_CHAR("BBBBB")   , ms )
    }
    ...
    {
        AString ms(A_CHAR("Hello"));
        ms.SearchAndReplace( nullptr  ,   NULL_STRING );     UT_EQ( A_CHAR("Hello") , ms )
        ms.SearchAndReplace( A_CHAR("l"), NULL_STRING );     UT_EQ( A_CHAR("Heo")   , ms )
    ...
    {
        AString ms(A_CHAR("Hello"));
        result= ms.SearchAndReplace( nullptr    ,  NULL_STRING );  UT_EQ( A_CHAR("Hello") , ms )   UT_EQ( 0, result )
        result= ms.SearchAndReplace( A_CHAR("l"),  NULL_STRING );  UT_EQ( A_CHAR("Heo")   , ms )   UT_EQ( 2, result )
    ...
    // replace in maximum range
    {
        AString ms(A_CHAR("ABCDE"));
        result= ms.SearchAndReplace( A_CHAR("DE"),  A_CHAR("de")  ,0, 10,  lang::Case::Sensitive, 1   );    UT_EQ( A_CHAR("ABCDE")       ,ms )      UT_EQ( 0, result )
        result= ms.SearchAndReplace( A_CHAR("DE"),  A_CHAR("de")  ,0, 10,  lang::Case::Sensitive, 2   );    UT_EQ( A_CHAR("ABCDE")       ,ms )      UT_EQ( 0, result )
        result= ms.SearchAndReplace( A_CHAR("DE"),  A_CHAR("de")  ,0, 10,  lang::Case::Sensitive, 3   );    UT_EQ( A_CHAR("ABCDE")       ,ms )      UT_EQ( 0, result )
        result= ms.SearchAndReplace( A_CHAR("DE"),  A_CHAR("de")  ,0, 10,  lang::Case::Sensitive, 4   );    UT_EQ( A_CHAR("ABCde")       ,ms )      UT_EQ( 1, result )
        result= ms.SearchAndReplace( A_CHAR("de"),  A_CHAR("DE")  ,0, 10,  lang::Case::Sensitive, 4   );    UT_EQ( A_CHAR("ABCDE")       ,ms )      UT_EQ( 1, result )
        result= ms.SearchAndReplace( A_CHAR("DE"),  A_CHAR("DE")  ,0, 10,  lang::Case::Sensitive, 5   );    UT_EQ( A_CHAR("ABCDE")       ,ms )      UT_EQ( 1, result )
        result= ms.SearchAndReplace( A_CHAR("DE"),  A_CHAR("DE")  ,0, 10,  lang::Case::Sensitive, 100 );    UT_EQ( A_CHAR("ABCDE")       ,ms )      UT_EQ( 1, result )
    }
}
...
UT_METHOD( Compare )
{
    ...
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>( A_CHAR("pad") + t,  3            );                    UT_EQ(  0,  result )
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>( A_CHAR("pad") + t,  3, 2         );                    UT_EQ(  1,  result )
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>( A_CHAR("pad") + t,  3, 100, 0, 4 );                    UT_EQ( -1,  result )
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>( A_CHAR("pad") + t,  3, 100, 0, 5 );                    UT_EQ(  0,  result )
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>(         t,  2,2,   2,2           );                    UT_EQ(  0,  result )
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>(         t,  2,2,   2,1           );                    UT_EQ( -1,  result )
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>(         t,  2,2,   2,3           );                    UT_EQ(  1,  result )
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>(         t,  -2,5,   -2, 5        );                    UT_EQ(  0,  result )
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>(         t,   2, intMaxValue,    2, intMaxValue );      UT_EQ(  0,  result )
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>(         t,  -2, intMaxValue,   -2, intMaxValue );      UT_EQ(  0,  result )
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>(         t,  -2, 100,           -2, 99 );               UT_EQ(  0,  result )
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>(         t,  -2, 5,             -2, intMaxValue );      UT_EQ(  1,  result )
    result= ms.CompareTo<CHK,   lang::Case::Sensitive>(         t,  -2, intMaxValue,   -2, 5 );                UT_EQ( -1,  result )


    result= ms.CompareTo<NC,   lang::Case::Sensitive>( A_CHAR("pad") + t,  3, 2         );    UT_EQ(  1,     result )
    result= ms.CompareTo<NC,   lang::Case::Sensitive>( A_CHAR("pad") + t,  3, 5         );    UT_EQ(  0,     result )
    result= ms.CompareTo<NC,   lang::Case::Sensitive>( A_CHAR("pad") + t,  3, 6         );    UT_EQ(  -1,    result )
    result= ms.CompareTo<NC,   lang::Case::Sensitive>(         t,  2,2,   2,2           );    UT_EQ(  0,     result )
    result= ms.CompareTo<NC,   lang::Case::Sensitive>(         t,  2,2,   2,1           );    UT_EQ( -1,     result )
    result= ms.CompareTo<NC,   lang::Case::Sensitive>(         t,  2,2,   2,3           );    UT_EQ(  1,     result )
    ...
    result= ms.CompareTo<CHK,   lang::Case::Sensitive  >( ABCDE               );    UT_TRUE( result >  0 )
    result= ms.CompareTo<CHK,   lang::Case::Ignore     >( ABCDE               );    UT_TRUE( result == 0 )
    result= ms.CompareTo<NC                          >( ABCDE               );    UT_TRUE( result >  0 )
    result= ms.CompareTo<NC,   lang::Case::Sensitive >( ABCDE               );    UT_TRUE( result >  0 )
    result= ms.CompareTo<NC,   lang::Case::Ignore    >( ABCDE               );    UT_TRUE( result == 0 )
    result= ms.CompareTo<CHK ,   lang::Case::Sensitive >( ABCDE,  2,2,   2,2  );    UT_TRUE( result >  0 )
    result= ms.CompareTo<CHK ,   lang::Case::Ignore    >( ABCDE,  2,2,   2,2  );    UT_TRUE( result == 0 )
    result= ms.CompareTo<NC,   lang::Case::Sensitive >( ABCDE,  2,2,   2,2  );    UT_TRUE( result >  0 )
    result= ms.CompareTo<NC,   lang::Case::Ignore    >( ABCDE,  2,2,   2,2  );    UT_TRUE( result == 0 )
    ...
    result= ms.CompareTo<CHK ,lang::Case::Sensitive>( cp                          );  UT_EQ( 0, result )
    result= ms.CompareTo<CHK ,lang::Case::Sensitive>( cp,  -5, 100, -10, 100      );  UT_EQ( 0, result )
    result= ms.CompareTo<CHK ,lang::Case::Sensitive>( cp,   2,   3,   2,   3      );  UT_EQ( 0, result )
    result= ms.CompareTo<NC                      >( cp,   2,   3,   2,   3      );  UT_EQ( 0, result )

    AString tAS( t );
    result= ms.CompareTo                                ( tAS      );                    UT_EQ( 0, result )
    result= ms.CompareTo<CHK ,   lang::Case::Sensitive>(tAS,  -5, 100, -10, 100      ); UT_EQ( 0, result )
    result= ms.CompareTo<CHK ,   lang::Case::Sensitive>( cp,   2,   3,   2,   3      ); UT_EQ( 0, result )
    result= ms.CompareTo<NC,   lang::Case::Sensitive>( cp,   2,   3,   2,   3      ); UT_EQ( 0, result )

    // different ranges
    basic_string<character> r1= A_CHAR("*ABCDEF*");
    basic_string<character> r2= A_CHAR("##*ABCDEF*##");
    ms.Reset( r1 );
    result= ms.CompareTo<CHK ,   lang::Case::Sensitive>( r2,  2,8          );       UT_EQ( 0,   result )
    result= ms.CompareTo<NC,   lang::Case::Sensitive>( r2,  2,7          );       UT_EQ( 1,   result )
    result= ms.CompareTo<NC,   lang::Case::Sensitive>( r2,  2,8          );       UT_EQ( 0,   result )
    result= ms.CompareTo<NC,   lang::Case::Sensitive>( r2,  2,9          );       UT_EQ(-1,   result )
    result= ms.CompareTo<CHK ,   lang::Case::Sensitive>( r2,  3,6,   1,6   );       UT_EQ( 0,   result )
    result= ms.CompareTo<NC,   lang::Case::Sensitive>( r2,  3,6,   1,6   );       UT_EQ( 0,   result )
    ...
    ms.Reset(A_CHAR("AB"));       UT_FALSE ( ms.ContainsAt( NULL_STRING, -1 )  )
                                  UT_FALSE ( ms.ContainsAt( NULL_STRING,  0 )  )
                                  UT_FALSE ( ms.ContainsAt( NULL_STRING,  1 )  )
                                  UT_FALSE ( ms.ContainsAt( NULL_STRING,  2 )  )
                                  UT_FALSE ( ms.ContainsAt( NULL_STRING,  3 )  )
    ...
    ms._();                       UT_FALSE ( ms.ContainsAt( NULL_STRING, -1 )  )
                                  UT_FALSE ( ms.ContainsAt( NULL_STRING,  0 )  )
                                  UT_FALSE ( ms.ContainsAt( NULL_STRING,  1 )  )
...
{
    UT_INIT()
// As of 241214 mingw GCC 13.47 has a problem with release builds here.
// Because a) debug-builds work and b) it had worked previously, we do not further investigate
// \checkpromise: To be checked with next release (and mingw GCC version).
#if !defined(__MINGW32__) || !defined(__MINGW64__)

    NAString na;                        na.Reverse();        UT_TRUE( na.Equals( NULL_NSTRING    ) )
    na         << A_NCHAR(""         ); na.Reverse();        UT_TRUE( na.Equals( A_NCHAR(""     )) )
                                        na.Reverse<NC>(0,0); UT_TRUE( na.Equals( A_NCHAR(""     )) )
    ...
    WAString wa;                        wa.Reverse();        UT_TRUE( wa.Equals( NULL_WSTRING    ) )
    wa         << A_WCHAR(""         ); wa.Reverse();        UT_TRUE( wa.Equals( A_WCHAR(""     )) )
                                        wa.Reverse<NC>(0,0); UT_TRUE( wa.Equals( A_WCHAR(""     )) )
    ...
    XAString xa;                        xa.Reverse();        UT_TRUE( xa.Equals( NULL_XSTRING    ) )
    xa         << A_XCHAR(""         ); xa.Reverse();        UT_TRUE( xa.Equals( A_XCHAR(""     )) )
                                        xa.Reverse<NC>(0,0); UT_TRUE( xa.Equals( A_XCHAR(""     )) )
