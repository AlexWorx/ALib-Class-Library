...
UT_METHOD( TextMarked )
{
    ...
    {ALIB_LOCK_RECURSIVE_WITH(Formatter::DefaultLock)
        ...
        {
            caught= true;
            UT_TRUE(  e.Type() == alib::format::FMTExceptions::UnknownMarker )
            UT_PRINT( e.Format() )
        }
        UT_TRUE( caught )
        ...
        {
            caught= true;
            UT_TRUE(  e.Type() == alib::format::FMTExceptions::EndmarkerWithoutStart )
            UT_PRINT( e.Format() )
        }
        UT_TRUE( caught )
...
UT_METHOD( TestSubstringSearch )
{
    ...
    {
        StringSearch<lang::Case::Sensitive> substringSearch( A_CHAR("of") );
    ...
    {
        StringSearch<lang::Case::Sensitive> substringSearch( A_CHAR("Vi") );
    ...
    {
        StringSearch<lang::Case::Ignore   > substringSearch( A_CHAR("VI") );
