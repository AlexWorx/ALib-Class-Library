                          ...
                          const String&         expected           )
{
    ...
    {
        ALIB_ASSERT( !expression, "UT_EXPR" )
                           ...
                           integer              programLength                               )
{
    ...
    time= Ticks::Now();
    {
        ...
        {
            ALIB_ASSERT( !recompiled, "UT_EXPR" )
            ut.Print (ci, alib::Verbosity::Info,
                      "--------- Error --------\n"
    ...
    //---------------- check parsing optimized -------------------
    {
        ...
        integer optimizedPLen= optimized->GetProgramLength();
        if( programLength > 0 && programLength != optimizedPLen )
        {
            ut.Print (ci, alib::Verbosity::Info,
                      ...
                      optimized->GetNormalizedString(),
                      programLength,
                      optimized->GetProgramLength()  );

            #if ALIB_DEBUG
                UT_PRINT("Progam listing:")
                UT_PRINT( expressions::DbgList(optimized) )
            #endif
    ...
    integer optimizedPLen= expression->GetProgramLength();
    if( programLength > 0 && programLength != optimizedPLen )
    {
        ut.Print (ci, alib::Verbosity::Info,
                      "--------- Error --------\n"
                  ...
                  expression->GetNormalizedString(),
                  programLength,
                  expression->GetProgramLength()  );

        #if ALIB_DEBUG
            UT_PRINT("Progam listing:")
            UT_PRINT( expressions::DbgList(expression)  )
        #endif
    ...
    integer nonOptimizedLen= 0;
    {
        ...
        {
            compiler.CfgCompilation-= expressions::Compilation::NoOptimization;
            ALIB_ASSERT( !expressionCompiledWitoutOptimizations, "UT_EXPR" )
            ut.Print (ci, alib::Verbosity::Info,
                      "--------- Error --------\n"
        ...
        compiler.CfgCompilation-= expressions::Compilation::NoOptimization;
        nonOptimizedLen= expressionCompiledWitoutOptimizations->GetProgramLength();
        ...
        {
            compiler.CfgCompilation-= expressions::Compilation::NoOptimization;
            ALIB_ASSERT( !expressionCompiledWitoutOptimizationsDecompiled, "UT_EXPR" )
            ut.Print (ci, alib::Verbosity::Info,
                      "--------- Error --------\n"
