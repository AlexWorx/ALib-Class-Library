...
#include "ALib.Containers.SharedVal.H"
#include "ALib.Containers.SharedPtr.H"
...
DOX_MARKER( [ALIB_MANUAL_T_HPP_FILE_USAGE_DECL] )
namespace alib::monomem {

    extern template class TMonoAllocator<alib::PoolAllocatorHA>;
