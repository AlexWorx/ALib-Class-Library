...
#include "ALib.Compatibility.QTBoxing.H"
#include "ALib.ALox.H"
...
{
    UT_INIT()
    IF_ALIB_THREADS( alib::monomem::GLOBAL_ALLOCATOR_LOCK.AcquireRecursive(ALIB_CALLER_PRUNED) );
    alib::boxing::compatibility::qt::BootstrapQTStringBoxing();
    IF_ALIB_THREADS( alib::monomem::GLOBAL_ALLOCATOR_LOCK.ReleaseRecursive(ALIB_CALLER_PRUNED) );
